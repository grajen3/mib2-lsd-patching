...
NavigationServiceListener {
   ...
   // @Override
    ...
    private void setRouteGuidanceStatus(RG_Status_Status rG_Status_Status) {
        ...
        rG_Status_Status.rg_Status = navigationService.getNavigationStatus() != 0 ? 0 : (this.instrumentClusterActionStatus != null ? (this.instrumentClusterActionStatus != false ? 1 : 0) : (navigationService.getRouteGuidanceState() == 0 ? 0 : 1));
    }
