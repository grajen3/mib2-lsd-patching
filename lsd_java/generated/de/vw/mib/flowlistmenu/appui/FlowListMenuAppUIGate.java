 ...
 */
package generated.de.vw.mib.flowlistmenu.appui;
...
import generated.de.vw.mib.flowlistmenu.appui.internal.FlowListMenuModelApiUpEventHandler;
import generated.de.vw.mib.flowlistmenu.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class FlowListMenuAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public FlowListMenuAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new FlowListMenuModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-883389111);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-27751095);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1079610697);
        }
    }
