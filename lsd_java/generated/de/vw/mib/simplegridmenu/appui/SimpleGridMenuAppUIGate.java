 ...
 */
package generated.de.vw.mib.simplegridmenu.appui;
...
import generated.de.vw.mib.simplegridmenu.appui.internal.SimpleGridMenuModelApiUpEventHandler;
import generated.de.vw.mib.simplegridmenu.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class SimpleGridMenuAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public SimpleGridMenuAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new SimpleGridMenuModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-547844791);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(475630921);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1616481609);
        }
    }
