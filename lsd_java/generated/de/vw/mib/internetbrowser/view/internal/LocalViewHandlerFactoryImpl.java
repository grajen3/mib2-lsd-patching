 ...
 */
package generated.de.vw.mib.internetbrowser.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.internetbrowser.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.shared = LocalViewHandlerFactoryImpl.setOf(new String[]{"Cws", "Gde", "Gdna", "Psgpb", "Wcc", "Wccs_974F", "Wccs_259D", "Wcid", "Wcnw", "Wcns", "Wcnsa", "Wcscm", "Wcsi", "Wcsep", "Wcw", "Wcwhl", "Wocnaa", "Wocnip", "Wocnipwf", "Wocnis", "Wocnp", "Wocnpoa", "Wocnui", "Wof", "Wosll", "Wos"});
        this.popups = LocalViewHandlerFactoryImpl.setOf(new String[]{"Peia", "Peis", "Pmbsld", "Psgpb"});
    }
