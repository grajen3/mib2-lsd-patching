 ...
 */
package generated.de.vw.mib.internetbrowser.appui;
...
import generated.de.vw.mib.internetbrowser.appui.internal.InternetbrowserModelApiUpEventHandler;
import generated.de.vw.mib.internetbrowser.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class InternetbrowserAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public InternetbrowserAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new InternetbrowserModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(72977737);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1180273993);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{566};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{224, 226, 382};
    }
}
