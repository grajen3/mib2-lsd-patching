 ...
 */
package generated.de.vw.mib.pictureviewertiles.appui;
...
import generated.de.vw.mib.pictureviewertiles.appui.internal.PictureViewerTileScioVisualizationService;
import generated.de.vw.mib.pictureviewertiles.appui.internal.PictureViewerTileSmodelApiUpEventHandler;
import generated.de.vw.mib.pictureviewertiles.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class PictureViewerTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public PictureViewerTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        PictureViewerTileScioVisualizationService pictureViewerTileScioVisualizationService = new PictureViewerTileScioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("PictureViewerTileS", string, pictureViewerTileScioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new PictureViewerTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-631730871);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(374967625);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1482263881);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{585};
    }
}
