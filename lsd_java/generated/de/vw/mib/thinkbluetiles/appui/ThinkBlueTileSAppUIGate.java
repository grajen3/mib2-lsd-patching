 ...
 */
package generated.de.vw.mib.thinkbluetiles.appui;
...
import generated.de.vw.mib.thinkbluetiles.appui.internal.ThinkBlueTileScioVisualizationService;
import generated.de.vw.mib.thinkbluetiles.appui.internal.ThinkBlueTileSmodelApiUpEventHandler;
import generated.de.vw.mib.thinkbluetiles.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class ThinkBlueTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public ThinkBlueTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        ThinkBlueTileScioVisualizationService thinkBlueTileScioVisualizationService = new ThinkBlueTileScioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("ThinkBlueTileS", string, thinkBlueTileScioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new ThinkBlueTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-329740983);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(760843593);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1868139849);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{607};
    }
}
