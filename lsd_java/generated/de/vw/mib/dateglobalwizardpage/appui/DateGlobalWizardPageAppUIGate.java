 ...
 */
package generated.de.vw.mib.dateglobalwizardpage.appui;
...
import generated.de.vw.mib.dateglobalwizardpage.appui.internal.DateGlobalWizardPageCioVisualizationService;
import generated.de.vw.mib.dateglobalwizardpage.appui.internal.DateGlobalWizardPageModelApiUpEventHandler;
import generated.de.vw.mib.dateglobalwizardpage.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class DateGlobalWizardPageAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public DateGlobalWizardPageAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        DateGlobalWizardPageCioVisualizationService dateGlobalWizardPageCioVisualizationService = new DateGlobalWizardPageCioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("DateGlobalWizardPage", string, dateGlobalWizardPageCioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new DateGlobalWizardPageModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-900166327);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-78082743);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1029279049);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{557};
    }
}
