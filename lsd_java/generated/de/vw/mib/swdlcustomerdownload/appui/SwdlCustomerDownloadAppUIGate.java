 ...
 */
package generated.de.vw.mib.swdlcustomerdownload.appui;
...
import generated.de.vw.mib.swdlcustomerdownload.appui.internal.SwdlCustomerDownloadmodelApiUpEventHandler;
import generated.de.vw.mib.swdlcustomerdownload.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class SwdlCustomerDownloadAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public SwdlCustomerDownloadAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new SwdlCustomerDownloadmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-497513143);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(559517001);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1515818313);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{603};
    }
}
