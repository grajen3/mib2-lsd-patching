 ...
 */
package generated.de.vw.mib.climate.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.climate.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.shared = LocalViewHandlerFactoryImpl.setOf(new String[]{"Cpd", "Cpm", "Cptp", "Cpts", "Gde", "Gdna", "Psgpb"});
        this.popups = LocalViewHandlerFactoryImpl.setOf(new String[]{"Pacdk", "Pca", "Pct", "Pdcff", "Pdcsina", "Picpno", "Picsv", "Psgpb"});
    }
