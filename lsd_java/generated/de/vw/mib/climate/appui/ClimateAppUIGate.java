 ...
 */
package generated.de.vw.mib.climate.appui;
...
import generated.de.vw.mib.climate.appui.internal.ClimateModelApiUpEventHandler;
import generated.de.vw.mib.climate.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class ClimateAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public ClimateAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new ClimateModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-145191607);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(962170185);
        }
    }
    ...
    static {
        ...
        VIEWNAME_2_SCREENAREAS_MAP.put("Csa", new String[]{"ScreenAreaClimateSetup"});
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{556};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{84, 117, 118, 222, 223, 280, 281};
    }
}
