 ...
 */
package generated.de.vw.mib.navhomeadressglobalwizardpage.appui;
...
import generated.de.vw.mib.navhomeadressglobalwizardpage.appui.internal.NavHomeAdressGlobalWizardPageCioVisualizationService;
import generated.de.vw.mib.navhomeadressglobalwizardpage.appui.internal.NavHomeAdressGlobalWizardPageModelApiUpEventHandler;
import generated.de.vw.mib.navhomeadressglobalwizardpage.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class NavHomeAdressGlobalWizardPageAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public NavHomeAdressGlobalWizardPageAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        NavHomeAdressGlobalWizardPageCioVisualizationService navHomeAdressGlobalWizardPageCioVisualizationService = new NavHomeAdressGlobalWizardPageCioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("NavHomeAdressGlobalWizardPage", string, navHomeAdressGlobalWizardPageCioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new NavHomeAdressGlobalWizardPageModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-749171383);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(190418249);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1297714505);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{572};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{454, 455, 456};
    }
}
