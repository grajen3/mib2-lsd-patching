 ...
 */
package generated.de.vw.mib.tunerautostoreglobalwizardpage.appui;
...
import generated.de.vw.mib.tunerautostoreglobalwizardpage.appui.internal.TunerAutostoreGlobalWizardPageCioVisualizationService;
import generated.de.vw.mib.tunerautostoreglobalwizardpage.appui.internal.TunerAutostoreGlobalWizardPageModelApiUpEventHandler;
import generated.de.vw.mib.tunerautostoreglobalwizardpage.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class TunerAutostoreGlobalWizardPageAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public TunerAutostoreGlobalWizardPageAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        TunerAutostoreGlobalWizardPageCioVisualizationService tunerAutostoreGlobalWizardPageCioVisualizationService = new TunerAutostoreGlobalWizardPageCioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("TunerAutostoreGlobalWizardPage", string, tunerAutostoreGlobalWizardPageCioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new TunerAutostoreGlobalWizardPageModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-312963767);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(794398025);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1901694281);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{609};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{369};
    }
}
