 ...
 */
package generated.de.vw.mib.tvtuner.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.tvtuner.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.popups = LocalViewHandlerFactoryImpl.setOf(new String[]{"Psgpb", "Ptca", "Ptci", "Ptcdap", "Ptcdsp", "Ptem", "Ptemal", "Ptemmd", "Ptntna"});
    }
    ...
    public String[] getFastAccessibleViewHandler() {
        return new String[]{"Tam_9D1A", "Tdm_97E5", "Tsmci", "Ttm"};
    }
