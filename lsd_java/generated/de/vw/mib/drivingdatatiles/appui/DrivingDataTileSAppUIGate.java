 ...
 */
package generated.de.vw.mib.drivingdatatiles.appui;
...
import generated.de.vw.mib.drivingdatatiles.appui.internal.DrivingDataTileScioVisualizationService;
import generated.de.vw.mib.drivingdatatiles.appui.internal.DrivingDataTileSmodelApiUpEventHandler;
import generated.de.vw.mib.drivingdatatiles.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class DrivingDataTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public DrivingDataTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        DrivingDataTileScioVisualizationService drivingDataTileScioVisualizationService = new DrivingDataTileScioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("DrivingDataTileS", string, drivingDataTileScioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new DrivingDataTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-61305527);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1046056265);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{558};
    }
}
