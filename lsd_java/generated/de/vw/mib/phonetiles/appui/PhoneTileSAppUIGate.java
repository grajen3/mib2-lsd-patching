 ...
 */
package generated.de.vw.mib.phonetiles.appui;
...
import generated.de.vw.mib.phonetiles.appui.internal.PhoneTileScioVisualizationService;
import generated.de.vw.mib.phonetiles.appui.internal.PhoneTileSmodelApiUpEventHandler;
import generated.de.vw.mib.phonetiles.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class PhoneTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public PhoneTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        PhoneTileScioVisualizationService phoneTileScioVisualizationService = new PhoneTileScioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("PhoneTileS", string, phoneTileScioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new PhoneTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-648508087);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(358190409);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1465486665);
        }
    }
