 ...
 */
package generated.de.vw.mib.climatesetup.appui;
...
import generated.de.vw.mib.climatesetup.appui.internal.ClimateSetupModelApiUpEventHandler;
import generated.de.vw.mib.climatesetup.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class ClimateSetupAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public ClimateSetupAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new ClimateSetupModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-128414391);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(978947401);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{555};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{221};
    }
}
