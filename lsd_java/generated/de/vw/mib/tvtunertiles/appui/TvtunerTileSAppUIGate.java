 ...
 */
package generated.de.vw.mib.tvtunertiles.appui;
...
import generated.de.vw.mib.tvtunertiles.appui.internal.TvtunerTileScioVisualizationService;
import generated.de.vw.mib.tvtunertiles.appui.internal.TvtunerTileSmodelApiUpEventHandler;
import generated.de.vw.mib.tvtunertiles.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class TvtunerTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public TvtunerTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        TvtunerTileScioVisualizationService tvtunerTileScioVisualizationService = new TvtunerTileScioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("TVTunerTileS", string, tvtunerTileScioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new TvtunerTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-279409335);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(844729673);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1952025929);
        }
    }
