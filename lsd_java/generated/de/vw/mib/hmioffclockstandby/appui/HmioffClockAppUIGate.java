 ...
 */
package generated.de.vw.mib.hmioffclockstandby.appui;
...
import generated.de.vw.mib.hmioffclockstandby.appui.internal.HmioffClockModelApiUpEventHandler;
import generated.de.vw.mib.hmioffclockstandby.view.internal.LocalViewHandlerFactoryImpl;
...
extends AbstractHmiAppUIGate {
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-833057463);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(22646089);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1129942345);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{563};
    }
}
