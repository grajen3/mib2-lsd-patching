...
extends AbstractHmiAppUIGate {
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{580};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{88, 89, 179, 180, 181, 182, 197, 228, 230, 231, 233, 234, 235, 236, 237, 238, 239, 240, 334, 335, 336, 337, 338, 458, 459, 460, 461, 462, 463, 464, 465, 466, 467, 468, 469, 470, 471, 472, 473, 474, 475, 519};
    }
}
