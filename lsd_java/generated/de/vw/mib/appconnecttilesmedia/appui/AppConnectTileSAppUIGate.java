 ...
 */
package generated.de.vw.mib.appconnecttilesmedia.appui;
...
import generated.de.vw.mib.appconnecttilesmedia.appui.internal.AppConnectTileSmediaCioVisualizationService;
import generated.de.vw.mib.appconnecttilesmedia.appui.internal.AppConnectTileSmodelApiUpEventHandler;
import generated.de.vw.mib.appconnecttilesmedia.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class AppConnectTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public AppConnectTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        AppConnectTileSmediaCioVisualizationService appConnectTileSmediaCioVisualizationService = new AppConnectTileSmediaCioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("AppConnectTileS", string, appConnectTileSmediaCioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new AppConnectTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-950497975);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-212300471);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(895061321);
        }
    }
