 ...
 */
package generated.de.vw.mib.speechgeneral.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.speechgeneral.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.popups = LocalViewHandlerFactoryImpl.setOf(new String[]{"Psdna", "Pslc", "Pslnss", "Psnavs", "Psgpb"});
    }
