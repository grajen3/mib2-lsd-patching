 ...
 */
package generated.de.vw.mib.smartphoneintegration.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.smartphoneintegration.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.shared = LocalViewHandlerFactoryImpl.setOf(new String[]{"Gde", "Gdna", "Gdnas", "Psgpb"});
        this.popups = LocalViewHandlerFactoryImpl.setOf(new String[]{"Psaid_B535", "Pscnvc1", "Pscnvc2", "Psccdcd", "Pscedt", "Pscnad", "Psicf", "Psid", "Psins", "Psincdc", "Psisc", "Psgpb"});
    }
