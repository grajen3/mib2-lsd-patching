 ...
 */
package generated.de.vw.mib.ugdo.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.ugdo.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.popups = LocalViewHandlerFactoryImpl.setOf(new String[]{"Paude", "Pauds", "Pcud", "Pcus4", "Pcusa", "Pcuse", "Pcuss", "Pcuta", "Pcute", "Pcutf", "Pcuts", "Pmus_CBB2", "Pmus_8439", "Pmus_ED32", "Pmusw_AA29", "Pmusw_CA3C", "Pmut_1591", "Pmut_7A3D", "Psgpb"});
    }
