 ...
 */
package generated.de.vw.mib.ugdo.appui;
...
import generated.de.vw.mib.ugdo.appui.internal.UgdomodelApiUpEventHandler;
import generated.de.vw.mib.ugdo.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class UgdoAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public UgdoAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new UgdomodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-262632119);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(861506889);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1968803145);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{614};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{114, 115, 215, 216, 217};
    }
}
