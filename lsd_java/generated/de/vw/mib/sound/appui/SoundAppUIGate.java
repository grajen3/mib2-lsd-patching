 ...
 */
package generated.de.vw.mib.sound.appui;
...
import generated.de.vw.mib.sound.appui.internal.SoundModelApiUpEventHandler;
import generated.de.vw.mib.sound.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class SoundAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public SoundAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new SoundModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(492408137);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1633258825);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{608, 619};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{501, 502, 503, 504, 505, 506};
    }
}
