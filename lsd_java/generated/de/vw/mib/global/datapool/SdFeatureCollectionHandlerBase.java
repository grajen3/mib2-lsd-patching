...
import generated.de.vw.mib.global.datapool.SdPromptFactory;
import org.dsi.ifc.global.ResourceLocator;

public abstract class SdFeatureCollectionHandlerBase
extends AbstractSdFeatureCollectionHandler {
    ...
    protected String getI18nString(int n) {
        return ServiceManagerCommon.scaledI18nDatapool.getScaledString(n);
    }

    protected String[] getI18nStrings(int n) {
        return ServiceManagerCommon.scaledI18nDatapool.getScaledStrings(n);
    }

    public static Prompt createPrompt(int n) {
        return SdPromptFactory.createPrompt(n);
    }
}
