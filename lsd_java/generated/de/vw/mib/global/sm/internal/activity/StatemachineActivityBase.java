...
import de.vw.mib.sm.internal.statemachine.StatemachineActivityImpl;
import de.vw.mib.sm.internal.statemachine.TopStatemachine;
import org.dsi.ifc.global.ResourceLocator;

public abstract class StatemachineActivityBase
extends StatemachineActivityImpl {
    ...
    protected StatemachineActivityBase(TopStatemachine topStatemachine, int n, int n2, int n3, int n4) {
        super(topStatemachine, n, n2, n3, n4);
    }

    protected void enterPopupView(String string, int n, int n2) {
        ServiceManagerCommon.statemachineEventDispatcher.createAndSubmitPopupViewEvent(this.topStatemachine.getId(), string, 0, this.topStatemachine.getPopupInfoId(n, n2));
    }

    protected void leavePopupView(String string) {
        ServiceManagerCommon.statemachineEventDispatcher.createAndSubmitPopupViewEvent(this.topStatemachine.getId(), string, 1, this.topStatemachine.getPopupInfoId());
    }
    ...
    protected void triggerObserver(int n, EventGeneric eventGeneric) {
        StatemachineActivityBase.getServiceRegister().triggerObserver(n, eventGeneric);
    }

    protected void triggerObserver(int n) {
        StatemachineActivityBase.getServiceRegister().triggerObserver(n);
    }
    ...
    protected static int evIntegerValueValue() {
        IntegerValueEvent integerValueEvent = (IntegerValueEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$IntegerValueEvent == null ? (class$de$vw$mib$event$IntegerValueEvent = StatemachineActivityBase.class$("de.vw.mib.event.IntegerValueEvent")) : class$de$vw$mib$event$IntegerValueEvent);
        if (integerValueEvent == null) {
            StatemachineActivityBase.errorEventParameter("Value of IntegerValueEvent");
            return 0;
        }
    ...
    protected static int evListItemActionIndex() {
        ListItemEvent listItemEvent = (ListItemEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$ListItemEvent == null ? (class$de$vw$mib$event$ListItemEvent = StatemachineActivityBase.class$("de.vw.mib.event.ListItemEvent")) : class$de$vw$mib$event$ListItemEvent);
        if (listItemEvent == null) {
            StatemachineActivityBase.errorEventParameter("ActionIndex of ListItemEvent");
            return 0;
        }
    ...
    protected static int evListItemAbsoluteIndex() {
        ListItemEvent listItemEvent = (ListItemEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$ListItemEvent == null ? (class$de$vw$mib$event$ListItemEvent = StatemachineActivityBase.class$("de.vw.mib.event.ListItemEvent")) : class$de$vw$mib$event$ListItemEvent);
        if (listItemEvent == null) {
            StatemachineActivityBase.errorEventParameter("AbsoluteIndex of ListItemEvent");
            return 0;
        }
    ...
    protected static String evListItemEventSender() {
        ListItemEvent listItemEvent = (ListItemEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$ListItemEvent == null ? (class$de$vw$mib$event$ListItemEvent = StatemachineActivityBase.class$("de.vw.mib.event.ListItemEvent")) : class$de$vw$mib$event$ListItemEvent);
        if (listItemEvent == null) {
            StatemachineActivityBase.errorEventParameter("EventSender of ListItemEvent");
    ...
    protected static long evListItemObjectId() {
        ListItemEvent listItemEvent = (ListItemEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$ListItemEvent == null ? (class$de$vw$mib$event$ListItemEvent = StatemachineActivityBase.class$("de.vw.mib.event.ListItemEvent")) : class$de$vw$mib$event$ListItemEvent);
        if (listItemEvent == null) {
            StatemachineActivityBase.errorEventParameter("ObjectId of ListItemEvent");
            return 0L;
        }
    ...
    protected static int evListItemDestinationIndex() {
        ListItemEvent listItemEvent = (ListItemEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$ListItemEvent == null ? (class$de$vw$mib$event$ListItemEvent = StatemachineActivityBase.class$("de.vw.mib.event.ListItemEvent")) : class$de$vw$mib$event$ListItemEvent);
        if (listItemEvent == null) {
            StatemachineActivityBase.errorEventParameter("DestinationIndex of ListItemEvent");
            return 0;
        }
    ...
    protected static int evPointX() {
        PointEvent pointEvent = (PointEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$PointEvent == null ? (class$de$vw$mib$event$PointEvent = StatemachineActivityBase.class$("de.vw.mib.event.PointEvent")) : class$de$vw$mib$event$PointEvent);
        if (pointEvent == null) {
            StatemachineActivityBase.errorEventParameter("X of PointEvent");
            return 0;
        }
    ...
    protected static int evPointY() {
        PointEvent pointEvent = (PointEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$PointEvent == null ? (class$de$vw$mib$event$PointEvent = StatemachineActivityBase.class$("de.vw.mib.event.PointEvent")) : class$de$vw$mib$event$PointEvent);
        if (pointEvent == null) {
            StatemachineActivityBase.errorEventParameter("Y of PointEvent");
            return 0;
        }
    ...
    protected static int evPointGestureParam1() {
        PointEvent pointEvent = (PointEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$PointEvent == null ? (class$de$vw$mib$event$PointEvent = StatemachineActivityBase.class$("de.vw.mib.event.PointEvent")) : class$de$vw$mib$event$PointEvent);
        if (pointEvent == null) {
            StatemachineActivityBase.errorEventParameter("GestureParam1 of PointEvent");
            return 0;
        }
    ...
    protected static int evPointGestureParam2() {
        PointEvent pointEvent = (PointEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$PointEvent == null ? (class$de$vw$mib$event$PointEvent = StatemachineActivityBase.class$("de.vw.mib.event.PointEvent")) : class$de$vw$mib$event$PointEvent);
        if (pointEvent == null) {
            StatemachineActivityBase.errorEventParameter("GestureParam2 of PointEvent");
            return 0;
        }
    ...
    protected static String evSpellerValuePressedChar() {
        SpellerValueEvent spellerValueEvent = (SpellerValueEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$SpellerValueEvent == null ? (class$de$vw$mib$event$SpellerValueEvent = StatemachineActivityBase.class$("de.vw.mib.event.SpellerValueEvent")) : class$de$vw$mib$event$SpellerValueEvent);
        if (spellerValueEvent == null) {
            StatemachineActivityBase.errorEventParameter("PressedChar of SpellerValueEvent");
            return "A";
        }
    ...
    protected static int evSpellerValueCursorPosition() {
        SpellerValueEvent spellerValueEvent = (SpellerValueEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$SpellerValueEvent == null ? (class$de$vw$mib$event$SpellerValueEvent = StatemachineActivityBase.class$("de.vw.mib.event.SpellerValueEvent")) : class$de$vw$mib$event$SpellerValueEvent);
        if (spellerValueEvent == null) {
            StatemachineActivityBase.errorEventParameter("CursorPosition of SpellerValueEvent");
            return 0;
        }
    ...
    protected static int evSpellerValueSelectionStart() {
        SpellerValueEvent spellerValueEvent = (SpellerValueEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$SpellerValueEvent == null ? (class$de$vw$mib$event$SpellerValueEvent = StatemachineActivityBase.class$("de.vw.mib.event.SpellerValueEvent")) : class$de$vw$mib$event$SpellerValueEvent);
        if (spellerValueEvent == null) {
            StatemachineActivityBase.errorEventParameter("SelectionStart of SpellerValueEvent");
            return 0;
        }
    ...
    protected static int evSpellerValueSelectionEnd() {
        SpellerValueEvent spellerValueEvent = (SpellerValueEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$SpellerValueEvent == null ? (class$de$vw$mib$event$SpellerValueEvent = StatemachineActivityBase.class$("de.vw.mib.event.SpellerValueEvent")) : class$de$vw$mib$event$SpellerValueEvent);
        if (spellerValueEvent == null) {
            StatemachineActivityBase.errorEventParameter("SelectionEnd of SpellerValueEvent");
            return 0;
        }
    ...
    protected static String evStringValueValue() {
        StringValueEvent stringValueEvent = (StringValueEvent)CurrentHMIEvent.getEventAs(class$de$vw$mib$event$StringValueEvent == null ? (class$de$vw$mib$event$StringValueEvent = StatemachineActivityBase.class$("de.vw.mib.event.StringValueEvent")) : class$de$vw$mib$event$StringValueEvent);
        if (stringValueEvent == null) {
            StatemachineActivityBase.errorEventParameter("Value of StringValueEvent");
            return "";
        }
