 ...
 */
package generated.de.vw.mib.message.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.message.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.popups = LocalViewHandlerFactoryImpl.setOf(new String[]{"Pamsmf", "Pcmsd", "Pcmsda", "Pcmssad", "Pimnd", "Pimsd", "Pimsda", "Pimsdae", "Pimsde_45FB", "Pimsdw", "Pimsde_0488", "Pimssadf", "Pimssads", "Pimssw", "Pimss", "Pimsse", "Pmw", "Ppmsda", "Psgpb"});
    }
