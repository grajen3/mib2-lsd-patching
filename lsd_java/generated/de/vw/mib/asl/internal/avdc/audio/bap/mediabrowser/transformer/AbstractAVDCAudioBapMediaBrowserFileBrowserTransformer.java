...
public abstract class AbstractAVDCAudioBapMediaBrowserFileBrowserTransformer
extends ItemTransformerAdapter {
    public static final int AVDC_AUDIO_BAP_MEDIABROWSER_ENTRY_ID_LONG;
    public static final int AVDC_AUDIO_BAP_MEDIABROWSER_FILE_NAME_STRING;
    public static final int AVDC_AUDIO_BAP_MEDIABROWSER_TITLE_STRING;
    public static final int AVDC_AUDIO_BAP_MEDIABROWSER_ALBUM_STRING;
    public static final int AVDC_AUDIO_BAP_MEDIABROWSER_ARTIST_STRING;
    public static final int AVDC_AUDIO_BAP_MEDIABROWSER_CONTENT_TYPE_INTEGER;
    public static final int AVDC_AUDIO_BAP_MEDIABROWSER_FLAGS_INTEGER;
    ...
    public int[] getColumnIds() {
        return ASLListColumns.getColumnsForASLList(3829);
    }
