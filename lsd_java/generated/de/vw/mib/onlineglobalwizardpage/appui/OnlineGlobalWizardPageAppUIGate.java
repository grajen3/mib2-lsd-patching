 ...
 */
package generated.de.vw.mib.onlineglobalwizardpage.appui;
...
import generated.de.vw.mib.onlineglobalwizardpage.appui.internal.OnlineGlobalWizardPageCioVisualizationService;
import generated.de.vw.mib.onlineglobalwizardpage.appui.internal.OnlineGlobalWizardPageModelApiUpEventHandler;
import generated.de.vw.mib.onlineglobalwizardpage.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class OnlineGlobalWizardPageAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public OnlineGlobalWizardPageAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        OnlineGlobalWizardPageCioVisualizationService onlineGlobalWizardPageCioVisualizationService = new OnlineGlobalWizardPageCioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("OnlineGlobalWizardPage", string, onlineGlobalWizardPageCioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new OnlineGlobalWizardPageModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(291081545);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1398377801);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{578};
    }
}
