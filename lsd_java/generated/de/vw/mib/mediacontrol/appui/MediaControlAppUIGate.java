 ...
 */
package generated.de.vw.mib.mediacontrol.appui;
...
import generated.de.vw.mib.mediacontrol.appui.internal.MediaControlModelApiUpEventHandler;
import generated.de.vw.mib.mediacontrol.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class MediaControlAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public MediaControlAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new MediaControlModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-782725815);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(106532169);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1213828425);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{567};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{6};
    }
}
