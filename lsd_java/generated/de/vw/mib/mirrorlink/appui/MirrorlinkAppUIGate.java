 ...
 */
package generated.de.vw.mib.mirrorlink.appui;
...
import generated.de.vw.mib.mirrorlink.appui.internal.MirrorlinkModelApiUpEventHandler;
import generated.de.vw.mib.mirrorlink.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class MirrorlinkAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public MirrorlinkAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new MirrorlinkModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(156863817);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1264160073);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{571};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{168, 169, 170, 171, 172, 173, 225, 227, 241, 322};
    }
}
