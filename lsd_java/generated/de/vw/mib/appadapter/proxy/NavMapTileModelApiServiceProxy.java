...
public class NavMapTileModelApiServiceProxy
implements ModelApiDownEventHandler {
    ...
    static /* synthetic */ Class class$generated$de$vw$mib$appadapter$navmaptile$GeneralModelApiService;

    public NavMapTileModelApiServiceProxy(ModelApiService[] modelApiServiceArray, AppDefinition appDefinition, Logger logger) {
        this.logger = logger;
        this.generalModelApiService = (GeneralModelApiService)this.getServiceOf(class$generated$de$vw$mib$appadapter$navmaptile$GeneralModelApiService == null ? (class$generated$de$vw$mib$appadapter$navmaptile$GeneralModelApiService = NavMapTileModelApiServiceProxy.class$("generated.de.vw.mib.appadapter.navmaptile.GeneralModelApiService")) : class$generated$de$vw$mib$appadapter$navmaptile$GeneralModelApiService, modelApiServiceArray);
    }
    ...
    public void onModelApiDownEvent(ModelApiDownEvent modelApiDownEvent) {
        ...
        switch (n) {
            case 21: {
                this.generalModelApiService._mda_navMapTileEnterNavContext();
                break;
            }
            default: {
