...
public class SpeechSetupModelApiServiceProxy
implements ModelApiDownEventHandler {
    private static final int SUB_CLASSIFIER;
    private final SettingsViewModelApiService settingsViewModelApiService;
    private final Logger logger;
    static /* synthetic */ Class class$generated$de$vw$mib$appadapter$speechsetup$SettingsViewModelApiService;

    public SpeechSetupModelApiServiceProxy(ModelApiService[] modelApiServiceArray, AppDefinition appDefinition, Logger logger) {
        this.logger = logger;
        this.settingsViewModelApiService = (SettingsViewModelApiService)this.getServiceOf(class$generated$de$vw$mib$appadapter$speechsetup$SettingsViewModelApiService == null ? (class$generated$de$vw$mib$appadapter$speechsetup$SettingsViewModelApiService = SpeechSetupModelApiServiceProxy.class$("generated.de.vw.mib.appadapter.speechsetup.SettingsViewModelApiService")) : class$generated$de$vw$mib$appadapter$speechsetup$SettingsViewModelApiService, modelApiServiceArray);
    }
    ...
    public SettingsViewModelApiService getSettingsViewModelApiService() {
        return this.settingsViewModelApiService;
    }
    ...
    public void onModelApiDownEvent(ModelApiDownEvent modelApiDownEvent) {
        ...
        switch (n) {
            case 33: {
                this.settingsViewModelApiService._mda_backTriggered();
                break;
            }
            default: {
