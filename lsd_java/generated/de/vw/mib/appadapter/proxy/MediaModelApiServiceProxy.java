...
public class MediaModelApiServiceProxy
implements ModelApiDownEventHandler {
    ...
    static /* synthetic */ Class class$generated$de$vw$mib$appadapter$media$GesturesModelApiService;

    public MediaModelApiServiceProxy(ModelApiService[] modelApiServiceArray, AppDefinition appDefinition, Logger logger) {
        this.logger = logger;
        this.gesturesModelApiService = (GesturesModelApiService)this.getServiceOf(class$generated$de$vw$mib$appadapter$media$GesturesModelApiService == null ? (class$generated$de$vw$mib$appadapter$media$GesturesModelApiService = MediaModelApiServiceProxy.class$("generated.de.vw.mib.appadapter.media.GesturesModelApiService")) : class$generated$de$vw$mib$appadapter$media$GesturesModelApiService, modelApiServiceArray);
    }
