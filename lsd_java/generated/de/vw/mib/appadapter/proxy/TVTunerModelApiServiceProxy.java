...
public class TVTunerModelApiServiceProxy
implements ModelApiDownEventHandler {
    ...
    static /* synthetic */ Class class$generated$de$vw$mib$appadapter$tvtuner$SpaceGesturesModelApiService;

    public TVTunerModelApiServiceProxy(ModelApiService[] modelApiServiceArray, AppDefinition appDefinition, Logger logger) {
        this.logger = logger;
        this.spaceGesturesModelApiService = (SpaceGesturesModelApiService)this.getServiceOf(class$generated$de$vw$mib$appadapter$tvtuner$SpaceGesturesModelApiService == null ? (class$generated$de$vw$mib$appadapter$tvtuner$SpaceGesturesModelApiService = TVTunerModelApiServiceProxy.class$("generated.de.vw.mib.appadapter.tvtuner.SpaceGesturesModelApiService")) : class$generated$de$vw$mib$appadapter$tvtuner$SpaceGesturesModelApiService, modelApiServiceArray);
    }
