...
public class TunerTileSModelApiServiceProxy
implements ModelApiDownEventHandler {
    ...
    static /* synthetic */ Class class$generated$de$vw$mib$appadapter$tunertiles$GeneralModelApiService;

    public TunerTileSModelApiServiceProxy(ModelApiService[] modelApiServiceArray, AppDefinition appDefinition, Logger logger) {
        this.logger = logger;
        this.generalModelApiService = (GeneralModelApiService)this.getServiceOf(class$generated$de$vw$mib$appadapter$tunertiles$GeneralModelApiService == null ? (class$generated$de$vw$mib$appadapter$tunertiles$GeneralModelApiService = TunerTileSModelApiServiceProxy.class$("generated.de.vw.mib.appadapter.tunertiles.GeneralModelApiService")) : class$generated$de$vw$mib$appadapter$tunertiles$GeneralModelApiService, modelApiServiceArray);
    }
    ...
    public void onModelApiDownEvent(ModelApiDownEvent modelApiDownEvent) {
        ...
        switch (n) {
            case 44: {
                this.generalModelApiService._mda_switchSource();
                break;
            }
            default: {
