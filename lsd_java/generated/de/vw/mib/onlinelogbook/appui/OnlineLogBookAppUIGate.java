 ...
 */
package generated.de.vw.mib.onlinelogbook.appui;
...
import generated.de.vw.mib.onlinelogbook.appui.internal.OnlineLogBookModelApiUpEventHandler;
import generated.de.vw.mib.onlinelogbook.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class OnlineLogBookAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public OnlineLogBookAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new OnlineLogBookModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-698839735);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(274304329);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1381600585);
        }
    }
