 ...
 */
package generated.de.vw.mib.mediatiles.appui;
...
import generated.de.vw.mib.mediatiles.appui.internal.MediaTileScioVisualizationService;
import generated.de.vw.mib.mediatiles.appui.internal.MediaTileSmodelApiUpEventHandler;
import generated.de.vw.mib.mediatiles.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class MediaTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public MediaTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        MediaTileScioVisualizationService mediaTileScioVisualizationService = new MediaTileScioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("MediaTileS", string, mediaTileScioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new MediaTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-765948599);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(123309385);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1230605641);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{568};
    }
}
