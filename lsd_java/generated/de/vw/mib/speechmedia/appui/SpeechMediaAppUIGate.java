 ...
 */
package generated.de.vw.mib.speechmedia.appui;
...
import generated.de.vw.mib.speechmedia.appui.internal.SpeechMediaModelApiUpEventHandler;
import generated.de.vw.mib.speechmedia.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class SpeechMediaAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public SpeechMediaAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new SpeechMediaModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-413627063);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(676957513);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1784253769);
        }
    }
    ...
    static {
        ...
        VIEWNAME_2_SCREENAREAS_MAP.put("Smdmn", new String[]{"ScreenAreaHeadline"});
        VIEWNAME_2_SCREENAREAS_MAP.put("Smdms", new String[]{"ScreenAreaHeadline"});
        VIEWNAME_2_SCREENAREAS_MAP.put("Smdss", new String[]{"ScreenAreaHeadline"});
        VIEWNAME_2_SCREENAREAS_MAP.put("Smm", new String[]{"ScreenAreaHeadline"});
        VIEWNAME_2_SCREENAREAS_MAP.put("Smms", new String[]{"ScreenAreaHeadline"});
        VIEWNAME_2_SCREENAREAS_MAP.put("Smnv", new String[]{"ScreenAreaHeadline"});
        VIEWNAME_2_SCREENAREAS_MAP.put("Smps", new String[]{"ScreenAreaHeadline"});
        VIEWNAME_2_SCREENAREAS_MAP.put("Smss", new String[]{"ScreenAreaHeadline"});
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{596, 623, 624};
    }
}
