 ...
 */
package generated.de.vw.mib.audiotiles.appui;
...
import generated.de.vw.mib.audiotiles.appui.internal.AudioTileScioVisualizationService;
import generated.de.vw.mib.audiotiles.appui.internal.AudioTileSmodelApiUpEventHandler;
import generated.de.vw.mib.audiotiles.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class AudioTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public AudioTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        AudioTileScioVisualizationService audioTileScioVisualizationService = new AudioTileScioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("AudioTileS", string, audioTileScioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new AudioTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-967275191);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-229077687);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(878284105);
        }
    }
