 ...
 */
package generated.de.vw.mib.tunertiles.appui;
...
import generated.de.vw.mib.tunertiles.appui.internal.TunerTileScioVisualizationService;
import generated.de.vw.mib.tunertiles.appui.internal.TunerTileSmodelApiUpEventHandler;
import generated.de.vw.mib.tunertiles.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class TunerTileSAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public TunerTileSAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        TunerTileScioVisualizationService tunerTileScioVisualizationService = new TunerTileScioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("TunerTileS", string, tunerTileScioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new TunerTileSmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-296186551);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(811175241);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1918471497);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{610};
    }
}
