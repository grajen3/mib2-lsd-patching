 ...
 */
package generated.de.vw.mib.swap.appui;
...
import generated.de.vw.mib.swap.appui.internal.SwaPmodelApiUpEventHandler;
import generated.de.vw.mib.swap.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class SwaPAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public SwaPAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new SwaPmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-514290359);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(542739785);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1683590473);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{602};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{350, 351, 352};
    }
}
