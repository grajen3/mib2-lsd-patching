 ...
 */
package generated.de.vw.mib.swdlperforming.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.swdlperforming.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.shared = LocalViewHandlerFactoryImpl.setOf(new String[]{"Gde", "Gdna", "Psgpb", "Sal", "Sdl_9DCD", "Se", "Sil", "Sml", "Srw"});
    }
