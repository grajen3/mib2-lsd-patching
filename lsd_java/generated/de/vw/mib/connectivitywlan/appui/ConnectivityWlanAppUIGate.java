 ...
 */
package generated.de.vw.mib.connectivitywlan.appui;
...
import generated.de.vw.mib.connectivitywlan.appui.internal.ConnectivityWlanModelApiUpEventHandler;
import generated.de.vw.mib.connectivitywlan.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class ConnectivityWlanAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public ConnectivityWlanAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new ConnectivityWlanModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-94859959);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1012501833);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{615};
    }
}
