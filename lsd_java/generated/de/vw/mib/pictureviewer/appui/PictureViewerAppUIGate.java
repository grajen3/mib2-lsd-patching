 ...
 */
package generated.de.vw.mib.pictureviewer.appui;
...
import generated.de.vw.mib.pictureviewer.appui.internal.PictureViewerCioVisualizationService;
import generated.de.vw.mib.pictureviewer.appui.internal.PictureViewerModelApiUpEventHandler;
import generated.de.vw.mib.pictureviewer.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class PictureViewerAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public PictureViewerAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        PictureViewerCioVisualizationService pictureViewerCioVisualizationService = new PictureViewerCioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("PictureViewer", string, pictureViewerCioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new PictureViewerModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(391744841);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1499041097);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{586};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{74, 75, 76};
    }
}
