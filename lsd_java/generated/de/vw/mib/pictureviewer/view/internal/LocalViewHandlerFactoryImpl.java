 ...
 */
package generated.de.vw.mib.pictureviewer.view.internal;
...
extends LocalViewHandlerFactory {
    ...
    private final StringBuilder qualifiedLocalClassNameBuffer = LocalViewHandlerFactoryImpl.newBuffer("generated.de.vw.mib.pictureviewer.view.internal.");
    ...
    public LocalViewHandlerFactoryImpl(SkinClassLoader skinClassLoader, PerfService perfService, ViewHandlerServices viewHandlerServices, ViewHandlerAppServices viewHandlerAppServices) {
        ...
        this.popups = LocalViewHandlerFactoryImpl.setOf(new String[]{"Pvoeod", "Pvomcp", "Pvow", "Psgpb"});
    }
