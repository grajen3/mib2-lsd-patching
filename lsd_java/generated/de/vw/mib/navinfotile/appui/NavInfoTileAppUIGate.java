 ...
 */
package generated.de.vw.mib.navinfotile.appui;
...
import generated.de.vw.mib.navinfotile.appui.internal.NavInfoTileCioVisualizationService;
import generated.de.vw.mib.navinfotile.appui.internal.NavInfoTileModelApiUpEventHandler;
import generated.de.vw.mib.navinfotile.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class NavInfoTileAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public NavInfoTileAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
        super(appDefinition, appSystemServices);
        String string = appDefinition.getAppInstanceName();
        NavInfoTileCioVisualizationService navInfoTileCioVisualizationService = new NavInfoTileCioVisualizationService(string);
        appSystemServices.getCioVisualizationRegister().registerRelayService("NavInfoTile", string, navInfoTileCioVisualizationService);
    }
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new NavInfoTileModelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-732394167);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(207195465);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1314491721);
        }
    }
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{573};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{391};
    }
}
