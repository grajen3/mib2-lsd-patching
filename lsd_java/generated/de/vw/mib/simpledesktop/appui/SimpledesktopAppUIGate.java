 ...
 */
package generated.de.vw.mib.simpledesktop.appui;
...
import generated.de.vw.mib.simpledesktop.appui.internal.SimpledesktopmodelApiUpEventHandler;
import generated.de.vw.mib.simpledesktop.view.internal.LocalViewHandlerFactoryImpl;
import java.util.HashMap;
import java.util.Map;

public class SimpledesktopAppUIGate
extends AbstractHmiAppUIGate {
    ...
    public SimpledesktopAppUIGate(AppDefinition appDefinition, AppSystemServices appSystemServices) {
    ...
    protected ModelApiUpEventHandler newModelApiUpEventHandler(AppAdapterListItemControlManager appAdapterListItemControlManager) {
        ...
        return new SimpledesktopmodelApiUpEventHandler(this.appDefinition, statemachineEventDispatcher, modelDatapool, appAdapterListItemControlManager);
    }
    ...
    public void denyVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(-564622007);
        }
    }
    ...
    public void grantVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(458853705);
        }
    }
    ...
    public void revokeVisibility(String string) {
        if (string.equals("Main")) {
            this.fireInternalHMIEvent(1599704393);
        }
    }
    ...
    static {
        ...
        VIEWNAME_2_SCREENAREAS_MAP.put("Sdl_7DD2", new String[]{"ScreenAreaDisplayOffClock", "ScreenAreaParking", "ScreenAreaParticleBackground", "ScreenAreaPopup", "ScreenAreaSpaceGesture", "ScreenAreaSpeech", "ScreenAreaStage"});
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{590};
    }
}
