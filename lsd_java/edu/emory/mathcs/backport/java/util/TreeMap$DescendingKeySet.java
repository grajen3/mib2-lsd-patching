...
class TreeMap$DescendingKeySet
extends TreeMap$KeySet {
    private final /* synthetic */ TreeMap this$0;

    TreeMap$DescendingKeySet(TreeMap treeMap) {
        this.this$0 = treeMap;
        super(treeMap);
    }
    ...
    public Iterator iterator() {
        return new TreeMap$DescendingKeyIterator(this.this$0, TreeMap.access$1300(this.this$0));
    }
    ...
    public NavigableSet subSet(Object object, boolean bl, Object object2, boolean bl2) {
        return (NavigableSet)this.this$0.descendingMap().subMap(object, bl, object2, bl2).keySet();
    }

    @Override
    public NavigableSet headSet(Object object, boolean bl) {
        return (NavigableSet)this.this$0.descendingMap().headMap(object, bl).keySet();
    }

    @Override
    public NavigableSet tailSet(Object object, boolean bl) {
        return (NavigableSet)this.this$0.descendingMap().tailMap(object, bl).keySet();
    }
