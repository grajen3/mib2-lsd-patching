...
implements ListIterator {
    ...
    LinkedList$DescItr(LinkedList linkedList, LinkedList$Entry linkedList$Entry, int n) {
    ...
    LinkedList$DescItr(LinkedList linkedList) {
        this(linkedList, LinkedList.access$100((LinkedList)linkedList).prev, 0);
    }
    ...
    public boolean hasPrevious() {
        return this.cursor.next != LinkedList.access$100(this.this$0);
    }
    ...
    public Object previous() {
        ...
        if (this.cursor.next == LinkedList.access$100(this.this$0)) {
            throw new NoSuchElementException();
        }
    ...
    public void add(Object object) {
        ...
        LinkedList.access$400(this.this$0, this.cursor, object);
        this.lastRet = null;
        ++this.idx;
