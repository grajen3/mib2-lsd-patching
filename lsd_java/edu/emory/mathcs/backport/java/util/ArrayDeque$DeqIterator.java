...
implements Iterator {
    ...
    private ArrayDeque$DeqIterator(ArrayDeque arrayDeque) {
    ...
    public Object next() {
        ...
        if (ArrayDeque.access$300(this.this$0) != this.fence || object == null) {
    ...
    /* synthetic */ ArrayDeque$DeqIterator(ArrayDeque arrayDeque, ArrayDeque$1 arrayDeque$1) {
        this(arrayDeque);
    }
}
