...
class TreeMap$DescendingValueIterator
extends TreeMap$BaseEntryIterator
implements Iterator {
    private final /* synthetic */ TreeMap this$0;

    TreeMap$DescendingValueIterator(TreeMap treeMap, TreeMap$Entry treeMap$Entry) {
        this.this$0 = treeMap;
    ...
    @Override
    public Object next() {
        return TreeMap$Entry.access$600(this.prevEntry());
    }
}
