...
extends TreeMap$NavigableSubMap {
    ...
    TreeMap$DescendingSubMap(TreeMap treeMap, boolean bl, Object object, boolean bl2, boolean bl3, Object object2, boolean bl4) {
        this.this$0 = treeMap;
    ...
    protected TreeMap$Entry uncheckedHigher(TreeMap$Entry treeMap$Entry) {
        return TreeMap.access$900(treeMap$Entry);
    }
    ...
    public NavigableMap subMap(Object object, boolean bl, Object object2, boolean bl2) {
        ...
        return new TreeMap$DescendingSubMap(this.this$0, false, object2, bl2, false, object, bl);
    }
    ...
    public NavigableMap headMap(Object object, boolean bl) {
        ...
        return new TreeMap$DescendingSubMap(this.this$0, false, object, bl, this.toEnd, this.toKey, this.toInclusive);
    }
    ...
    public NavigableMap tailMap(Object object, boolean bl) {
        ...
        return new TreeMap$DescendingSubMap(this.this$0, this.fromStart, this.fromKey, this.fromInclusive, false, object, bl);
    }

    @Override
    public NavigableMap descendingMap() {
        if (this.descendingMap == null) {
            this.descendingMap = new TreeMap$AscendingSubMap(this.this$0, this.fromStart, this.fromKey, this.fromInclusive, this.toEnd, this.toKey, this.toInclusive);
        }
