...
public class BatteryControlPowerProviderAH {
    ...
    public BatteryControlPowerProviderAH() {
        this.arrayContent = 0;
    ...
    public BatteryControlPowerProviderAH(int n, int n2, int n3, int n4, int n5, int n6) {
        this.arrayContent = n;
    ...
    public String toString() {
        ...
        stringBuffer.append("BatteryControlPowerProviderAH");
        stringBuffer.append('(');
