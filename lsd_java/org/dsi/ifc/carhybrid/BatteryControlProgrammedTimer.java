...
public class BatteryControlProgrammedTimer {
    ...
    public BatteryControlProgrammedTimer(boolean bl, boolean bl2, boolean bl3, boolean bl4) {
        this.timer1 = bl;
        this.timer2 = bl2;
        this.timer3 = bl3;
        this.timer4 = bl4;
    ...
    public String toString() {
        ...
        stringBuffer.append("BatteryControlProgrammedTimer");
        stringBuffer.append('(');
