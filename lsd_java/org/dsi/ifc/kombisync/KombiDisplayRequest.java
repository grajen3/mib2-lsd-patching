...
public class KombiDisplayRequest {
    public int tid;
    public int focus;
    ...
    public boolean lastmoderequest;
    public boolean lvdslock;

    public KombiDisplayRequest() {
        this.tid = 0;
        this.focus = 0;
        this.screenFormat = 0;
        this.mainContext = 0;
        ...
        this.lastmoderequest = false;
        this.lvdslock = false;
    }

    public KombiDisplayRequest(int n, int n2, int n3, int n4, MenuContext menuContext, int n5, int n6, int n7, int n8, int n9, boolean bl, boolean bl2) {
        this.tid = n;
        this.focus = n2;
    ...
    public String toString() {
        ...
        stringBuffer.append("KombiDisplayRequest");
        stringBuffer.append('(');
        ...
        stringBuffer.append(',');
        stringBuffer.append("lastmoderequest");
        stringBuffer.append('=');
        stringBuffer.append(this.lastmoderequest);
        stringBuffer.append(',');
        stringBuffer.append("lvdslock");
        stringBuffer.append('=');
