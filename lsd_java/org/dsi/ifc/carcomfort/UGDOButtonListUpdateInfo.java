...
public class UGDOButtonListUpdateInfo {
    ...
    public UGDOButtonListUpdateInfo() {
        this.arrayContent = 0;
    ...
    public UGDOButtonListUpdateInfo(int n, int n2, int n3, int n4, int n5) {
        this.arrayContent = n;
    ...
    public UGDOButtonListUpdateInfo(int n, int n2, int n3, int n4, int n5, int n6) {
        this.arrayContent = n;
        this.recordContent = n2;
        this.startElement = n3;
        this.numOfElements = n4;
    ...
    public String toString() {
        ...
        stringBuffer.append("UGDOButtonListUpdateInfo");
        stringBuffer.append('(');
