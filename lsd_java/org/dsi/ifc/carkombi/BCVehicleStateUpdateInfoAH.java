...
public class BCVehicleStateUpdateInfoAH {
    ...
    public BCVehicleStateUpdateInfoAH() {
        this.arrayContent = 0;
    ...
    public BCVehicleStateUpdateInfoAH(int n, int n2, int n3, int n4, int n5, int n6) {
        this.arrayContent = n;
    ...
    public String toString() {
        ...
        stringBuffer.append("BCVehicleStateUpdateInfoAH");
        stringBuffer.append('(');
