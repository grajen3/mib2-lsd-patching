...
public class PDCStatusLevelFrontRear {
    public int left;
    public int leftMiddle;
    public int rightMiddle;
    public int right;

    public PDCStatusLevelFrontRear() {
        this.left = 0;
        this.leftMiddle = 0;
        this.rightMiddle = 0;
        this.right = 0;
    ...
    public PDCStatusLevelFrontRear(int n, int n2, int n3, int n4) {
        this.left = n;
        this.leftMiddle = n2;
        this.rightMiddle = n3;
        this.right = n4;
    ...
    public String toString() {
        ...
        stringBuffer.append("PDCStatusLevelFrontRear");
        stringBuffer.append('(');
