...
public class Values {
    ...
    public Values() {
        ...
        this.valuesDouble = null;
        this.valuesBoolean = null;
        this.valuesResourceLocator = null;
        this.valuesDate = null;
    }

    public Values(String[] stringArray, int[] nArray, long[] lArray, float[] fArray, double[] dArray, boolean[] blArray, ResourceLocator[] resourceLocatorArray, TravelLinkDate[] travelLinkDateArray) {
        this.valuesString = stringArray;
        this.valuesInt = nArray;
        this.valuesLong = lArray;
        this.valuesFloat = fArray;
        this.valuesDouble = dArray;
    ...
    public String toString() {
        ...
        stringBuffer.append('}');
        stringBuffer.append(',');
        stringBuffer.append("valuesDouble");
        stringBuffer.append('[');
        if (this.valuesDouble != null) {
            stringBuffer.append(this.valuesDouble.length);
        }
        stringBuffer.append(']');
        stringBuffer.append('=');
        stringBuffer.append('{');
        if (this.valuesDouble != null) {
            n3 = this.valuesDouble.length;
            n2 = n3 - 1;
            for (n = 0; n < n3; ++n) {
                stringBuffer.append(this.valuesDouble[n]);
                if (n >= n2) continue;
                stringBuffer.append(',');
            }
        } else {
            stringBuffer.append(this.valuesDouble);
        }
        stringBuffer.append('}');
        stringBuffer.append(',');
