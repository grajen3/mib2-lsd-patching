...
public class TrackData {
    ...
    public void toTrace(PrintWriter printWriter) {
        ...
        printWriter.print('=');
        printWriter.print('\"');
        printWriter.print(this.album);
        printWriter.print('\"');
        printWriter.print(',');
        printWriter.print("artist");
        printWriter.print('=');
        printWriter.print('\"');
        printWriter.print(this.artist);
        printWriter.print('\"');
        printWriter.print(',');
        printWriter.print("genre");
        printWriter.print('=');
        printWriter.print('\"');
        printWriter.print(this.genre);
        printWriter.print('\"');
        printWriter.print(',');
        printWriter.print("composer");
        printWriter.print('=');
        printWriter.print('\"');
        printWriter.print(this.composer);
        printWriter.print('\"');
        printWriter.print(')');
    }
