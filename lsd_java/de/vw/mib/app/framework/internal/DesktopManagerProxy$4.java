...
implements Runnable {
    ...
    DesktopManagerProxy$4(DesktopManagerProxy desktopManagerProxy, ViewHandler viewHandler, String[] stringArray) {
    ...
    @Override
    public void run() {
        this.this$0.desktopManager.openPopup(this.val$view, this.val$screenAreaPath);
    }
}
