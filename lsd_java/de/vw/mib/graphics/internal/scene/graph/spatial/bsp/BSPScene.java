 ...
 */
package de.vw.mib.graphics.internal.scene.graph.spatial.bsp;

import de.vw.mib.NotYetImplementedException;
import de.vw.mib.graphics.Graphics3D;
import de.vw.mib.graphics.internal.scene.AbstractScene;
import de.vw.mib.graphics.internal.scene.graph.spatial.bsp.BSPSceneNode;
import de.vw.mib.graphics.internal.spatial.bsp.BSP;
...
public final class BSPScene
extends AbstractScene {
    private static final long serialVersionUID;
    private BSP bsp = new BSP();

    public BSPScene(Graphics3D graphics3D, Logger logger, SceneManager sceneManager) {
        super(graphics3D, logger, sceneManager);
    }

    @Override
    public SceneNode createSceneNode() {
        return new BSPSceneNode();
    }
