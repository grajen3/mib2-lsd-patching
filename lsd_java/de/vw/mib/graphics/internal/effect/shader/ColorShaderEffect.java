...
public final class ColorShaderEffect
extends TransformColorShaderEffect
implements ColorEffect {
    private static String[] VERTEX_SHADER_FILE_NAMES = new String[]{"TransformColor"};
    private static String[] FRAGMENT_SHADER_FILE_NAMES = new String[]{"Color"};

    public ColorShaderEffect(ShaderEffectManager shaderEffectManager) {
    ...
    protected void updateAllocationStatistics(EffectPerformanceMetrics effectPerformanceMetrics, boolean bl) {
        effectPerformanceMetrics.allocatedColorEffects = effectPerformanceMetrics.allocatedColorEffects + (bl ? 1 : -1);
    }
