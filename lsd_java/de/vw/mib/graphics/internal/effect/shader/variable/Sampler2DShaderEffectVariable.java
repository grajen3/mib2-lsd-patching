...
public final class Sampler2DShaderEffectVariable
extends AbstractShaderEffectVariable
implements SamplerShaderEffectVariable {
    private int sampler = -1;

    public Sampler2DShaderEffectVariable(ShaderProgram shaderProgram, String string) {
        super(shaderProgram, 1, string, 15, 1);
    }
