...
public final class DepthVisualizationShaderEffect
extends TransformShaderEffect {
    private static String[] VERTEX_SHADER_FILE_NAMES = new String[]{"Transform"};
    private static String[] FRAGMENT_SHADER_FILE_NAMES = new String[]{"DepthVisualization"};

    public DepthVisualizationShaderEffect(ShaderEffectManager shaderEffectManager) {
    ...
    protected void updateAllocationStatistics(EffectPerformanceMetrics effectPerformanceMetrics, boolean bl) {
        effectPerformanceMetrics.allocatedDepthVisualizationEffects = effectPerformanceMetrics.allocatedDepthVisualizationEffects + (bl ? 1 : -1);
    }
