...
Geometry2D {
    ...
    public Triangle2f(Triangle2f triangle2f) {
        this.point = (Point2f)triangle2f.point.clone();
        this.edge0 = (Vector2f)triangle2f.edge0.clone();
        this.edge1 = (Vector2f)triangle2f.edge1.clone();
    }

    public Triangle2f(Point2f point2f, Vector2f vector2f, Vector2f vector2f2) {
        this();
        this.set(point2f, vector2f, vector2f2);
    }

    public Triangle2f(Point2f point2f, Point2f point2f2, Point2f point2f3) {
        this();
        this.set(point2f, point2f2, point2f3);
    }

    @Override
    public Object clone() {
        Triangle2f triangle2f = (Triangle2f)super.clone();
        triangle2f.point = (Point2f)this.point.clone();
        triangle2f.edge0 = (Vector2f)this.edge0.clone();
        triangle2f.edge1 = (Vector2f)this.edge1.clone();
        return triangle2f;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (object != null && super.getClass() == object.getClass()) {
            Triangle2f triangle2f = (Triangle2f)object;
            return this.point.equals(triangle2f.point) && this.edge0.equals(triangle2f.edge0) && this.edge1.equals(triangle2f.edge1);
        }
        return false;
    }
    ...
    public void set(Triangle2f triangle2f) {
        if (this != triangle2f) {
            this.point.set(triangle2f.point);
            this.edge0.set(triangle2f.edge0);
            this.edge1.set(triangle2f.edge1);
        }
    }
    ...
    public void set(Point2f point2f, Point2f point2f2, Point2f point2f3) {
        this.point.set(point2f);
        point2f2.sub(this.point, this.edge0);
        point2f3.sub(this.point, this.edge1);
    }
    ...
    public void getVertex0(Point2f point2f) {
        point2f.set(this.point);
    }

    public void setVertex0(Point2f point2f) {
        this.point.set(point2f);
    }

    public void getVertex1(Point2f point2f) {
        this.point.add(this.edge0, point2f);
    }

    public void setVertex1(Point2f point2f) {
        point2f.sub(this.point, this.edge0);
    }

    public void getVertex2(Point2f point2f) {
        this.point.add(this.edge1, point2f);
    }

    public void setVertex2(Point2f point2f) {
        point2f.sub(this.point, this.edge1);
    }
    ...
    public void getEdge(int n, LineSegment2f lineSegment2f) {
        ...
        switch (n) {
            ...
            case 1: {
                this.point.add(this.edge0, point2f);
                this.edge1.sub(this.edge0, vector2f);
    ...
    public void transform(Matrix3f matrix3f, Triangle2f triangle2f) {
        try {
            matrix3f.mul(this.point, triangle2f.point);
            Matrix3f matrix3f2 = new Matrix3f();
            matrix3f.invert(matrix3f2);
            matrix3f2.transpose();
            matrix3f2.mul(this.edge0, triangle2f.edge0);
            matrix3f2.mul(this.edge1, triangle2f.edge1);
        }
