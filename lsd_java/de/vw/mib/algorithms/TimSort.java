...
public class TimSort {
    ...
    static /* synthetic */ Class class$de$vw$mib$algorithms$TimSort;

    private TimSort(Object[] objectArray, Comparator comparator, Object[] objectArray2, int n, int n2) {
        int n3;
        ...
        if (objectArray2 == null || n2 < n3 || n + n3 > objectArray2.length) {
            Object[] objectArray3 = (Object[])Array.newInstance(super.getClass().getComponentType(), n3);
            this.temp = objectArray3;
            this.tempBase = 0;
            this.tempLen = n3;
        } else {
    ...
    public static void sort(Object[] objectArray, int n, int n2, Comparator comparator) {
        int n3;
        if (!($assertionsDisabled || comparator != null && objectArray != null && n >= 0 && n <= n2 && n2 <= objectArray.length)) {
        ...
        if (n4 < 32) {
            int n5 = TimSort.countRunAndMakeAscending(objectArray, n, n2, comparator);
            TimSort.binarySort(objectArray, n, n2, n + n5, comparator);
            return;
        }
        TimSort timSort = new TimSort(objectArray, comparator, null, 0, 0);
        int n6 = TimSort.minRunLength(n4);
        do {
            if ((n3 = TimSort.countRunAndMakeAscending(objectArray, n, n2, comparator)) < n6) {
                int n7 = n4 <= n6 ? n4 : n6;
                TimSort.binarySort(objectArray, n, n + n7, n + n3, comparator);
                n3 = n7;
            }
            timSort.pushRun(n, n3);
    ...
    private static void binarySort(Object[] objectArray, int n, int n2, int n3, Comparator comparator) {
        ...
        while (n3 < n2) {
            ...
            while (n5 < n6) {
                n4 = n5 + n6 >>> 1;
                if (comparator.compare(object, objectArray[n4]) < 0) {
                    n6 = n4;
                    continue;
                }
                n5 = n4 + 1;
    ...
    private static int countRunAndMakeAscending(Object[] objectArray, int n, int n2, Comparator comparator) {
        if (!$assertionsDisabled && n >= n2) {
            throw new AssertionError();
        }
        int n3 = n + 1;
        ...
        if (comparator.compare(objectArray[n3++], objectArray[n]) < 0) {
            while (n3 < n2 && comparator.compare(objectArray[n3], objectArray[n3 - 1]) < 0) {
                ++n3;
            }
            TimSort.reverseRange(objectArray, n, n3);
        } else {
            while (n3 < n2 && comparator.compare(objectArray[n3], objectArray[n3 - 1]) >= 0) {
                ++n3;
            }
    ...
    private void mergeAt(int n) {
        ...
        --this.stackSize;
        int n6 = TimSort.gallopRight(this.array[n4], this.array, n2, n3, 0, this.comparator);
        ...
        n5 = TimSort.gallopLeft(this.array[n2 + n3 - 1], this.array, n4, n5, n5 - 1, this.comparator);
    ...
    private static int gallopLeft(Object object, Object[] objectArray, int n, int n2, int n3, Comparator comparator) {
        int n4;
        ...
        int n5 = 0;
        int n6 = 1;
        if (comparator.compare(object, objectArray[n + n3]) > 0) {
            n4 = n2 - n3;
            while (n6 < n4 && comparator.compare(object, objectArray[n + n3 + n6]) > 0) {
                n5 = n6;
        ...
        while (n5 < n6) {
            n4 = n5 + (n6 - n5 >>> 1);
            if (comparator.compare(object, objectArray[n + n4]) > 0) {
                n5 = n4 + 1;
                continue;
            }
            n6 = n4;
    ...
    private static int gallopRight(Object object, Object[] objectArray, int n, int n2, int n3, Comparator comparator) {
        int n4;
        if (!($assertionsDisabled || n2 > 0 && n3 >= 0 && n3 < n2)) {
            throw new AssertionError();
        }
        ...
        if (comparator.compare(object, objectArray[n + n3]) < 0) {
            n4 = n3 + 1;
            while (n5 < n4 && comparator.compare(object, objectArray[n + n3 - n5]) < 0) {
                n6 = n5;
    ...
    private void mergeLo(int n, int n2, int n3, int n4) {
        ...
        block0: while (true) {
            ...
            do {
                ...
                if (comparator.compare(objectArray[n6], objectArray2[n5]) < 0) {
                    objectArray[n7++] = objectArray[n6++];
                    ++n10;
                    n9 = 0;
                    if (--n4 != 0) continue;
            ...
            do {
                ...
                n9 = TimSort.gallopRight(objectArray[n6], objectArray2, n5, n2, 0, comparator);
                if (n9 != 0) {
                ...
                n10 = TimSort.gallopLeft(objectArray2[n5], objectArray, n6, n4, 0, comparator);
                if (n10 != 0) {
    ...
    private void mergeHi(int n, int n2, int n3, int n4) {
        ...
        block0: while (true) {
            ...
            do {
                ...
                if (comparator.compare(objectArray2[n7], objectArray[n6]) < 0) {
                    objectArray[n8--] = objectArray[n6--];
                    ++n10;
                    n11 = 0;
                    if (--n2 != 0) continue;
            ...
            do {
                ...
                n10 = n2 - TimSort.gallopRight(objectArray2[n7], objectArray, n, n2, n2 - 1, comparator);
                if (n10 != 0) {
                ...
                objectArray[n8--] = objectArray2[n7--];
                if (--n4 == 1) break block0;
                n11 = n4 - TimSort.gallopLeft(objectArray[n6], objectArray2, n5, n4, n4 - 1, comparator);
                if (n11 != 0) {
    ...
    private Object[] ensureCapacity(int n) {
        if (this.tempLen < n) {
            ...
            Object[] objectArray = (Object[])Array.newInstance(super.getClass().getComponentType(), n2);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$algorithms$TimSort == null ? (class$de$vw$mib$algorithms$TimSort = TimSort.class$("de.vw.mib.algorithms.TimSort")) : class$de$vw$mib$algorithms$TimSort).desiredAssertionStatus();
    }
}
