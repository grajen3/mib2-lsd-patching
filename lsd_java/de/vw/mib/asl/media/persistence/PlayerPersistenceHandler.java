...
class PlayerPersistenceHandler
extends AbstractPersistenceDataHandler {
    private final PlayerPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$media$persistence$PlayerPersistenceHandler;

    PlayerPersistenceHandler(PlayerPersistence playerPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    public void handle(int n, int n2) {
        switch (n) {
            case 2: {
                this.handledPersistable.setParentalManagementLevel(n2);
    ...
    public void handle(int n, String string) {
        switch (n) {
            case 1: {
                this.handledPersistable.setParentalManagementPin(string);
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    protected void installDefaultValue(int n) {
        switch (n) {
            ...
            case 2: {
                this.handledPersistable.setParentalManagementLevel(0);
                break;
            }
            default: {
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$media$persistence$PlayerPersistenceHandler == null ? (class$de$vw$mib$asl$media$persistence$PlayerPersistenceHandler = PlayerPersistenceHandler.class$("de.vw.mib.asl.media.persistence.PlayerPersistenceHandler")) : class$de$vw$mib$asl$media$persistence$PlayerPersistenceHandler).desiredAssertionStatus();
    }
}
