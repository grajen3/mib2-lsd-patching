...
class SourcesPersistenceUserHandler
extends AbstractPersistenceDataHandler {
    private final SourcesPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$media$persistence$SourcesPersistenceUserHandler;

    SourcesPersistenceUserHandler(SourcesPersistence sourcesPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    public void handle(int n, int n2) {
        switch (n) {
            case 5: {
                this.handledPersistable.setObjectId(n2);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$media$persistence$SourcesPersistenceUserHandler == null ? (class$de$vw$mib$asl$media$persistence$SourcesPersistenceUserHandler = SourcesPersistenceUserHandler.class$("de.vw.mib.asl.media.persistence.SourcesPersistenceUserHandler")) : class$de$vw$mib$asl$media$persistence$SourcesPersistenceUserHandler).desiredAssertionStatus();
    }
}
