...
class ResourceLocatorPersistenceHandler
extends AbstractPersistenceDataHandler {
    private final ResourceLocatorPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$ResourceLocatorPersistenceHandler;

    ResourceLocatorPersistenceHandler(ResourceLocatorPersistence resourceLocatorPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && resourceLocatorPersistence == null) {
            throw new AssertionError();
        }
        this.handledPersistable = resourceLocatorPersistence;
