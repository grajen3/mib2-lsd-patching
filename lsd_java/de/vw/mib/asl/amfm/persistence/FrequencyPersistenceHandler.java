...
class FrequencyPersistenceHandler
extends AbstractPersistenceDataHandler {
    private final FrequencyPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$FrequencyPersistenceHandler;

    FrequencyPersistenceHandler(FrequencyPersistence frequencyPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && frequencyPersistence == null) {
            throw new AssertionError();
        }
        this.handledPersistable = frequencyPersistence;
    ...
    public void handle(int n, long l) {
        switch (n) {
            case 1: {
                this.handledPersistable.setFrequency(l);
        ...
        switch (n) {
            case 2: {
                if (!this.performValidation() || string != null) {
                    this.handledPersistable.setLabel(string);
                    this.markAsProcessed(n);
                    break;
                }
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$amfm$persistence$FrequencyPersistenceHandler == null ? (class$de$vw$mib$asl$amfm$persistence$FrequencyPersistenceHandler = FrequencyPersistenceHandler.class$("de.vw.mib.asl.amfm.persistence.FrequencyPersistenceHandler")) : class$de$vw$mib$asl$amfm$persistence$FrequencyPersistenceHandler).desiredAssertionStatus();
    }
}
