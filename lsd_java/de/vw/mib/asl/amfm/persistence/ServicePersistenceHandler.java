...
class ServicePersistenceHandler
extends AbstractPersistenceDataHandler {
    private final ServicePersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$ServicePersistenceHandler;

    ServicePersistenceHandler(ServicePersistence servicePersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && servicePersistence == null) {
            throw new AssertionError();
        }
        this.handledPersistable = servicePersistence;
    ...
    public void handle(int n, byte by) {
        switch (n) {
            case 6: {
                this.handledPersistable.getPtyCodes().add(new Byte(by));
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    public void handle(int n, long l) {
        switch (n) {
            case 8: {
                this.handledPersistable.setServiceId(l);
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$amfm$persistence$ServicePersistenceHandler == null ? (class$de$vw$mib$asl$amfm$persistence$ServicePersistenceHandler = ServicePersistenceHandler.class$("de.vw.mib.asl.amfm.persistence.ServicePersistenceHandler")) : class$de$vw$mib$asl$amfm$persistence$ServicePersistenceHandler).desiredAssertionStatus();
    }
}
