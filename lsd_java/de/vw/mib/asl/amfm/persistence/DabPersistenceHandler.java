...
class DabPersistenceHandler
extends AbstractPersistenceDataHandler {
    private final DabPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$DabPersistenceHandler;

    DabPersistenceHandler(DabPersistence dabPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    public void handle(int n, int n2) {
        switch (n) {
            case 21: {
                this.handledPersistable.setCurrentBand1(n2);
                this.markAsProcessed(n);
                break;
            }
            case 22: {
                this.handledPersistable.setCurrentBand2(n2);
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    protected void installDefaultValue(int n) {
        switch (n) {
            case 21: {
                ...
                this.handledPersistable.setCurrentBand1(DabPersistable.getDefaultDabBand1Setting());
                break;
            }
            case 22: {
                if (!this.invokeExternalMethods()) break;
                this.handledPersistable.setCurrentBand2(DabPersistable.getDefaultDabBand2Setting());
                break;
            }
            default: {
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$amfm$persistence$DabPersistenceHandler == null ? (class$de$vw$mib$asl$amfm$persistence$DabPersistenceHandler = DabPersistenceHandler.class$("de.vw.mib.asl.amfm.persistence.DabPersistenceHandler")) : class$de$vw$mib$asl$amfm$persistence$DabPersistenceHandler).desiredAssertionStatus();
    }
}
