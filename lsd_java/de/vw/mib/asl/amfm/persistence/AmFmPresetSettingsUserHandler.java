...
class AmFmPresetSettingsUserHandler
extends AbstractPersistenceDataHandler {
    private final AmFmPresetSettings handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$AmFmPresetSettingsUserHandler;

    AmFmPresetSettingsUserHandler(AmFmPresetSettings amFmPresetSettings, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && amFmPresetSettings == null) {
            throw new AssertionError();
        }
        this.handledPersistable = amFmPresetSettings;
    ...
    public void handle(int n, int n2) {
        switch (n) {
            case 3: {
                this.handledPersistable.setCurrentBankIndexAm(n2);
                this.markAsProcessed(n);
                break;
            }
            case 4: {
                this.handledPersistable.setCurrentBankIndexFm(n2);
                this.markAsProcessed(n);
                break;
            }
            case 5: {
                this.handledPersistable.setCurrentIndexAm(n2);
                this.markAsProcessed(n);
                break;
            }
            case 6: {
                this.handledPersistable.setCurrentIndexFm(n2);
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    public void handle(int n, Persistable persistable) {
        switch (n) {
            case 1: {
                this.handledPersistable.getAmPresets().add(persistable);
                this.markAsProcessed(n);
                break;
            }
            case 2: {
                this.handledPersistable.getFmPresets().add(persistable);
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    protected void installDefaultValue(int n) {
        switch (n) {
            ...
            case 3: {
                this.handledPersistable.setCurrentBankIndexAm(0);
                break;
            }
            case 4: {
                this.handledPersistable.setCurrentBankIndexFm(0);
                break;
            }
            case 5: {
                if (!this.invokeExternalMethods()) break;
                this.handledPersistable.setCurrentIndexAm(AmFmSettingsPersistable.getDefaultPresetIndexValue());
                break;
            }
            case 6: {
                if (!this.invokeExternalMethods()) break;
                this.handledPersistable.setCurrentIndexFm(AmFmSettingsPersistable.getDefaultPresetIndexValue());
                break;
            }
            default: {
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$amfm$persistence$AmFmPresetSettingsUserHandler == null ? (class$de$vw$mib$asl$amfm$persistence$AmFmPresetSettingsUserHandler = AmFmPresetSettingsUserHandler.class$("de.vw.mib.asl.amfm.persistence.AmFmPresetSettingsUserHandler")) : class$de$vw$mib$asl$amfm$persistence$AmFmPresetSettingsUserHandler).desiredAssertionStatus();
    }
}
