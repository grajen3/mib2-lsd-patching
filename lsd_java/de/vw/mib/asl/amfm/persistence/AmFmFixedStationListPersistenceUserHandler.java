...
class AmFmFixedStationListPersistenceUserHandler
extends AbstractPersistenceDataHandler {
    private final AmFmFixedStationListPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$AmFmFixedStationListPersistenceUserHandler;

    AmFmFixedStationListPersistenceUserHandler(AmFmFixedStationListPersistence amFmFixedStationListPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && amFmFixedStationListPersistence == null) {
            throw new AssertionError();
        }
        this.handledPersistable = amFmFixedStationListPersistence;
    ...
    public void handle(int n, Persistable persistable) {
        switch (n) {
            case 1: {
                this.handledPersistable.getFixedStationListPersistence().add(persistable);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$amfm$persistence$AmFmFixedStationListPersistenceUserHandler == null ? (class$de$vw$mib$asl$amfm$persistence$AmFmFixedStationListPersistenceUserHandler = AmFmFixedStationListPersistenceUserHandler.class$("de.vw.mib.asl.amfm.persistence.AmFmFixedStationListPersistenceUserHandler")) : class$de$vw$mib$asl$amfm$persistence$AmFmFixedStationListPersistenceUserHandler).desiredAssertionStatus();
    }
}
