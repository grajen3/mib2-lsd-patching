...
class AmFmPresetSettingsHandler
extends AbstractPersistenceDataHandler {
    private final AmFmPresetSettings handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$AmFmPresetSettingsHandler;

    AmFmPresetSettingsHandler(AmFmPresetSettings amFmPresetSettings, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
