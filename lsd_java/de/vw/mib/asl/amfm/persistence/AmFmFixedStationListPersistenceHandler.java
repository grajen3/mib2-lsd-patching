...
class AmFmFixedStationListPersistenceHandler
extends AbstractPersistenceDataHandler {
    private final AmFmFixedStationListPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$AmFmFixedStationListPersistenceHandler;

    AmFmFixedStationListPersistenceHandler(AmFmFixedStationListPersistence amFmFixedStationListPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
