...
class ComponentPersistenceHandler
extends AbstractPersistenceDataHandler {
    private final ComponentPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$amfm$persistence$ComponentPersistenceHandler;

    ComponentPersistenceHandler(ComponentPersistence componentPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && componentPersistence == null) {
            throw new AssertionError();
        }
        this.handledPersistable = componentPersistence;
    ...
    public void handle(int n, boolean bl) {
        switch (n) {
            case 7: {
                this.handledPersistable.setPrimaryService(bl);
    ...
    public void handle(int n, int n2) {
        switch (n) {
            ...
            case 4: {
                this.handledPersistable.setScidi(n2);
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    public void handle(int n, long l) {
        switch (n) {
            case 3: {
                this.handledPersistable.setSid(l);
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$amfm$persistence$ComponentPersistenceHandler == null ? (class$de$vw$mib$asl$amfm$persistence$ComponentPersistenceHandler = ComponentPersistenceHandler.class$("de.vw.mib.asl.amfm.persistence.ComponentPersistenceHandler")) : class$de$vw$mib$asl$amfm$persistence$ComponentPersistenceHandler).desiredAssertionStatus();
    }
}
