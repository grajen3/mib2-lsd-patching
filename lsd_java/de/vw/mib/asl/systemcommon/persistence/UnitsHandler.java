...
extends AbstractPersistenceDataHandler {
    ...
    static /* synthetic */ Class class$de$vw$mib$asl$systemcommon$persistence$UnitsHandler;

    UnitsHandler(Units units, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$systemcommon$persistence$UnitsHandler == null ? (class$de$vw$mib$asl$systemcommon$persistence$UnitsHandler = UnitsHandler.class$("de.vw.mib.asl.systemcommon.persistence.UnitsHandler")) : class$de$vw$mib$asl$systemcommon$persistence$UnitsHandler).desiredAssertionStatus();
    }
}
