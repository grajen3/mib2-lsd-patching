...
class GlobalSetupWizardDescriptorHandler
extends AbstractPersistenceDataHandler {
    private final GlobalSetupWizardDescriptor handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$globalsetupwizard$persistence$GlobalSetupWizardDescriptorHandler;

    GlobalSetupWizardDescriptorHandler(GlobalSetupWizardDescriptor globalSetupWizardDescriptor, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$globalsetupwizard$persistence$GlobalSetupWizardDescriptorHandler == null ? (class$de$vw$mib$asl$globalsetupwizard$persistence$GlobalSetupWizardDescriptorHandler = GlobalSetupWizardDescriptorHandler.class$("de.vw.mib.asl.globalsetupwizard.persistence.GlobalSetupWizardDescriptorHandler")) : class$de$vw$mib$asl$globalsetupwizard$persistence$GlobalSetupWizardDescriptorHandler).desiredAssertionStatus();
    }
}
