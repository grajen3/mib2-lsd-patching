...
public class SelectJukeboxAction
extends AbstractSourceSelectAction {
    public SelectJukeboxAction(ResultHandler resultHandler, MediaServiceController mediaServiceController) {
    ...
    protected void onRecognition(String string) {
        if (this.logger.isTraceEnabled()) {
            this.logger.trace("Jukebox action");
        }
        this.msController.activateSource(0);
    }
