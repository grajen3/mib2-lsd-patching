...
public abstract class AbstractGridMenuTarget
implements Target {
    ...
    public AbstractGridMenuTarget(GenericEvents genericEvents, Logger logger, int n) {
    ...
    public void addObserver(int n) {
        this.genericEvents.getServiceRegister().addObserver(n, this.targetId);
    }
