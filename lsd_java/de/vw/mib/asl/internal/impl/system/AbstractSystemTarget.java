...
public abstract class AbstractSystemTarget
implements Target {
    ...
    public AbstractSystemTarget(GenericEvents genericEvents, Logger logger, int n) {
    ...
    private void registerTarget() {
        try {
            ...
            this.logger.error(2048).append("Could not register target ").append(super.getClass().getName()).attachThrowable(exception).log();
        }
    }
}
