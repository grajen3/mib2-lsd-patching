...
extends KombiViewState {
    ...
    static /* synthetic */ Class class$de$vw$mib$asl$internal$mostkombi$kombiview$states$InitializeState;

    public InitializeState(KombiViewHsmContext kombiViewHsmContext, HsmState hsmState) {
        super(kombiViewHsmContext, (class$de$vw$mib$asl$internal$mostkombi$kombiview$states$InitializeState == null ? (class$de$vw$mib$asl$internal$mostkombi$kombiview$states$InitializeState = InitializeState.class$("de.vw.mib.asl.internal.mostkombi.kombiview.states.InitializeState")) : class$de$vw$mib$asl$internal$mostkombi$kombiview$states$InitializeState).getName(), hsmState);
    }
