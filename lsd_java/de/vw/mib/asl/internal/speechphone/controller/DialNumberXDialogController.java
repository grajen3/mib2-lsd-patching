...
public class DialNumberXDialogController
extends AbstractDialNumberResultItemController {
    public DialNumberXDialogController(ServiceFunctions serviceFunctions, PhoneHandler phoneHandler, ResultItemHandler resultItemHandler) {
    ...
    protected void onRecognizedNumber(String string) {
        ...
        if (this.handleNumberMaxLength(string)) {
            ...
            this.serviceFunctions.sendHMIEvent(-1800848640);
        }
    }
}
