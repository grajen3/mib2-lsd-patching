 ...
 */
package de.vw.mib.asl.internal.phone.presets.transformer;
...
import generated.de.vw.mib.asl.internal.phone.presets.transformer.AbstractPhonePresetsPresetsTransformer;
import org.dsi.ifc.global.ResourceLocator;

public class PhonePresetsPresetsTransformer
extends AbstractPhonePresetsPresetsTransformer {
    @Override
    public int getInt(int n, Object object) {
        ...
        switch (n) {
            ...
            case 9: {
                return bl ? -1 : phonePresetCollector.adbEntry.phoneData[phonePresetCollector.phoneDataIdx].numberType;
            }
        }
