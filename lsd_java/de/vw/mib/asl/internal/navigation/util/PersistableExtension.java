...
public final class PersistableExtension
extends AbstractSharedPersistable
implements PersistableMap,
IPersistableExtension {
    private boolean isLoaded = false;
    private static PersistableExtension mpInstance = new PersistableExtension();
    private PersistableMapImpl myData = new PersistableMapImpl(this);

    private PersistableExtension() {
        super(5006, 0);
    }
    ...
    public static PersistableExtension getInstance() {
        return mpInstance;
    }
