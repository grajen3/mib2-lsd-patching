...
public abstract class AbstractMapViewerKombiStateMapScaleContinuous
extends AbstractHsmState {
    private final IExtLogger logger;
    protected final MapViewerKombiTargetHSM target;
    ...
    public AbstractMapViewerKombiStateMapScaleContinuous(MapViewerKombiTargetHSM mapViewerKombiTargetHSM, String string, HsmState hsmState) {
        ...
        this.timerServer = mapViewerKombiTargetHSM.getTimerServer();
    }
