...
public class MapContentChangerStateDetailScreenDualList
extends AbstractHsmState {
    private IExtLogger logger = ASLNavigationUtilFactory.getNavigationUtilApi().getExtLogger(256, "[MapContentChangerStateDetailScreenDualList]");
    private final MapContentChangerTargetHSM target;

    public MapContentChangerStateDetailScreenDualList(MapContentChangerTargetHSM mapContentChangerTargetHSM, String string, HsmState hsmState) {
