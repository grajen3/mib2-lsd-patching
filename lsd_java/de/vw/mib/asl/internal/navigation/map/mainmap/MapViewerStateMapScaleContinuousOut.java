...
public class MapViewerStateMapScaleContinuousOut
extends AbstractMapViewerStateMapScaleContinuous {
    ...
    public MapViewerStateMapScaleContinuousOut(MapViewerTargetHSM mapViewerTargetHSM, String string, HsmState hsmState) {
