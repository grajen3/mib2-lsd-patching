...
public class MapInMapViewerAutoZoomNotifierModel {
    private final IExtLogger logger = ASLNavigationUtilFactory.getNavigationUtilApi().getExtLogger(256, "[MapInMapViewerAutoZoomNotifierModel]");
