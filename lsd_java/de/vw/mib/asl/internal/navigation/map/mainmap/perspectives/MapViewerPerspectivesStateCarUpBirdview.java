...
public final class MapViewerPerspectivesStateCarUpBirdview
extends AbstractHsmState {
    private final IExtLogger logger = ASLNavigationUtilFactory.getNavigationUtilApi().getExtLogger(256, "[MapViewerPerspectivesStateCarUpBirdview]");
    private final MapViewerPerspectivesTargetHSM target;

    public MapViewerPerspectivesStateCarUpBirdview(MapViewerPerspectivesTargetHSM mapViewerPerspectivesTargetHSM, String string, HsmState hsmState) {
    ...
    private void handleExit() {
        ...
        this.target.datapool.setPerspective25DCarUp(false);
    }

    private void handleStart() {
        this.logger.trace("handleStart()");
        this.target.datapool.setMainMapPerspective(2);
        this.target.datapool.setPerspective25DCarUp(true);
        this.target.notifierDSI.viewFreezeTrue();
        this.target.notifierDSI.setViewTypeBirdview();
        ...
        this.target.notifierModel.notifyPerspective25DHeading();
    }
}
