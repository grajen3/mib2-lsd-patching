...
public class MapInMapViewerTouchgesturesStateTwoFingerZoom
extends AbstractHsmState {
    private final IExtLogger logger = ASLNavigationUtilFactory.getNavigationUtilApi().getExtLogger(256, "[MapInMapTouchgesturesStateTwoFingerZoom]");
    private final MapInMapViewerTouchgesturesTarget target;

    public MapInMapViewerTouchgesturesStateTwoFingerZoom(MapInMapViewerTouchgesturesTarget mapInMapViewerTouchgesturesTarget, String string, HsmState hsmState) {
