...
public class MapViewerPerspectivesStatePNav
extends AbstractHsmState {
    private final IExtLogger logger = ASLNavigationUtilFactory.getNavigationUtilApi().getExtLogger(256, "[MapViewerPerspectivesStatePNav]");
    private final MapViewerPerspectivesTargetHSM target;

    public MapViewerPerspectivesStatePNav(MapViewerPerspectivesTargetHSM mapViewerPerspectivesTargetHSM, String string, HsmState hsmState) {
    ...
    private void handleExit() {
        ...
        this.target.datapool.setPerspectivePNavOverview(false);
        if (this.target.datapool.isRangeViewBeforePNav()) {
    ...
    private void handleStart() {
        ...
        this.target.datapool.setPerspectivePNavOverview(true);
        this.target.notifierDSI.viewFreezeTrue();
        this.target.notifierDSI.setModePNavOverview();
