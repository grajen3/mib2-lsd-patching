...
public class MapContentChangerStatePNavShowInMap
extends AbstractHsmState {
    private IExtLogger logger = ASLNavigationUtilFactory.getNavigationUtilApi().getExtLogger(256, "[MapContentChangerStatePNavShowInMap]");
    private MapContentChangerTargetHSM target;

    public MapContentChangerStatePNavShowInMap(MapContentChangerTargetHSM mapContentChangerTargetHSM, String string, HsmState hsmState) {
    ...
    private void handleExit() {
        this.target.notifierDSI.setRouteVisibility(false);
        this.logger.trace("handleExit()");
    }

    private void handleStart() {
        this.logger.trace("handleStart()");
        this.target.notifierDSI.setRouteVisibility(true);
