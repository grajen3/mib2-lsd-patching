...
public class MapContentChangerStateDetailScreenChnCrosshairInput
extends AbstractHsmState {
    private IExtLogger logger = ASLNavigationUtilFactory.getNavigationUtilApi().getExtLogger(256, "[MapContentChangerStateDetailScreenChnCrosshairInput]");
    MapContentChangerTargetHSM target;

    public MapContentChangerStateDetailScreenChnCrosshairInput(MapContentChangerTargetHSM mapContentChangerTargetHSM, String string, HsmState hsmState) {
    ...
    private void handleStart() {
        ...
        this.target.datapool.getQueuedGotoLocations().remove(new Integer(27));
