...
public final class LR150e1561f
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateStreet1stStreetWithBasenames)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateStreet1stStreetWithBasenames)object).toString();
                }
                case 51: {
                    return ((StateStreet1stStreetWithBasenames)object).getName();
                }
                case 52: {
                    return ((StateStreet1stStreetWithBasenames)object).getParent();
                }
                case 53: {
                    ((StateStreet1stStreetWithBasenames)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateStreet1stStreetWithBasenames)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateStreet1stStreetWithBasenames)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateStreet1stStreetWithBasenames)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateStreet1stStreetWithBasenames)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateStreet1stStreetWithBasenames)object).hashCode());
                }
                case 59: {
                    return ((StateStreet1stStreetWithBasenames)object).getClass();
                }
                case 60: {
                    ((StateStreet1stStreetWithBasenames)object).notify();
                    return null;
                }
                case 61: {
                    ((StateStreet1stStreetWithBasenames)object).notifyAll();
                    return null;
                }
            }
            return null;
