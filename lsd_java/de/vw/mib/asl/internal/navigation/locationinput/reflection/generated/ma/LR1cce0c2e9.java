...
public final class LR1cce0c2e9
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateStreetDisambiguation)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateStreetDisambiguation)object).toString();
                }
                case 51: {
                    return ((StateStreetDisambiguation)object).getName();
                }
                case 52: {
                    return ((StateStreetDisambiguation)object).getParent();
                }
                case 53: {
                    ((StateStreetDisambiguation)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateStreetDisambiguation)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateStreetDisambiguation)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateStreetDisambiguation)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateStreetDisambiguation)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateStreetDisambiguation)object).hashCode());
                }
                case 59: {
                    return ((StateStreetDisambiguation)object).getClass();
                }
                case 60: {
                    ((StateStreetDisambiguation)object).notify();
                    return null;
                }
                case 61: {
                    ((StateStreetDisambiguation)object).notifyAll();
                    return null;
                }
            }
            return null;
