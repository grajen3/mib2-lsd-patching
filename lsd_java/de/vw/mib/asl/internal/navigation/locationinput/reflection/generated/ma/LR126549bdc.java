...
public final class LR126549bdc
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateWard)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateWard)object).toString();
                }
                case 51: {
                    return ((StateWard)object).getName();
                }
                case 52: {
                    return ((StateWard)object).getParent();
                }
                case 53: {
                    ((StateWard)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateWard)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateWard)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateWard)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateWard)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateWard)object).hashCode());
                }
                case 59: {
                    return ((StateWard)object).getClass();
                }
                case 60: {
                    ((StateWard)object).notify();
                    return null;
                }
                case 61: {
                    ((StateWard)object).notifyAll();
                    return null;
                }
            }
            return null;
