...
public final class LR1a3e0b1f1
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StatePlace)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StatePlace)object).toString();
                }
                case 51: {
                    return ((StatePlace)object).getName();
                }
                case 52: {
                    return ((StatePlace)object).getParent();
                }
                case 53: {
                    ((StatePlace)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StatePlace)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StatePlace)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StatePlace)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StatePlace)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StatePlace)object).hashCode());
                }
                case 59: {
                    return ((StatePlace)object).getClass();
                }
                case 60: {
                    ((StatePlace)object).notify();
                    return null;
                }
                case 61: {
                    ((StatePlace)object).notifyAll();
                    return null;
                }
            }
            return null;
