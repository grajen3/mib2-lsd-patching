...
public final class LR1e3675b1f
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateStreet1stZipCode)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateStreet1stZipCode)object).toString();
                }
                case 51: {
                    return ((StateStreet1stZipCode)object).getName();
                }
                case 52: {
                    return ((StateStreet1stZipCode)object).getParent();
                }
                case 53: {
                    ((StateStreet1stZipCode)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateStreet1stZipCode)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateStreet1stZipCode)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateStreet1stZipCode)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateStreet1stZipCode)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateStreet1stZipCode)object).hashCode());
                }
                case 59: {
                    return ((StateStreet1stZipCode)object).getClass();
                }
                case 60: {
                    ((StateStreet1stZipCode)object).notify();
                    return null;
                }
                case 61: {
                    ((StateStreet1stZipCode)object).notifyAll();
                    return null;
                }
            }
            return null;
