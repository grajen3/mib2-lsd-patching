...
public final class LR18ae92781
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StatePhoneNumber)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StatePhoneNumber)object).toString();
                }
                case 51: {
                    return ((StatePhoneNumber)object).getName();
                }
                case 52: {
                    return ((StatePhoneNumber)object).getParent();
                }
                case 53: {
                    ((StatePhoneNumber)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StatePhoneNumber)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StatePhoneNumber)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StatePhoneNumber)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StatePhoneNumber)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StatePhoneNumber)object).hashCode());
                }
                case 59: {
                    return ((StatePhoneNumber)object).getClass();
                }
                case 60: {
                    ((StatePhoneNumber)object).notify();
                    return null;
                }
                case 61: {
                    ((StatePhoneNumber)object).notifyAll();
                    return null;
                }
            }
            return null;
