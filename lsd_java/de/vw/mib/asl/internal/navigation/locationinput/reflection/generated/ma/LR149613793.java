...
public final class LR149613793
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateHousenumber)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateHousenumber)object).toString();
                }
                case 51: {
                    return ((StateHousenumber)object).getName();
                }
                case 52: {
                    return ((StateHousenumber)object).getParent();
                }
                case 53: {
                    ((StateHousenumber)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateHousenumber)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateHousenumber)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateHousenumber)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateHousenumber)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateHousenumber)object).hashCode());
                }
                case 59: {
                    return ((StateHousenumber)object).getClass();
                }
                case 60: {
                    ((StateHousenumber)object).notify();
                    return null;
                }
                case 61: {
                    ((StateHousenumber)object).notifyAll();
                    return null;
                }
            }
            return null;
