...
public final class LR1dc167dd8
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateStreetWithBasenames)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateStreetWithBasenames)object).toString();
                }
                case 51: {
                    return ((StateStreetWithBasenames)object).getName();
                }
                case 52: {
                    return ((StateStreetWithBasenames)object).getParent();
                }
                case 53: {
                    ((StateStreetWithBasenames)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateStreetWithBasenames)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateStreetWithBasenames)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateStreetWithBasenames)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateStreetWithBasenames)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateStreetWithBasenames)object).hashCode());
                }
                case 59: {
                    return ((StateStreetWithBasenames)object).getClass();
                }
                case 60: {
                    ((StateStreetWithBasenames)object).notify();
                    return null;
                }
                case 61: {
                    ((StateStreetWithBasenames)object).notifyAll();
                    return null;
                }
            }
            return null;
