...
public final class LR1e9c9847e
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 45: {
                    return ((NavReflectionState)object).handle((EventGeneric)objectArray[0]);
                }
                case 46: {
                ...
                case 47: {
                    return ((NavReflectionState)object).toString();
                }
                case 48: {
                    return ((NavReflectionState)object).getName();
                }
                case 49: {
                    return ((NavReflectionState)object).getParent();
                }
                case 50: {
                    ((NavReflectionState)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 51: {
                    ((NavReflectionState)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 52: {
                    ((NavReflectionState)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 53: {
                    ((NavReflectionState)object).wait();
                    return null;
                }
                case 54: {
                    return RuntimeUtil.valueOf(((NavReflectionState)object).equals(objectArray[0]));
                }
                case 55: {
                    return RuntimeUtil.valueOf(((NavReflectionState)object).hashCode());
                }
                case 56: {
                    return ((NavReflectionState)object).getClass();
                }
                case 57: {
                    ((NavReflectionState)object).notify();
                    return null;
                }
                case 58: {
                    ((NavReflectionState)object).notifyAll();
                    return null;
                }
            }
            return null;
