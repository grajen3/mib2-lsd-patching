...
public final class LR1afa8b382
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateCrossing)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateCrossing)object).toString();
                }
                case 51: {
                    return ((StateCrossing)object).getName();
                }
                case 52: {
                    return ((StateCrossing)object).getParent();
                }
                case 53: {
                    ((StateCrossing)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateCrossing)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateCrossing)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateCrossing)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateCrossing)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateCrossing)object).hashCode());
                }
                case 59: {
                    return ((StateCrossing)object).getClass();
                }
                case 60: {
                    ((StateCrossing)object).notify();
                    return null;
                }
                case 61: {
                    ((StateCrossing)object).notifyAll();
                    return null;
                }
            }
            return null;
