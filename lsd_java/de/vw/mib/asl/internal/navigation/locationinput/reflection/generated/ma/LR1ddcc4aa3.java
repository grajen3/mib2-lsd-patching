...
public final class LR1ddcc4aa3
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateStreet)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateStreet)object).toString();
                }
                case 51: {
                    return ((StateStreet)object).getName();
                }
                case 52: {
                    return ((StateStreet)object).getParent();
                }
                case 53: {
                    ((StateStreet)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateStreet)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateStreet)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateStreet)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateStreet)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateStreet)object).hashCode());
                }
                case 59: {
                    return ((StateStreet)object).getClass();
                }
                case 60: {
                    ((StateStreet)object).notify();
                    return null;
                }
                case 61: {
                    ((StateStreet)object).notifyAll();
                    return null;
                }
            }
            return null;
