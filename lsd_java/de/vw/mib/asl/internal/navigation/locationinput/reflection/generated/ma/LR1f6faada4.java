...
public final class LR1f6faada4
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StatePointLocationHousenumber)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StatePointLocationHousenumber)object).toString();
                }
                case 51: {
                    return ((StatePointLocationHousenumber)object).getName();
                }
                case 52: {
                    return ((StatePointLocationHousenumber)object).getParent();
                }
                case 53: {
                    ((StatePointLocationHousenumber)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StatePointLocationHousenumber)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StatePointLocationHousenumber)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StatePointLocationHousenumber)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StatePointLocationHousenumber)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StatePointLocationHousenumber)object).hashCode());
                }
                case 59: {
                    return ((StatePointLocationHousenumber)object).getClass();
                }
                case 60: {
                    ((StatePointLocationHousenumber)object).notify();
                    return null;
                }
                case 61: {
                    ((StatePointLocationHousenumber)object).notifyAll();
                    return null;
                }
            }
            return null;
