...
public final class LR1f63dc710
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateProvince)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateProvince)object).toString();
                }
                case 51: {
                    return ((StateProvince)object).getName();
                }
                case 52: {
                    return ((StateProvince)object).getParent();
                }
                case 53: {
                    ((StateProvince)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateProvince)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateProvince)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateProvince)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateProvince)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateProvince)object).hashCode());
                }
                case 59: {
                    return ((StateProvince)object).getClass();
                }
                case 60: {
                    ((StateProvince)object).notify();
                    return null;
                }
                case 61: {
                    ((StateProvince)object).notifyAll();
                    return null;
                }
            }
            return null;
