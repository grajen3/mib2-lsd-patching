...
public final class LR1264ba2cb
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateCity)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateCity)object).toString();
                }
                case 51: {
                    return ((StateCity)object).getName();
                }
                case 52: {
                    return ((StateCity)object).getParent();
                }
                case 53: {
                    ((StateCity)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateCity)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateCity)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateCity)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateCity)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateCity)object).hashCode());
                }
                case 59: {
                    return ((StateCity)object).getClass();
                }
                case 60: {
                    ((StateCity)object).notify();
                    return null;
                }
                case 61: {
                    ((StateCity)object).notifyAll();
                    return null;
                }
            }
            return null;
