...
public final class LR1a40e9d7b
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateState)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateState)object).toString();
                }
                case 51: {
                    return ((StateState)object).getName();
                }
                case 52: {
                    return ((StateState)object).getParent();
                }
                case 53: {
                    ((StateState)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateState)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateState)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateState)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateState)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateState)object).hashCode());
                }
                case 59: {
                    return ((StateState)object).getClass();
                }
                case 60: {
                    ((StateState)object).notify();
                    return null;
                }
                case 61: {
                    ((StateState)object).notifyAll();
                    return null;
                }
            }
            return null;
