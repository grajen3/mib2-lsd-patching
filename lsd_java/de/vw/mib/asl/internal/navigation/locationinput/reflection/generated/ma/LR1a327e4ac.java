...
public final class LR1a327e4ac
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateChome)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateChome)object).toString();
                }
                case 51: {
                    return ((StateChome)object).getName();
                }
                case 52: {
                    return ((StateChome)object).getParent();
                }
                case 53: {
                    ((StateChome)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateChome)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateChome)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateChome)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateChome)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateChome)object).hashCode());
                }
                case 59: {
                    return ((StateChome)object).getClass();
                }
                case 60: {
                    ((StateChome)object).notify();
                    return null;
                }
                case 61: {
                    ((StateChome)object).notifyAll();
                    return null;
                }
            }
            return null;
