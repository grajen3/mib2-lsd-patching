...
public final class LR13b179058
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateZipCode)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateZipCode)object).toString();
                }
                case 51: {
                    return ((StateZipCode)object).getName();
                }
                case 52: {
                    return ((StateZipCode)object).getParent();
                }
                case 53: {
                    ((StateZipCode)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateZipCode)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateZipCode)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateZipCode)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateZipCode)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateZipCode)object).hashCode());
                }
                case 59: {
                    return ((StateZipCode)object).getClass();
                }
                case 60: {
                    ((StateZipCode)object).notify();
                    return null;
                }
                case 61: {
                    ((StateZipCode)object).notifyAll();
                    return null;
                }
            }
            return null;
