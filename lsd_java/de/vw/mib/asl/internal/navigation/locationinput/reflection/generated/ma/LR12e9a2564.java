...
public final class LR12e9a2564
    ...
    public Object invoke(int n, Object object, Object[] objectArray) {
        try {
            switch (n) {
                ...
                case 48: {
                    return ((StateStreet1stCity)object).handle((EventGeneric)objectArray[0]);
                }
                case 49: {
                ...
                case 50: {
                    return ((StateStreet1stCity)object).toString();
                }
                case 51: {
                    return ((StateStreet1stCity)object).getName();
                }
                case 52: {
                    return ((StateStreet1stCity)object).getParent();
                }
                case 53: {
                    ((StateStreet1stCity)object).trans((HsmState)objectArray[0]);
                    return null;
                }
                case 54: {
                    ((StateStreet1stCity)object).wait(((Number)objectArray[0]).longValue());
                    return null;
                }
                case 55: {
                    ((StateStreet1stCity)object).wait(((Number)objectArray[0]).longValue(), ((Number)objectArray[1]).intValue());
                    return null;
                }
                case 56: {
                    ((StateStreet1stCity)object).wait();
                    return null;
                }
                case 57: {
                    return RuntimeUtil.valueOf(((StateStreet1stCity)object).equals(objectArray[0]));
                }
                case 58: {
                    return RuntimeUtil.valueOf(((StateStreet1stCity)object).hashCode());
                }
                case 59: {
                    return ((StateStreet1stCity)object).getClass();
                }
                case 60: {
                    ((StateStreet1stCity)object).notify();
                    return null;
                }
                case 61: {
                    ((StateStreet1stCity)object).notifyAll();
                    return null;
                }
            }
            return null;
