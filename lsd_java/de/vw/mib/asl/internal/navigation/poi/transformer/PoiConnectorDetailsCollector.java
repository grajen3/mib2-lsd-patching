...
public class PoiConnectorDetailsCollector {
    public int count;
    ...
    public PoiConnectorDetailsCollector(int n, String string, String string2, String string3, String string4, int n2, int n3) {
        this.count = n;
