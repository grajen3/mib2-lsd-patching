...
public final class PoiStateSubElementSurrounding
extends PoiAbstractSubElementCommon {
    public PoiStateSubElementSurrounding(PoiHsmTarget poiHsmTarget, Hsm hsm, String string, HsmState hsmState) {
    ...
    private void handleLIGETSTATERESULT(LISpellerData lISpellerData) {
        ...
        if (this.getParentPOIState) {
            ...
            PoiStateElementSurrounding.runningSearchState = lISpellerData;
