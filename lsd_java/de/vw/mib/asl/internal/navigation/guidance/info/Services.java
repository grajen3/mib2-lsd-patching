...
implements DSIServiceStateListener {
    ...
    private DSIListener dsiCarTimeUnitsLanguageListener;
    private HsmTargetInfo target;
    private static final int[] OBSERVER_DSINAV = new int[]{75, 11, 13, 23, 43, 42, 28};
    private static final int[] OBSERVER_DSICARTIME = new int[]{3};
    ...
    Services(HsmTargetInfo hsmTargetInfo) {
    ...
    DSICarTimeUnitsLanguage getCarTimeUnitsLanguage() {
        return this.dsiCarTimeUnitsLanguage;
    }
    ...
    public void registered(String string, int n) {
        ...
        } else if (string2 == RuntimeGeneratedConstants.SERVICE_TS_NS[30]) {
            this.initDsiCarTimeUnitsLanguage();
        }
        if (this.dsiNavigation != null && this.dsiCarTimeUnitsLanguage != null) {
            this.target.isFirstStartupDone = true;
        }
    }

    void initDsiCarTimeUnitsLanguage() {
        DSIProxy dSIProxy = DSIProxyFactory.getDSIProxyAPI().getDSIProxy();
        this.dsiCarTimeUnitsLanguage = (DSICarTimeUnitsLanguage)dSIProxy.getService(this.target, class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguage == null ? (class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguage = Services.class$("org.dsi.ifc.cartimeunitslanguage.DSICarTimeUnitsLanguage")) : class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguage);
        this.dsiCarTimeUnitsLanguageListener = dSIProxy.getAdapterFactory().createDSIListenerMethodAdapter(this.target.getHsm(), class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener == null ? (class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener = Services.class$("org.dsi.ifc.cartimeunitslanguage.DSICarTimeUnitsLanguageListener")) : class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener);
        dSIProxy.addResponseListener(this.target, class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener == null ? (class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener = Services.class$("org.dsi.ifc.cartimeunitslanguage.DSICarTimeUnitsLanguageListener")) : class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener, this.dsiCarTimeUnitsLanguageListener);
        this.dsiCarTimeUnitsLanguage.setNotification(OBSERVER_DSICARTIME, this.dsiCarTimeUnitsLanguageListener);
    }
    ...
    public void unregistered(String string, int n) {
        if (this.target.isTraceEnabled()) {
            this.target.trace().append("HsmTarget Guidance Info tries to unregister from ").append(string).append("...").log();
        }
        try {
            DSIProxy dSIProxy = DSIProxyFactory.getDSIProxyAPI().getDSIProxy();
            if (dSIProxy == null) {
            ...
            if (string2 == RuntimeGeneratedConstants.SERVICE_TS_NS[79]) {
                ...
                this.unregisterDSICarTimeUnitsLanguage(string, dSIProxy);
            }
        }
    ...
    private void unregisterDSICarTimeUnitsLanguage(String string, DSIProxy dSIProxy) {
        if (this.dsiCarTimeUnitsLanguageListener != null) {
            dSIProxy.removeResponseListener(this.target, class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener == null ? (class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener = Services.class$("org.dsi.ifc.cartimeunitslanguage.DSICarTimeUnitsLanguageListener")) : class$org$dsi$ifc$cartimeunitslanguage$DSICarTimeUnitsLanguageListener, this.dsiCarTimeUnitsLanguageListener);
            this.dsiCarTimeUnitsLanguageListener = null;
    ...
    private void traceUnregisterDone(String string) {
        if (this.target.isTraceEnabled()) {
            this.target.trace().append("HsmTarget Guidance Info unregistered from ").append(string).log();
        }
    }
