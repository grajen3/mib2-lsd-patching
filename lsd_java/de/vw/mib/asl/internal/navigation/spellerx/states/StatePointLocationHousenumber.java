...
public class StatePointLocationHousenumber
extends NavReflectionState {
    private XSpellerTarget target;

    public StatePointLocationHousenumber(XSpellerTarget xSpellerTarget, Hsm hsm, String string, HsmState hsmState) {
    ...
    private void useEUSpeller(int n) {
        ...
        this.addSubject(new EUMatchTextPointLocationSubject(this.target, 3077, 3076, this.target.modelHousenumberList, null, n, false, false, false));
    }
