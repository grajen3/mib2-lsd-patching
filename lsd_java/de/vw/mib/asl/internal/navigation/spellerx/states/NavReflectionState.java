...
public class NavReflectionState
extends AbstractReflectionState
implements NavGatewayListener {
    public NavReflectionState(AbstractReflectionHsmTarget abstractReflectionHsmTarget, Hsm hsm, String string, HsmState hsmState) {
    ...
    private String getShortStateName(String string) {
        if (string.length() > 4 && string.startsWith("state")) {
    ...
    private String getActiveStateName() {
        String string = this.myHsm.getState().getName();
        return this.getShortStateName(string);
    }
    ...
    public void warn(String string) {
        ServiceManager.logger.trace(16384).append("[").append(this.getActiveStateName()).append(":").append(this.getCurrentStateName()).append("] ").append(string).log();
    }

    public void error(String string) {
        ServiceManager.logger.error(16384).append(this.getActiveStateName()).append(":").append(this.getCurrentStateName()).append(": ").append(string).log();
    }

    public void trace(String string) {
        if (ServiceManager.logger.isTraceEnabled(16384)) {
            ServiceManager.logger.trace(16384).append(this.getActiveStateName()).append(":").append(this.getCurrentStateName()).append(": ").append(string).log();
        }
    }
