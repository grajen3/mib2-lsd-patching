...
public abstract class AbstractNavGatewayTarget
extends AbstractASLTarget
implements NavGatewayListener {
    public AbstractNavGatewayTarget(GenericEvents genericEvents, int n, String string) {
        super(genericEvents, n, string);
    }

    public AbstractNavGatewayTarget(GenericEvents genericEvents, int n) {
