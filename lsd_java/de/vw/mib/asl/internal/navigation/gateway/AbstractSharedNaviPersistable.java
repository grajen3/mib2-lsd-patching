...
public abstract class AbstractSharedNaviPersistable
...
implements NavGatewayListener {
    ...
    protected AbstractSharedNaviPersistable(int n, long l) {
        super(n, l);
        this.LOGGER_PREFIX = "AbstractSharedNaviPersistable: ";
    }

    public void warn(String string) {
        ServiceManager.logger.trace(16384).append("AbstractSharedNaviPersistable: ").append(string).log();
    }

    public void error(String string) {
        ServiceManager.logger.error(16384).append("AbstractSharedNaviPersistable: ").append(string).log();
    }
