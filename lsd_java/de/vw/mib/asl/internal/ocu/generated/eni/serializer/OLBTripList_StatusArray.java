...
public final class OLBTripList_StatusArray
implements BAPStatusArray {
    ...
    public OLBTripList_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public OLBTripList_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        OLBTripList_StatusArray oLBTripList_StatusArray = (OLBTripList_StatusArray)bAPEntity;
        return this.asg_Id == oLBTripList_StatusArray.asg_Id && this.taid == oLBTripList_StatusArray.taid && this.totalNumListElements == oLBTripList_StatusArray.totalNumListElements && this.arrayHeader.equalTo(oLBTripList_StatusArray.arrayHeader) && this.data.equalTo(oLBTripList_StatusArray.data);
    }
    ...
    public String toString() {
        return "OLBTripList_StatusArray:";
    }
    ...
    public int getFunctionId() {
        return OLBTripList_StatusArray.functionId();
    }
