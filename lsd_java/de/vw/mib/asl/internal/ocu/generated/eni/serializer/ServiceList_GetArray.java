...
public final class ServiceList_GetArray
implements BAPGetArray {
    ...
    public ServiceList_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public ServiceList_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ServiceList_GetArray serviceList_GetArray = (ServiceList_GetArray)bAPEntity;
        return this.asg_Id == serviceList_GetArray.asg_Id && this.taid == serviceList_GetArray.taid && this.arrayHeader.equalTo(serviceList_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return ServiceList_GetArray.functionId();
    }
