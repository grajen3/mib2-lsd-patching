...
import de.vw.mib.asl.internal.ocu.generated.eni.serializer.FoDList_Data;
...
public final class FoDList_StatusArray
implements BAPStatusArray {
    ...
    public FoDList_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public FoDList_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        FoDList_StatusArray foDList_StatusArray = (FoDList_StatusArray)bAPEntity;
        return this.asg_Id == foDList_StatusArray.asg_Id && this.taid == foDList_StatusArray.taid && this.totalNumListElements == foDList_StatusArray.totalNumListElements && this.arrayHeader.equalTo(foDList_StatusArray.arrayHeader) && this.data.equalTo(foDList_StatusArray.data);
    }
    ...
    public int getFunctionId() {
        return FoDList_StatusArray.functionId();
    }
