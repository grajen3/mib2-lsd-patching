...
public final class OnlineUpdateList_StatusArray
implements BAPStatusArray {
    ...
    public OnlineUpdateList_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public OnlineUpdateList_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        OnlineUpdateList_StatusArray onlineUpdateList_StatusArray = (OnlineUpdateList_StatusArray)bAPEntity;
        return this.asg_Id == onlineUpdateList_StatusArray.asg_Id && this.taid == onlineUpdateList_StatusArray.taid && this.totalNumListElements == onlineUpdateList_StatusArray.totalNumListElements && this.arrayHeader.equalTo(onlineUpdateList_StatusArray.arrayHeader) && this.data.equalTo(onlineUpdateList_StatusArray.data);
    }
    ...
    public String toString() {
        return "OnlineUpdateList_StatusArray:";
    }
    ...
    public int getFunctionId() {
        return OnlineUpdateList_StatusArray.functionId();
    }
