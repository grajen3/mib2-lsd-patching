...
public final class DestinationsList_ChangedArray
implements BAPChangedArray {
    ...
    public DestinationsList_ChangedArray() {
        this.internalReset();
        this.customInitialization();
    }

    public DestinationsList_ChangedArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        DestinationsList_ChangedArray destinationsList_ChangedArray = (DestinationsList_ChangedArray)bAPEntity;
        return this.arrayHeader.equalTo(destinationsList_ChangedArray.arrayHeader) && this.data.equalTo(destinationsList_ChangedArray.data);
    }
    ...
    public String toString() {
        return "DestinationsList_ChangedArray:";
    }
    ...
    public int getFunctionId() {
        return DestinationsList_ChangedArray.functionId();
    }
