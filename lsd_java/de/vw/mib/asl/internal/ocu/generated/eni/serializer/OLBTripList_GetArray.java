...
public final class OLBTripList_GetArray
implements BAPGetArray {
    ...
    public OLBTripList_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public OLBTripList_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        OLBTripList_GetArray oLBTripList_GetArray = (OLBTripList_GetArray)bAPEntity;
        return this.asg_Id == oLBTripList_GetArray.asg_Id && this.taid == oLBTripList_GetArray.taid && this.arrayHeader.equalTo(oLBTripList_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return OLBTripList_GetArray.functionId();
    }
