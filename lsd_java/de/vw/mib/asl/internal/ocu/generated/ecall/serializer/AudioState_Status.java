...
public final class AudioState_Status
implements StatusProperty {
    ...
    public AudioState_Status() {
        this.internalReset();
        this.customInitialization();
    }

    public AudioState_Status(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ...
        return this.currentAudioSource == audioState_Status.currentAudioSource && this.audioRequest == audioState_Status.audioRequest;
    }
    ...
    public int getFunctionId() {
        return AudioState_Status.functionId();
    }
}
