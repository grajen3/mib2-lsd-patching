...
public final class FoDList_GetArray
implements BAPGetArray {
    ...
    public FoDList_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public FoDList_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        FoDList_GetArray foDList_GetArray = (FoDList_GetArray)bAPEntity;
        return this.asg_Id == foDList_GetArray.asg_Id && this.taid == foDList_GetArray.taid && this.arrayHeader.equalTo(foDList_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return FoDList_GetArray.functionId();
    }
