...
public final class AlertList_StatusArray
implements BAPStatusArray {
    ...
    public AlertList_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public AlertList_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        AlertList_StatusArray alertList_StatusArray = (AlertList_StatusArray)bAPEntity;
        return this.asg_Id == alertList_StatusArray.asg_Id && this.taid == alertList_StatusArray.taid && this.totalNumListElements == alertList_StatusArray.totalNumListElements && this.arrayHeader.equalTo(alertList_StatusArray.arrayHeader) && this.data.equalTo(alertList_StatusArray.data);
    }
    ...
    public int getFunctionId() {
        return AlertList_StatusArray.functionId();
    }
