...
extends ECallState {
    ...
    static /* synthetic */ Class class$de$vw$mib$asl$internal$ocu$ecall$states$InitializeState;

    public InitializeState(ECallHsmContext eCallHsmContext, HsmState hsmState) {
        super(eCallHsmContext, (class$de$vw$mib$asl$internal$ocu$ecall$states$InitializeState == null ? (class$de$vw$mib$asl$internal$ocu$ecall$states$InitializeState = InitializeState.class$("de.vw.mib.asl.internal.ocu.ecall.states.InitializeState")) : class$de$vw$mib$asl$internal$ocu$ecall$states$InitializeState).getName(), hsmState);
    }
