...
import de.vw.mib.asl.internal.ocu.ecall.states.ECallStartupTopState;
import de.vw.mib.asl.internal.ocu.ecall.states.InitializeState;
import de.vw.mib.asl.internal.ocu.ecall.states.RunningState;
import de.vw.mib.genericevents.hsm.Hsm;
import de.vw.mib.genericevents.hsm.HsmState;

public class ECallHsmContext
implements CommonHsmContext {
    ...
    private ECallHsmContextDelegate _delegate;

    public ECallHsmContext(Hsm hsm, HsmState hsmState) {
        this._hsm = hsm;
    ...
    public HsmContextDelegate getContextDelegate() {
        return this.getECallContextDelegate();
    }

    public ECallHsmContextDelegate getECallContextDelegate() {
        return this._delegate;
    }

    public void setDelegate(ECallHsmContextDelegate eCallHsmContextDelegate) {
        this._delegate = eCallHsmContextDelegate;
    }
    ...
    private HsmState getStartupTopState() {
        if (this._startupTopState == null) {
            this._startupTopState = new ECallStartupTopState(this, this.getDefaultParentState());
        }
