...
BAPValueObserverable {
    ...
    protected final Logger getLogger() {
        return (Logger)this.getDelegate().getService(class$de$vw$mib$log4mib$Logger == null ? (class$de$vw$mib$log4mib$Logger = ENIFunction.class$("de.vw.mib.log4mib.Logger")) : class$de$vw$mib$log4mib$Logger);
    }
