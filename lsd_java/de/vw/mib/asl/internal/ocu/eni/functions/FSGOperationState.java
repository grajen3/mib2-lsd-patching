...
InternalServiceProvider {
    ...
    private OperationStateServiceListener getOperationStateServiceListener() {
        return (OperationStateServiceListener)this.getDelegate().getService(class$de$vw$mib$asl$internal$ocu$eni$api$online$OperationStateServiceListener == null ? (class$de$vw$mib$asl$internal$ocu$eni$api$online$OperationStateServiceListener = FSGOperationState.class$("de.vw.mib.asl.internal.ocu.eni.api.online.OperationStateServiceListener")) : class$de$vw$mib$asl$internal$ocu$eni$api$online$OperationStateServiceListener);
    }

    private void _informServices() {
        boolean bl = this.getState() == 0;
        this.getOperationStateServiceListener().updateEniOperationState(bl);
        if (this.getLogger().isTraceEnabled(256)) {
            this.getLogger().trace(256).append("ENIFSGOperationState: Update with new startedAndRunning=").append(bl).log();
        }
    }
    ...
    public void initialize(boolean bl) {
        if (bl) {
            ...
            this.getDelegate().registerServiceProviderListener(this, class$de$vw$mib$asl$internal$ocu$eni$api$online$OperationStateServiceListener == null ? (class$de$vw$mib$asl$internal$ocu$eni$api$online$OperationStateServiceListener = FSGOperationState.class$("de.vw.mib.asl.internal.ocu.eni.api.online.OperationStateServiceListener")) : class$de$vw$mib$asl$internal$ocu$eni$api$online$OperationStateServiceListener, OperationStateServiceListener.SERVICE_CONSTANTS);
        }
    }

    @Override
    public void uninitialize() {
        if (this.setOperationState(3)) {
