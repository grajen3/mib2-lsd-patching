...
abstract class ENIState
extends AbstractHsmState
implements EniInternalServices {
    private final ENIHsmContext _hsmContext;

    public ENIState(ENIHsmContext eNIHsmContext, String string, HsmState hsmState) {
        super(eNIHsmContext.getHsm(), string, hsmState);
        this._hsmContext = eNIHsmContext;
    }

    protected ENIHsmContext getHsmContext() {
        return this._hsmContext;
    }

    protected ENIHsmContextDelegate getContextDelegate() {
        return this.getHsmContext().getENIContextDelegate();
    }
    ...
    private EniServiceProxy getProxyMarshaller() {
        return (EniServiceProxy)this.getContextDelegate().getOCUServiceProxy();
    }
