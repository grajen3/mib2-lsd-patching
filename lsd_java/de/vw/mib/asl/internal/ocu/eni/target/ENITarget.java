...
import de.vw.mib.asl.internal.ocu.eni.target.ENIControlUnit;
...
public class ENITarget
extends AbstractASLHsmTarget
implements ENIHsmContextDelegate {
    private ENIHsmContext _hsmContext;
    private BAPDisplayControlUnit _displayLogicalControlUnit;
    private ObjectObjectOptHashMap _serviceReceiverRegistry;

    public ENITarget(GenericEvents genericEvents, int n, String string) {
        super(genericEvents, n, string);
    }

    private ENIHsmContext getHsmContext() {
        if (this._hsmContext == null) {
            this._hsmContext = new ENIHsmContext(this.getHsm(), this.getWorkStateParent());
    ...
    public BAPDisplayControlUnit getLogicalControlUnit() {
        if (this._displayLogicalControlUnit == null) {
            this._displayLogicalControlUnit = new ENIControlUnit(this);
        }
    ...
    public OcuServiceProxy getOCUServiceProxy() {
        return (OcuServiceProxy)((Object)ENIServiceProvider.getENIService(ENIServiceProvider.ENI_SERVICE_VERSION_1_0));
    }

    @Override
    public OCUService getOCUService() {
        return (OCUService)((Object)ENIServiceProvider.getENIService(ENIServiceProvider.ENI_SERVICE_VERSION_1_0));
    }
