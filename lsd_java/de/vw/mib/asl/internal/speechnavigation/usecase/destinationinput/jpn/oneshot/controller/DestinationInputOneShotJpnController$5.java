...
class DestinationInputOneShotJpnController$5
implements DestinationInputListener {
    ...
    DestinationInputOneShotJpnController$5(DestinationInputOneShotJpnController destinationInputOneShotJpnController, OneShotJpnModel oneShotJpnModel) {
    ...
    public void setDestinationFieldResponse(int n, INavigationLocation iNavigationLocation, int[] nArray) {
        ...
        this.this$0.notifyMunicipalitySelected(this.val$selectedOneshot);
    }
}
