...
class DestinationInputOneShotJpnController$7
implements DestinationInputListener {
    ...
    DestinationInputOneShotJpnController$7(DestinationInputOneShotJpnController destinationInputOneShotJpnController, OneShotJpnModel oneShotJpnModel) {
    ...
    public void setDestinationFieldResponse(int n, INavigationLocation iNavigationLocation, int[] nArray) {
        ...
        this.this$0.notifyPlaceSelected(this.val$selectedOneshot);
    }
}
