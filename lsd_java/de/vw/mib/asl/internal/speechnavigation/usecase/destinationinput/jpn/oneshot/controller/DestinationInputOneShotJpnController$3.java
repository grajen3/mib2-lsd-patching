...
class DestinationInputOneShotJpnController$3
implements DestinationInputListener {
    ...
    DestinationInputOneShotJpnController$3(DestinationInputOneShotJpnController destinationInputOneShotJpnController, OneShotJpnModel oneShotJpnModel) {
    ...
    public void setDestinationFieldResponse(int n, INavigationLocation iNavigationLocation, int[] nArray) {
        ...
        this.this$0.notifyPrefectureSelected(this.val$selectedOneshot);
    }
}
