...
class NavigationDestinationInputServiceAdapter$4
implements VoiceDestinationEntryCallback {
    ...
    NavigationDestinationInputServiceAdapter$4(NavigationDestinationInputServiceAdapter navigationDestinationInputServiceAdapter, INavigationLocation iNavigationLocation, int[] nArray) {
    ...
    public void setCapabilitiesResult(Capabilities capabilities) {
        ...
        this.this$0.selectEntryByIndexCaller.release(0, this.val$inputLocation, this.val$possibleFields);
    }
}
