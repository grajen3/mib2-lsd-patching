...
import generated.de.vw.mib.asl.internal.speechnavigation.controller.lastdestinations.transformer.AbstractSpeechNavigationControllerLastDestinationsLastDestinationListTransformer;

public class SpeechNavigationControllerLastDestinationsLastDestinationListTransformer
extends AbstractSpeechNavigationControllerLastDestinationsLastDestinationListTransformer {
    @Override
    public int getInt(int n, Object object) {
        LastDestination lastDestination = (LastDestination)object;
        switch (n) {
            case 1: {
                return lastDestination.size;
            }
        }
