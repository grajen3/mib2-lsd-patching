...
import generated.de.vw.mib.asl.internal.speechnavigation.controller.onboardpois.transformer.AbstractSpeechNavigationControllerOnboardPOIsOnboardPOIsTransformer;
import org.dsi.ifc.global.ResourceLocator;

public class SpeechNavigationControllerOnboardPOIsOnboardPOIsTransformer
extends AbstractSpeechNavigationControllerOnboardPOIsOnboardPOIsTransformer {
    @Override
    ...
    public long getLong(int n, Object object) {
        ...
        switch (n) {
            case 0: {
                return new Long(onboardPOI.getIndex());
            }
        }
        throw new IllegalArgumentException(new StringBuffer().append("Parameter columnID=").append(n).append(" can not be resolved. ").toString());
    }
