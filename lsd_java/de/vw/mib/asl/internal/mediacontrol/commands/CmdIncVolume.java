...
public final class CmdIncVolume
extends AbstractCommand {
    private static int TIMEOUT = 10000;
    private static final int STEP_0_INC_VOLUME;
    private final Player mPlayer;
    private final String mDeviceId;

    public CmdIncVolume(Player player, String string) {
        super(1, 1, 1, TIMEOUT);
        this.mPlayer = player;
    ...
    public void execute(int n) {
        switch (n) {
            case 1: {
                this.mPlayer.rqIncVolume(this.mDeviceId, this.NEXT_STEP);
                return;
            }
        }
    }
