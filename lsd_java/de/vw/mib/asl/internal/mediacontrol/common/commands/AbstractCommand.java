...
import de.vw.mib.asl.internal.mediacontrol.common.commands.AbstractCommand$1;
import de.vw.mib.asl.internal.mediacontrol.common.commands.AbstractCommand$2;
import de.vw.mib.asl.internal.mediacontrol.common.commands.AbstractCommand$3;
import de.vw.mib.asl.internal.mediacontrol.common.commands.AbstractCommand$4;
...
import de.vw.mib.asl.internal.mediacontrol.common.commands.CommandTracer;
...
implements Command {
    ...
    private final MediaControlTimer mAbortCommandTimer;
    ...
    public AbstractCommand(int n, int n2, int n3, int n4) {
        ...
        this.mAbortCommandTimer = new MediaControlTimer(abstractCommand$3, n4, "abort_command");
        ...
        this.mCommandNameShort = string2;
    ...
    protected void commandTimedOut() {
        this.NEXT_STEP.timeout();
        this.NO_OPERATION.timeout();
        if (!this.isTerminated()) {
            this.mAbortCommandTimer.stop();
    ...
    public String getCommandStr(boolean bl, boolean bl2, boolean bl3, boolean bl4) {
        ...
        if (bl || bl2 || bl3 || bl4) {
            ...
            string3 = "";
            if (bl4) {
                string3 = new StringBuffer().append(", requiredComponents: ").append(Components.getComponentsStr(this.mRequiredComponents)).toString();
            }
    ...
    private void error(Exception exception) {
        this.mTracer.logError(exception);
    }
    ...
    static /* synthetic */ MediaControlTimer access$000(AbstractCommand abstractCommand) {
