...
import de.vw.mib.asl.internal.list.impl.Range;

class Coverage {
    private final boolean autoCompact;
    private Range first;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$internal$list$impl$Coverage;
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$internal$list$impl$Coverage == null ? (class$de$vw$mib$asl$internal$list$impl$Coverage = Coverage.class$("de.vw.mib.asl.internal.list.impl.Coverage")) : class$de$vw$mib$asl$internal$list$impl$Coverage).desiredAssertionStatus();
    }
}
