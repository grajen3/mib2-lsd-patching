...
import generated.de.vw.mib.asl.internal.avdc.audio.transformer.AbstractAVDCAudioAvailableBrowsingSourcesTransformer;

public class AVDCAudioAvailableBrowsingSourcesTransformer
extends AbstractAVDCAudioAvailableBrowsingSourcesTransformer {
    @Override
    public boolean getBoolean(int n, Object object) {
        DeviceCollector deviceCollector = DeviceCollector.get((Device)object);
        switch (n) {
            case 1: {
                return deviceCollector.isUserAvailable() && deviceCollector.isDeviceActive();
            }
            case 2: {
