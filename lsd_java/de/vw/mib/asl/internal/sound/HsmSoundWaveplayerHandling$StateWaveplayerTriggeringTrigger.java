...
public class HsmSoundWaveplayerHandling$StateWaveplayerTriggeringTrigger
extends AbstractHsmState {
    private HsmSoundWaveplayerHandling target;
    private final /* synthetic */ HsmSoundWaveplayerHandling this$0;

    public HsmSoundWaveplayerHandling$StateWaveplayerTriggeringTrigger(HsmSoundWaveplayerHandling hsmSoundWaveplayerHandling, Hsm hsm, String string, HsmState hsmState) {
    ...
    public HsmState handle(EventGeneric eventGeneric) {
        ...
        switch (eventGeneric.getReceiverEventId()) {
            case 3: {
                this.target.dsiWavePlayer.audioTrigger(0);
                break;
            }
            default: {
    ...
    public void dsiWavePlayerAudioTriggerResponse(int n) {
        switch (n) {
            ...
            case 9: {
                ...
                this.this$0.warn().append("SoundWaveplayerHandlingTrigger: can not play TONE_NAV_POI; going to disconnecting.").log();
