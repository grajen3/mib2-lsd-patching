 ...
 */
package de.vw.mib.asl.internal.navmaptile.util;
...
public class MapTileLogger {
    ...
    public MapTileLogger(AbstractTarget abstractTarget, Hsm hsm) {
    ...
    public MapTileLogger(int n, String string, boolean bl) {
    ...
    public MapTileLogger(int n, String string) {
        this.LOG_PREFIX = true;
        this.msgPrefix = new StringBuilder(string).append(" ").toString();
        this.classifier = n;
        this.target = null;
