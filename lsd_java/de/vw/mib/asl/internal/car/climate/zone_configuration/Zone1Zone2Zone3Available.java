...
public class Zone1Zone2Zone3Available
extends BaseConfiguration {
    public Zone1Zone2Zone3Available(ClimateMainController climateMainController) {
    ...
    public void updateAirconAirDistributionZone1(AirconAirDistribution airconAirDistribution, int n) {
        ...
        this.evaluateAutoModeFront();
        this.evaluatePresetFront();
        this.updateArrowColourZone1(airconAirDistribution);
        ...
        if (!this.airDistributionAvailableZone3) {
            ...
            this.updateArrowColourZone3(airconAirDistribution);
        }
        this.informAirFlowArrowStateToModel();
        this.informPresetCollectorToModel();
    ...
    public void updateAirconTempZone3(AirconTemp airconTemp, int n) {
        ...
        this.temperatureButtonList[3].temperatureValue = this.evaluateTemperatureValue(airconTemp.tempValue, airconTemp.tempUnit);
        this.temperatureButtonList[3].unit = this.evaluateTemperatureUnit(airconTemp, this.isEcoZone3);
        this.updateArrowColourZone3(this.airDistributionZone3);
        this.informAirFlowArrowStateToModel();
        this.informTemperaturToModel();
    }
    ...
    public void updateAirconTempStepZone3(int n, int n2, int n3) {
        ...
        this.temperatureButtonList[3].temperatureValue = n;
        this.temperatureButtonList[3].unit = this.evaluateTemperatureStepUnit(n, n2, this.isEcoZone3);
        this.informTemperaturToModel();
    }
    ...
    private void updateArrowColourZone1(AirconAirDistribution airconAirDistribution) {
        ...
        this.isButtonFrontAirFlowWindowActive = airconAirDistribution.up > 0;
        this.airFlowArrowStateCollector[0] = this.isAutoAirDistributionFront || airconAirDistribution.up > 0 ? this.evaluateArrowColor(this.styleStateZone1, this.tempTypeZone1, this.airconTempZone1, this.isAutoAirDistributionFront) : 0;
        ...
        this.airFlowArrowStateCollector[2] = this.isAutoAirDistributionFront || airconAirDistribution.footwell > 0 ? this.evaluateArrowColor(this.styleStateZone1, this.tempTypeZone1, this.airconTempZone1, this.isAutoAirDistributionFront) : 0;
    ...
    private void updateArrowColourZone3(AirconAirDistribution airconAirDistribution) {
        ...
        boolean bl = this.isButtonRearAirFlowFootWellActive = airconAirDistribution.footwell > 0;
        if (this.isRearWindowOutletAvailable && (this.isAutoAirDistributionRear || airconAirDistribution.up > 0)) {
            this.airFlowArrowStateCollector[6] = this.evaluateArrowColor(this.styleStateZone3, this.tempTypeZone3, this.airconTempZone3, this.isAutoAirDistributionRear);
            this.airFlowArrowStateCollector[9] = this.evaluateArrowColor(this.styleStateZone3, this.tempTypeZone3, this.airconTempZone3, this.isAutoAirDistributionRear);
        } else {
            this.airFlowArrowStateCollector[6] = 0;
            this.airFlowArrowStateCollector[9] = 0;
        }
        if (this.isAutoAirDistributionRear || airconAirDistribution.body > 0) {
            this.airFlowArrowStateCollector[7] = this.evaluateArrowColor(this.styleStateZone3, this.tempTypeZone3, this.airconTempZone3, this.isAutoAirDistributionRear);
            this.airFlowArrowStateCollector[10] = this.evaluateArrowColor(this.styleStateZone3, this.tempTypeZone3, this.airconTempZone3, this.isAutoAirDistributionRear);
        } else {
            this.airFlowArrowStateCollector[7] = 0;
            this.airFlowArrowStateCollector[10] = 0;
        }
        if (this.isAutoAirDistributionRear || airconAirDistribution.footwell > 0) {
            this.airFlowArrowStateCollector[8] = this.evaluateArrowColor(this.styleStateZone3, this.tempTypeZone3, this.airconTempZone3, this.isAutoAirDistributionRear);
            this.airFlowArrowStateCollector[11] = this.evaluateArrowColor(this.styleStateZone3, this.tempTypeZone3, this.airconTempZone3, this.isAutoAirDistributionRear);
        } else {
            this.airFlowArrowStateCollector[8] = 0;
            this.airFlowArrowStateCollector[11] = 0;
        }
    ...
    public void updateAirconClimateStateZone3(int n, int n2) {
        ...
        if (this.isEcoZone3) {
            this.temperatureButtonList[3].unit = 5;
        } else if (this.tempTypeZone3 == 1) {
            this.temperatureButtonList[3].unit = this.evaluateTemperatureUnit(this.airconTempZone3, this.isEcoZone3);
        } else if (this.tempTypeZone3 == 2) {
            this.temperatureButtonList[3].unit = this.evaluateTemperatureStepUnit(this.airConTempStepZone3, this.airconTempStepMaxCount3, this.isEcoZone3);
        }
        this.informTemperaturToModel();
        this.updateArrowColourZone3(this.airDistributionZone3);
        this.informAirFlowArrowStateToModel();
