...
public class Zone1Zone2Available
extends BaseConfiguration {
    public Zone1Zone2Available(ClimateMainController climateMainController) {
    ...
    private void updateArrowColourZone1(AirconAirDistribution airconAirDistribution) {
        ...
        if (this.isAutoAirDistributionFront || airconAirDistribution.up > 0) {
            ...
            this.airFlowArrowStateCollector[6] = this.isRearWindowOutletAvailable ? this.evaluateArrowColor(this.styleStateZone1, this.tempTypeZone1, this.airconTempZone1, this.isAutoAirDistributionFront) : 0;
        } else {
            this.airFlowArrowStateCollector[0] = 0;
            this.airFlowArrowStateCollector[6] = 0;
        }
        if (this.isAutoAirDistributionFront || airconAirDistribution.body > 0) {
            this.airFlowArrowStateCollector[1] = this.evaluateArrowColor(this.styleStateZone1, this.tempTypeZone1, this.airconTempZone1, this.isAutoAirDistributionFront);
            this.airFlowArrowStateCollector[7] = this.evaluateArrowColor(this.styleStateZone1, this.tempTypeZone1, this.airconTempZone1, this.isAutoAirDistributionFront);
        } else {
            this.airFlowArrowStateCollector[1] = 0;
        ...
        if (this.isAutoAirDistributionFront || airconAirDistribution.footwell > 0) {
            ...
            this.airFlowArrowStateCollector[8] = this.evaluateArrowColor(this.styleStateZone1, this.tempTypeZone1, this.airconTempZone1, this.isAutoAirDistributionFront);
        } else {
    ...
    private void updateArrowColourZone2(AirconAirDistribution airconAirDistribution) {
        if (this.isAutoAirDistributionFront || airconAirDistribution.up > 0) {
            this.airFlowArrowStateCollector[3] = this.evaluateArrowColor(this.styleStateZone2, this.tempTypeZone2, this.airconTempZone2, this.isAutoAirDistributionFront);
            this.airFlowArrowStateCollector[9] = this.isRearWindowOutletAvailable ? this.evaluateArrowColor(this.styleStateZone2, this.tempTypeZone2, this.airconTempZone2, this.isAutoAirDistributionFront) : 0;
        } else {
            this.airFlowArrowStateCollector[3] = 0;
            this.airFlowArrowStateCollector[9] = 0;
        }
        if (this.isAutoAirDistributionFront || airconAirDistribution.body > 0) {
            this.airFlowArrowStateCollector[4] = this.evaluateArrowColor(this.styleStateZone2, this.tempTypeZone2, this.airconTempZone2, this.isAutoAirDistributionFront);
            this.airFlowArrowStateCollector[10] = this.evaluateArrowColor(this.styleStateZone2, this.tempTypeZone2, this.airconTempZone2, this.isAutoAirDistributionFront);
        } else {
            this.airFlowArrowStateCollector[4] = 0;
            this.airFlowArrowStateCollector[10] = 0;
        }
        if (this.isAutoAirDistributionFront || airconAirDistribution.footwell > 0) {
            this.airFlowArrowStateCollector[5] = this.evaluateArrowColor(this.styleStateZone2, this.tempTypeZone2, this.airconTempZone2, this.isAutoAirDistributionFront);
            this.airFlowArrowStateCollector[11] = this.evaluateArrowColor(this.styleStateZone2, this.tempTypeZone2, this.airconTempZone2, this.isAutoAirDistributionFront);
        } else {
            this.airFlowArrowStateCollector[5] = 0;
