...
ASLListDataUpdateListener {
    ...
    private static Object getService(BundleContext bundleContext, Class clazz) {
    ...
    protected ASLDatapool getDataPool() {
        if (this._dataPool == null) {
            this._dataPool = (ASLDatapool)DataPoolAdapter.getService(ServiceManager.bundleContext, class$de$vw$mib$datapool$ASLDatapool == null ? (class$de$vw$mib$datapool$ASLDatapool = DataPoolAdapter.class$("de.vw.mib.datapool.ASLDatapool")) : class$de$vw$mib$datapool$ASLDatapool);
        }
