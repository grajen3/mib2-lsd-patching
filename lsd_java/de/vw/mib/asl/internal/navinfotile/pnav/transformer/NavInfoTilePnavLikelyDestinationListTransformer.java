...
import generated.de.vw.mib.asl.internal.navinfotile.pnav.transformer.AbstractNavInfoTilePnavLikelyDestinationListTransformer;
import org.dsi.ifc.global.ResourceLocator;

public class NavInfoTilePnavLikelyDestinationListTransformer
extends AbstractNavInfoTilePnavLikelyDestinationListTransformer {
    @Override
    public FixFormatterFieldData getFixFormatterFieldData(int n, Object object) {
        IPnavLikelyDestination iPnavLikelyDestination = (IPnavLikelyDestination)object;
        switch (n) {
            case 16: {
