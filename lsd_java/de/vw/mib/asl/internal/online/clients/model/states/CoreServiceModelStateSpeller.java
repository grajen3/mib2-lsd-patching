...
public class CoreServiceModelStateSpeller
extends AbstractHsmState {
    private final CoreServiceModelTarget _target;
    private final String _classname = super.getClass().getName();
    private int _subCategoryID;

    public CoreServiceModelStateSpeller(CoreServiceModelTarget coreServiceModelTarget, Hsm hsm, String string, HsmState hsmState) {
        super(hsm, string, hsmState);
        this._target = coreServiceModelTarget;
        if (this.getTarget().isTraceEnabled()) {
            this.getTarget().trace().append(this._classname).append(".CoreServiceModelStateSpeller()").log();
        }
    }
    ...
    public HsmState handle(EventGeneric eventGeneric) {
        ...
        switch (eventGeneric.getReceiverEventId()) {
            ...
            case 1073744720: {
                ...
                CoreServiceModelFactory.getCoreServiceModelController(this.getTarget()).getModelHandler().setCarNetRegistrationState(3);
