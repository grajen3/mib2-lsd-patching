...
public class SmiPreventDisplayOnKoreaEwsPermission
extends AbstractStageContentRequestPermission {
    private EmergencyAnnouncementService emergencyAnnouncementService;

    public SmiPreventDisplayOnKoreaEwsPermission(EmergencyAnnouncementService emergencyAnnouncementService) {
        super("HMI_SMARTPHONEINTEGRATION", "Permission refused, because Korea EWS / EA is currently active.");
