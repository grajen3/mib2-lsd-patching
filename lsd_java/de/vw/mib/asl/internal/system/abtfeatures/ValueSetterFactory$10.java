...
class ValueSetterFactory$10
extends IntegerSetter {
    private final /* synthetic */ ValueSetterFactory this$0;

    ValueSetterFactory$10(ValueSetterFactory valueSetterFactory, AbtFeatures abtFeatures, short s) {
    ...
    protected void apply(AbtFeatures abtFeatures, int n) {
        abtFeatures.setRotaryEncoderType(n);
    }
}
