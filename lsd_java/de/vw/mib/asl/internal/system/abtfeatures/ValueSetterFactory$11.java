...
class ValueSetterFactory$11
extends IntegerSetter {
    private final /* synthetic */ ValueSetterFactory this$0;

    ValueSetterFactory$11(ValueSetterFactory valueSetterFactory, AbtFeatures abtFeatures, short s) {
    ...
    protected void apply(AbtFeatures abtFeatures, int n) {
        abtFeatures.setTouchController(n);
    }
}
