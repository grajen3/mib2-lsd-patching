...
extends AbstractCommand {
    ...
    private final ExtendedListEntry mFile;
    private Selection mSelection;

    public CmdSelectEntry(MediaRecorderBrowser mediaRecorderBrowser, MediaRecorder mediaRecorder, ExtendedListEntry extendedListEntry, boolean bl) {
        super(1032, 1, 2, TIMEOUT);
        this.mBrowser = mediaRecorderBrowser;
        this.mRecorder = mediaRecorder;
        this.mFile = extendedListEntry;
        this.mSelected = bl;
    }
    ...
    public void execute(int n) {
        switch (n) {
            case 1: {
                if (this.mFile == null) {
                    this.commandFailed("File is null");
                    break;
                }
                this.mSelection = this.mBrowser.createEntrySelection(PlayMode.UNKNOWN, this.mFile, this.mSelected, true);
    ...
    protected String getParameterStr() {
        return new StringBuffer().append("file/folder: ").append(this.mFile).append(", selected: ").append(this.mSelected).toString();
    }
}
