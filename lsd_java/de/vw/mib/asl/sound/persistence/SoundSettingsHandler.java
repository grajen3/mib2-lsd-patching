...
class SoundSettingsHandler
extends AbstractPersistenceDataHandler {
    private final SoundSettings handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$sound$persistence$SoundSettingsHandler;

    SoundSettingsHandler(SoundSettings soundSettings, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$sound$persistence$SoundSettingsHandler == null ? (class$de$vw$mib$asl$sound$persistence$SoundSettingsHandler = SoundSettingsHandler.class$("de.vw.mib.asl.sound.persistence.SoundSettingsHandler")) : class$de$vw$mib$asl$sound$persistence$SoundSettingsHandler).desiredAssertionStatus();
    }
}
