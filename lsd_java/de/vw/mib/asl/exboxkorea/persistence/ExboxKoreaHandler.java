...
class ExboxKoreaHandler
extends AbstractPersistenceDataHandler {
    private final ExboxKorea handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$exboxkorea$persistence$ExboxKoreaHandler;

    ExboxKoreaHandler(ExboxKorea exboxKorea, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$exboxkorea$persistence$ExboxKoreaHandler == null ? (class$de$vw$mib$asl$exboxkorea$persistence$ExboxKoreaHandler = ExboxKoreaHandler.class$("de.vw.mib.asl.exboxkorea.persistence.ExboxKoreaHandler")) : class$de$vw$mib$asl$exboxkorea$persistence$ExboxKoreaHandler).desiredAssertionStatus();
    }
}
