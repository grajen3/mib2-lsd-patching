...
class ExboxKoreaUserHandler
extends AbstractPersistenceDataHandler {
    private final ExboxKorea handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$exboxkorea$persistence$ExboxKoreaUserHandler;

    ExboxKoreaUserHandler(ExboxKorea exboxKorea, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && exboxKorea == null) {
            throw new AssertionError();
        }
        this.handledPersistable = exboxKorea;
    ...
    public void handle(int n, boolean bl) {
        switch (n) {
            case 1: {
                this.handledPersistable.setNavigationAnnouncementDuringPhoneCallEnabled(bl);
    ...
    protected void installDefaultValue(int n) {
        switch (n) {
            case 1: {
                this.handledPersistable.setNavigationAnnouncementDuringPhoneCallEnabled(true);
                break;
            }
            default: {
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$exboxkorea$persistence$ExboxKoreaUserHandler == null ? (class$de$vw$mib$asl$exboxkorea$persistence$ExboxKoreaUserHandler = ExboxKoreaUserHandler.class$("de.vw.mib.asl.exboxkorea.persistence.ExboxKoreaUserHandler")) : class$de$vw$mib$asl$exboxkorea$persistence$ExboxKoreaUserHandler).desiredAssertionStatus();
    }
}
