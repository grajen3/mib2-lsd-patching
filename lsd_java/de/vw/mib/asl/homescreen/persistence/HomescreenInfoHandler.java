...
class HomescreenInfoHandler
extends AbstractPersistenceDataHandler {
    private final HomescreenInfo handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$homescreen$persistence$HomescreenInfoHandler;

    HomescreenInfoHandler(HomescreenInfo homescreenInfo, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$homescreen$persistence$HomescreenInfoHandler == null ? (class$de$vw$mib$asl$homescreen$persistence$HomescreenInfoHandler = HomescreenInfoHandler.class$("de.vw.mib.asl.homescreen.persistence.HomescreenInfoHandler")) : class$de$vw$mib$asl$homescreen$persistence$HomescreenInfoHandler).desiredAssertionStatus();
    }
}
