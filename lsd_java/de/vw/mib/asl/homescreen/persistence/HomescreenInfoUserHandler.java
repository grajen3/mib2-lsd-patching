...
import de.vw.mib.asl.internal.homescreen.persistence.PersistenceDefaults;
import de.vw.mib.log4mib.Logger;
import java.util.Map$Entry;

class HomescreenInfoUserHandler
extends AbstractPersistenceDataHandler {
    private final HomescreenInfo handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$homescreen$persistence$HomescreenInfoUserHandler;

    HomescreenInfoUserHandler(HomescreenInfo homescreenInfo, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && homescreenInfo == null) {
            throw new AssertionError();
        }
        this.handledPersistable = homescreenInfo;
    ...
    public void handle(int n, int n2) {
        switch (n) {
            case 1: {
                this.handledPersistable.setClockLayout(n2);
    ...
    public void handle(int n, Persistable persistable) {
        switch (n) {
            case 2: {
                this.handledPersistable.getTileContents().add(persistable);
                this.markAsProcessed(n);
                break;
            }
            default: {
    ...
    protected void installDefaultValue(int n) {
        switch (n) {
            case 1: {
                ...
                this.handledPersistable.setClockLayout(PersistenceDefaults.getDefaultClockLayout());
                break;
            }
            case 2: {
                break;
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$homescreen$persistence$HomescreenInfoUserHandler == null ? (class$de$vw$mib$asl$homescreen$persistence$HomescreenInfoUserHandler = HomescreenInfoUserHandler.class$("de.vw.mib.asl.homescreen.persistence.HomescreenInfoUserHandler")) : class$de$vw$mib$asl$homescreen$persistence$HomescreenInfoUserHandler).desiredAssertionStatus();
    }
}
