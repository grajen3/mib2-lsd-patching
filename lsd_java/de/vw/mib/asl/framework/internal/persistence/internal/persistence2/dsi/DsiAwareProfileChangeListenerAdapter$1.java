...
class DsiAwareProfileChangeListenerAdapter$1
extends AbstractDsiAwareProfileChangeListenerCallback {
    ...
    DsiAwareProfileChangeListenerAdapter$1(DsiAwareProfileChangeListenerAdapter dsiAwareProfileChangeListenerAdapter, Logger logger, String string, String string2, ProfileChangeCallback profileChangeCallback) {
    ...
    protected void processCallbackTask(boolean bl) {
        ...
        this.val$callback.notifyProfileChanged(bl);
    }
}
