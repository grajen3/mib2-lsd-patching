...
final class ProxyTargetCompiler$MethodIdRetriever$1
extends ProxyTargetCompiler$MethodIdRetriever {
    private final /* synthetic */ DSIReflectionFactory val$factory;

    ProxyTargetCompiler$MethodIdRetriever$1(String[] stringArray, DSIReflectionFactory dSIReflectionFactory) {
    ...
    protected MultipleMethodAccessibleObject getMMAO(int n) {
        return this.val$factory.getListenersMmao(n);
    }
}
