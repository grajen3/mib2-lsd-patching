...
class DomainRestartObservation$1$1
implements DomainRestartObservation$CallRestartMethod {
    ...
    DomainRestartObservation$1$1(DomainRestartObservation$1 domainRestartObservation$1, int n) {
    ...
    public void run(int n) {
        DomainRestartObservation$1.access$000(this.this$1).handleRestartSds(this.val$domainStatus, n);
    }
}
