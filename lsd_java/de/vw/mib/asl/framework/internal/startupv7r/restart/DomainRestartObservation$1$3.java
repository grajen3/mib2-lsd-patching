...
class DomainRestartObservation$1$3
implements DomainRestartObservation$CallRestartMethod {
    ...
    DomainRestartObservation$1$3(DomainRestartObservation$1 domainRestartObservation$1, int n) {
    ...
    public void run(int n) {
        DomainRestartObservation$1.access$000(this.this$1).handleRestartGemmi(this.val$domainStatus, n);
    }
}
