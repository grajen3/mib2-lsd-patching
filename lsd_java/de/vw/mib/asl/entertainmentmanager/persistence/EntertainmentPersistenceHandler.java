...
class EntertainmentPersistenceHandler
extends AbstractPersistenceDataHandler {
    private final EntertainmentPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$entertainmentmanager$persistence$EntertainmentPersistenceHandler;

    EntertainmentPersistenceHandler(EntertainmentPersistence entertainmentPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$entertainmentmanager$persistence$EntertainmentPersistenceHandler == null ? (class$de$vw$mib$asl$entertainmentmanager$persistence$EntertainmentPersistenceHandler = EntertainmentPersistenceHandler.class$("de.vw.mib.asl.entertainmentmanager.persistence.EntertainmentPersistenceHandler")) : class$de$vw$mib$asl$entertainmentmanager$persistence$EntertainmentPersistenceHandler).desiredAssertionStatus();
    }
}
