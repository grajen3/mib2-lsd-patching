...
class EntertainmentPersistenceUserHandler
extends AbstractPersistenceDataHandler {
    private final EntertainmentPersistence handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$entertainmentmanager$persistence$EntertainmentPersistenceUserHandler;

    EntertainmentPersistenceUserHandler(EntertainmentPersistence entertainmentPersistence, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && entertainmentPersistence == null) {
            throw new AssertionError();
        }
        this.handledPersistable = entertainmentPersistence;
    ...
    public void handle(int n, int n2) {
        switch (n) {
            case 1: {
                this.handledPersistable.setContext(n2);
    ...
    protected void installDefaultValue(int n) {
        switch (n) {
            case 1: {
                ...
                this.handledPersistable.setContext(EntertainmentManagerLastmodes.fallbackContext());
                break;
            }
            default: {
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$entertainmentmanager$persistence$EntertainmentPersistenceUserHandler == null ? (class$de$vw$mib$asl$entertainmentmanager$persistence$EntertainmentPersistenceUserHandler = EntertainmentPersistenceUserHandler.class$("de.vw.mib.asl.entertainmentmanager.persistence.EntertainmentPersistenceUserHandler")) : class$de$vw$mib$asl$entertainmentmanager$persistence$EntertainmentPersistenceUserHandler).desiredAssertionStatus();
    }
}
