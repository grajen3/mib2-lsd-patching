...
extends AbstractPersistenceDataHandler {
    ...
    static /* synthetic */ Class class$de$vw$mib$asl$gridmenu$persistence$GridMenuHandler;

    GridMenuHandler(GridMenu gridMenu, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$gridmenu$persistence$GridMenuHandler == null ? (class$de$vw$mib$asl$gridmenu$persistence$GridMenuHandler = GridMenuHandler.class$("de.vw.mib.asl.gridmenu.persistence.GridMenuHandler")) : class$de$vw$mib$asl$gridmenu$persistence$GridMenuHandler).desiredAssertionStatus();
    }
}
