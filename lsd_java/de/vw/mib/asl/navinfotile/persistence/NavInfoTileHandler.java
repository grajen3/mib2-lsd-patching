...
import de.vw.mib.asl.internal.navinfotile.NavInfoTilePersistenceDefaults;
import de.vw.mib.asl.navinfotile.persistence.NavInfoTile;
import de.vw.mib.log4mib.Logger;
import java.util.Map$Entry;

class NavInfoTileHandler
extends AbstractPersistenceDataHandler {
    private final NavInfoTile handledPersistable;
    private final PersistenceModule module;
    static final /* synthetic */ boolean $assertionsDisabled;
    static /* synthetic */ Class class$de$vw$mib$asl$navinfotile$persistence$NavInfoTileHandler;

    NavInfoTileHandler(NavInfoTile navInfoTile, Logger logger, PersistenceModule persistenceModule) {
        super(logger);
        if (!$assertionsDisabled && navInfoTile == null) {
            throw new AssertionError();
        }
        this.handledPersistable = navInfoTile;
    ...
    public void handle(int n, int n2) {
        switch (n) {
            case 3: {
                this.handledPersistable.setPageIndex(n2);
    ...
    protected void installDefaultValue(int n) {
        switch (n) {
            case 3: {
                ...
                this.handledPersistable.setPageIndex(NavInfoTilePersistenceDefaults.getPageIndexDefault());
                break;
            }
            default: {
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$asl$navinfotile$persistence$NavInfoTileHandler == null ? (class$de$vw$mib$asl$navinfotile$persistence$NavInfoTileHandler = NavInfoTileHandler.class$("de.vw.mib.asl.navinfotile.persistence.NavInfoTileHandler")) : class$de$vw$mib$asl$navinfotile$persistence$NavInfoTileHandler).desiredAssertionStatus();
    }
}
