...
public final class OptHashMapHelper {
    public static final float DEFAULT_LOAD_FACTOR;
    public static final float DEFAULT_RESIZE_FACTOR;
    public static final float DEFAULT_RESIZE_THRESHOLD;
    public static final float DEFAULT_RESIZE_STRATEGY;
    public static final float SLOWLY_GROWING_RESIZE_STRATEGY;
    public static final float DEFAULT_REHASH_STRATEGY;
    public static final float SLOWLY_GROWING_REHASH_STRATEGY;
    public static final int DEFAULT_MIN_SIZE;
    private static final int LENGTH_OF_OPTHASHMAP_INTERNAL_DATA;
    static final int[] CAPACITIES;

    private OptHashMapHelper() {
    }

    public static int capacityAtLeast(int n, float f2) {
        return OptHashMapHelper.capacityAtLeast((int)Math.ceil((float)n / f2));
    }

    public static int capacityAtLeast(int n) {
        int n2 = -1;
        int n3 = CAPACITIES.length;
        while (n2 + 1 < n3) {
            int n4 = n2 + n3 >>> 1;
            if (CAPACITIES[n4] < n) {
                n2 = n4;
