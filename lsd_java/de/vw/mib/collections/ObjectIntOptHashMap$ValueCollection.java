...
class ObjectIntOptHashMap$ValueCollection
implements IntCollection {
    private final /* synthetic */ ObjectIntOptHashMap this$0;

    public ObjectIntOptHashMap$ValueCollection(ObjectIntOptHashMap objectIntOptHashMap) {
    ...
    public IntIterator iterator() {
        return new ObjectIntOptHashMap$ValueIterator(this.this$0);
    }
