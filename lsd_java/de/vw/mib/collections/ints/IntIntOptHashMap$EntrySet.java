...
class IntIntOptHashMap$EntrySet
implements Set {
    private final /* synthetic */ IntIntOptHashMap this$0;

    public IntIntOptHashMap$EntrySet(IntIntOptHashMap intIntOptHashMap) {
    ...
    private int containsWhere(Object object) {
        if (!(object instanceof IntIntOptHashMap$Entry)) {
            return 128;
        }
        IntIntOptHashMap$Entry intIntOptHashMap$Entry = (IntIntOptHashMap$Entry)object;
        int n = this.this$0.findKey(intIntOptHashMap$Entry.getKey());
        int n2 = intIntOptHashMap$Entry.getValue();
    ...
    public Iterator iterator() {
        return new IntIntOptHashMap$EntryIterator(this.this$0);
    }
