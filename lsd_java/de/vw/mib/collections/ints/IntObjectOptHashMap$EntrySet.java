...
class IntObjectOptHashMap$EntrySet
implements Set {
    private final /* synthetic */ IntObjectOptHashMap this$0;

    public IntObjectOptHashMap$EntrySet(IntObjectOptHashMap intObjectOptHashMap) {
    ...
    private int containsWhere(Object object) {
        if (!(object instanceof IntObjectOptHashMap$Entry)) {
            return 128;
        }
        IntObjectOptHashMap$Entry intObjectOptHashMap$Entry = (IntObjectOptHashMap$Entry)object;
        int n = this.this$0.findKey(intObjectOptHashMap$Entry.getKey());
        Object object2 = intObjectOptHashMap$Entry.getValue();
    ...
    public Iterator iterator() {
        return new IntObjectOptHashMap$EntryIterator(this.this$0);
    }
