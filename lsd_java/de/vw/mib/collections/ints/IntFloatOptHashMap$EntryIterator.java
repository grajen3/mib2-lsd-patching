...
class IntFloatOptHashMap$EntryIterator
implements Iterator {
    int where = -1;
    int which = 0;
    int expectedWrites;
    ...
    public IntFloatOptHashMap$EntryIterator(IntFloatOptHashMap intFloatOptHashMap) {
        this.this$0 = intFloatOptHashMap;
        this.expectedWrites = intFloatOptHashMap.writes;
    }
    ...
    public Object next() {
        ...
        ++this.which;
        return new IntFloatOptHashMap$Entry(this.this$0, this.where);
    }
