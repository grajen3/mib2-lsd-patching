...
class IntFloatOptHashMap$EntrySet
implements Set {
    private final /* synthetic */ IntFloatOptHashMap this$0;

    public IntFloatOptHashMap$EntrySet(IntFloatOptHashMap intFloatOptHashMap) {
    ...
    private int containsWhere(Object object) {
        if (!(object instanceof IntFloatOptHashMap$Entry)) {
            return 128;
        }
        IntFloatOptHashMap$Entry intFloatOptHashMap$Entry = (IntFloatOptHashMap$Entry)object;
        int n = this.this$0.findKey(intFloatOptHashMap$Entry.getKey());
        float f2 = intFloatOptHashMap$Entry.getValue();
        if (n != 128 && this.this$0.values[n] == f2) {
            return n;
        }
        return 128;
    }
    ...
    public Iterator iterator() {
        return new IntFloatOptHashMap$EntryIterator(this.this$0);
    }
