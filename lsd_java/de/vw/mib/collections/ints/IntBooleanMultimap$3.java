...
class IntBooleanMultimap$3
implements IntSet {
    private final /* synthetic */ IntBooleanMultimap this$0;

    IntBooleanMultimap$3(IntBooleanMultimap intBooleanMultimap) {
    ...
    public int get(int n) {
        return this.contains(n) ? n : IntBooleanMultimap.access$000(this.this$0);
    }
}
