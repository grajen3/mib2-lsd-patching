...
class IntBooleanOptHashMap$EntrySet
implements Set {
    private final /* synthetic */ IntBooleanOptHashMap this$0;

    public IntBooleanOptHashMap$EntrySet(IntBooleanOptHashMap intBooleanOptHashMap) {
    ...
    private int containsWhere(Object object) {
        if (!(object instanceof IntBooleanOptHashMap$Entry)) {
            return 128;
        }
        IntBooleanOptHashMap$Entry intBooleanOptHashMap$Entry = (IntBooleanOptHashMap$Entry)object;
        int n = this.this$0.findKey(intBooleanOptHashMap$Entry.getKey());
        boolean bl = intBooleanOptHashMap$Entry.getValue();
        if (n != 128 && this.this$0.values[n] == bl) {
            return n;
        }
        return 128;
    }
    ...
    public Iterator iterator() {
        return new IntBooleanOptHashMap$EntryIterator(this.this$0);
    }
