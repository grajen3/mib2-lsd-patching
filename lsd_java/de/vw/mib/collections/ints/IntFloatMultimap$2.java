...
class IntFloatMultimap$2
implements Set {
    private final /* synthetic */ IntFloatMultimap this$0;

    IntFloatMultimap$2(IntFloatMultimap intFloatMultimap) {
    ...
    public boolean contains(Object object) {
        if (object instanceof IntFloatMap$Entry) {
            ...
            return this.this$0.containsKeyValuePair(intFloatMap$Entry.getKey(), intFloatMap$Entry.getValue());
        }
        return false;
    }
