...
import de.vw.mib.collections.ints.IntObjectOptHashMap$EntryIterator;
import de.vw.mib.collections.ints.IntObjectOptHashMap$EntrySet;
import de.vw.mib.collections.ints.IntObjectOptHashMap$KeyIterator;
import de.vw.mib.collections.ints.IntObjectOptHashMap$KeySet;
import de.vw.mib.collections.ints.IntObjectOptHashMap$ValueCollection;
import de.vw.mib.collections.ints.IntObjectOptHashMap$ValueIterator;
...
public class IntObjectOptHashMap
...
IntObjectMap {
    ...
    static /* synthetic */ Class class$de$vw$mib$collections$ints$IntObjectOptHashMap;

    public static void copy(IntObjectOptHashMap intObjectOptHashMap, IntObjectOptHashMap intObjectOptHashMap2) {
        Iterator iterator = intObjectOptHashMap.entrySet().iterator();
        while (iterator.hasNext()) {
            IntObjectOptHashMap$Entry intObjectOptHashMap$Entry = (IntObjectOptHashMap$Entry)iterator.next();
            intObjectOptHashMap2.put(intObjectOptHashMap$Entry.key, intObjectOptHashMap$Entry.value);
        }
    }

    public IntObjectOptHashMap() {
        this(3, 63, 63, 49215, NEUTRAL_VALUE);
    }

    public IntObjectOptHashMap(int n) {
        this(n, 63, 63, 49215, NEUTRAL_VALUE);
    }

    public IntObjectOptHashMap(int n, float f2, float f3) {
        this(n, f2, f3, 49215, NEUTRAL_VALUE);
    }

    public IntObjectOptHashMap(IntObjectOptHashMap intObjectOptHashMap) {
        this.loadFactor = intObjectOptHashMap.loadFactor;
        this.resizeFactor = intObjectOptHashMap.resizeFactor;
        this.rehashStrategy = intObjectOptHashMap.rehashStrategy;
        this.neutralValue = intObjectOptHashMap.neutralValue;
        this.sizeWarningThreshold = intObjectOptHashMap.sizeWarningThreshold;
        int[] nArray = new int[intObjectOptHashMap.arraySize];
        System.arraycopy((Object)intObjectOptHashMap.keys, 0, (Object)nArray, 0, intObjectOptHashMap.arraySize);
        Object[] objectArray = new Object[intObjectOptHashMap.arraySize];
        System.arraycopy((Object)intObjectOptHashMap.values, 0, (Object)objectArray, 0, intObjectOptHashMap.arraySize);
        byte[] byArray = new byte[intObjectOptHashMap.arraySize];
        System.arraycopy((Object)intObjectOptHashMap.valueStates, 0, (Object)byArray, 0, intObjectOptHashMap.arraySize);
        this.init(nArray, objectArray, byArray, intObjectOptHashMap.size, intObjectOptHashMap.fill);
        this.writes = intObjectOptHashMap.writes;
    }

    private IntObjectOptHashMap(int n, float f2, float f3, float f4, Object object) {
        ...
        this.init(new int[n2], new Object[n2], new byte[n2], 0, 0);
        this.writes = 0;
    }

    private IntObjectOptHashMap(int[] nArray, Object[] objectArray, byte[] byArray, int n, int n2, float f2, float f3, float f4, Object object) {
        this.loadFactor = f2;
        this.resizeFactor = f3;
        this.rehashStrategy = f4;
        this.neutralValue = object;
        this.sizeWarningThreshold = n * 2 > CollectionsHelper.DEFAULT_SIZE_WARNING_THRESHOLD ? n * 2 : CollectionsHelper.DEFAULT_SIZE_WARNING_THRESHOLD;
        this.init(nArray, objectArray, byArray, n, n2);
        this.writes = 0;
    }

    private void init(int[] nArray, Object[] objectArray, byte[] byArray, int n, int n2) {
        this.keys = nArray;
    ...
    public static IntObjectOptHashMap createFromInternalData(Object[] objectArray) {
        return IntObjectOptHashMap.createFromInternalData(objectArray, 0);
    }

    public static IntObjectOptHashMap createFromInternalData(Object[] objectArray, int n) {
        int[] nArray = (int[])objectArray[3 + n];
        return new IntObjectOptHashMap((int[])objectArray[0 + n], (Object[])objectArray[1 + n], (byte[])objectArray[2 + n], nArray[0], nArray[1], Float.intBitsToFloat(nArray[2]), Float.intBitsToFloat(nArray[3]), Float.intBitsToFloat(nArray[4]), ((Object[])objectArray[4 + n])[0]);
    }

    public static IntObjectOptHashMap createSlowlyGrowingHashmap(int n, float f2, float f3) {
        return new IntObjectOptHashMap(n, f2, f3, -842232769, NEUTRAL_VALUE);
    }

    public static IntObjectOptHashMap createWithNeutralValue(int n, float f2, float f3, Object object) {
        return new IntObjectOptHashMap(n, f2, f3, 49215, object);
    }
    ...
    private void rehash(int n) {
        ...
        this.init(new int[n], new Object[n], new byte[n], 0, 0);
        ...
        if (this.size > this.sizeWarningThreshold) {
            CollectionsHelper.writeSizeWarning("IntObjectOptHashMap", this.arraySize, 5);
        }
    }
    ...
    public Object put(int n, Object object) {
        ...
        throw new CollectionOverflowException(new StringBuffer().append("Map overflow on adding (").append(n).append(",").append(object).append(").").toString());
    }
    ...
    public Object remove(int n) {
        Object object = this.removePos(this.findKey(n));
        this.onCollectionChanged();
        return object;
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.keys.length; ++i2) {
            ...
            stringBuilder.append(string).append(n).append("<-").append(object);
            string = ", ";
        }
    ...
    public Iterator entryIterator() {
        return new IntObjectOptHashMap$EntryIterator(this);
    }

    @Override
    public Set entrySet() {
        return new IntObjectOptHashMap$EntrySet(this);
    }

    @Override
    public IntIterator keyIterator() {
        return new IntObjectOptHashMap$KeyIterator(this);
    }

    @Override
    public IntSet keySet() {
        return new IntObjectOptHashMap$KeySet(this);
    }
    ...
    public boolean equals(Object object) {
        ...
        IntObjectOptHashMap intObjectOptHashMap = (IntObjectOptHashMap)object;
        if (intObjectOptHashMap.size != this.size) {
            return false;
        }
        if (!(intObjectOptHashMap.neutralValue == this.neutralValue || intObjectOptHashMap.neutralValue != null && intObjectOptHashMap.neutralValue.equals(this.neutralValue))) {
            return false;
        }
        Iterator iterator = this.entrySet().iterator();
        while (iterator.hasNext()) {
            IntObjectOptHashMap$Entry intObjectOptHashMap$Entry = (IntObjectOptHashMap$Entry)iterator.next();
            if (!intObjectOptHashMap.containsKey(intObjectOptHashMap$Entry.key)) {
                return false;
            }
            Object object2 = intObjectOptHashMap.get(intObjectOptHashMap$Entry.key);
            if (object2 == intObjectOptHashMap$Entry.value || object2 != null && object2.equals(intObjectOptHashMap$Entry.value)) continue;
            return false;
        }
        return true;
    }
    ...
    public Object replaceKey(int n, int n2) {
        ...
        Object object = this.removePos(n3);
    ...
    public Iterator valueIterator() {
        return new IntObjectOptHashMap$ValueIterator(this);
    }

    @Override
    public Collection values() {
        return new IntObjectOptHashMap$ValueCollection(this);
    }
    ...
    static {
        $assertionsDisabled = !(class$de$vw$mib$collections$ints$IntObjectOptHashMap == null ? (class$de$vw$mib$collections$ints$IntObjectOptHashMap = IntObjectOptHashMap.class$("de.vw.mib.collections.ints.IntObjectOptHashMap")) : class$de$vw$mib$collections$ints$IntObjectOptHashMap).desiredAssertionStatus();
        NEUTRAL_VALUE = null;
    }
}
