...
class IntLongOptHashMap$EntrySet
implements Set {
    private final /* synthetic */ IntLongOptHashMap this$0;

    public IntLongOptHashMap$EntrySet(IntLongOptHashMap intLongOptHashMap) {
    ...
    private int containsWhere(Object object) {
        if (!(object instanceof IntLongOptHashMap$Entry)) {
            return 128;
        }
        IntLongOptHashMap$Entry intLongOptHashMap$Entry = (IntLongOptHashMap$Entry)object;
        int n = this.this$0.findKey(intLongOptHashMap$Entry.getKey());
        long l = intLongOptHashMap$Entry.getValue();
    ...
    public Iterator iterator() {
        return new IntLongOptHashMap$EntryIterator(this.this$0);
    }
