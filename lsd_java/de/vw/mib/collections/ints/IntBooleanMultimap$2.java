...
class IntBooleanMultimap$2
implements Set {
    private final /* synthetic */ IntBooleanMultimap this$0;

    IntBooleanMultimap$2(IntBooleanMultimap intBooleanMultimap) {
    ...
    public boolean contains(Object object) {
        if (object instanceof IntBooleanMap$Entry) {
            ...
            return this.this$0.containsKeyValuePair(intBooleanMap$Entry.getKey(), intBooleanMap$Entry.getValue());
        }
        return false;
    }
