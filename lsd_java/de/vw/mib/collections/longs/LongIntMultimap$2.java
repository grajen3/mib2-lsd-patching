...
class LongIntMultimap$2
implements Set {
    private final /* synthetic */ LongIntMultimap this$0;

    LongIntMultimap$2(LongIntMultimap longIntMultimap) {
    ...
    public boolean contains(Object object) {
        if (object instanceof LongIntMap$Entry) {
            ...
            return this.this$0.containsKeyValuePair(longIntMap$Entry.getKey(), longIntMap$Entry.getValue());
        }
        return false;
    }
