...
class LongIntOptHashMap$EntrySet
implements Set {
    private final /* synthetic */ LongIntOptHashMap this$0;

    public LongIntOptHashMap$EntrySet(LongIntOptHashMap longIntOptHashMap) {
    ...
    private int containsWhere(Object object) {
        if (!(object instanceof LongIntOptHashMap$Entry)) {
            return 128;
        }
        LongIntOptHashMap$Entry longIntOptHashMap$Entry = (LongIntOptHashMap$Entry)object;
        int n = this.this$0.findKey(longIntOptHashMap$Entry.getKey());
        int n2 = longIntOptHashMap$Entry.getValue();
    ...
    public Iterator iterator() {
        return new LongIntOptHashMap$EntryIterator(this.this$0);
    }
