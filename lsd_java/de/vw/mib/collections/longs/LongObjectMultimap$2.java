...
class LongObjectMultimap$2
implements Set {
    private final /* synthetic */ LongObjectMultimap this$0;

    LongObjectMultimap$2(LongObjectMultimap longObjectMultimap) {
    ...
    public boolean contains(Object object) {
        if (object instanceof LongObjectMap$Entry) {
            ...
            return this.this$0.containsKeyValuePair(longObjectMap$Entry.getKey(), longObjectMap$Entry.getValue());
        }
        return false;
    }
