...
import de.vw.mib.widgets.models.ChinaSpellerModel;
...
public class ChinaSpeller
extends AsiaSpeller
implements ChinaSpellerModel {
    static /* synthetic */ Class class$de$vw$mib$widgets$ui$ChinaSpellerUI;
    ...
    public Class[] getCompatibleUIClasses() {
        return new Class[]{class$de$vw$mib$widgets$ui$ChinaSpellerUI == null ? (class$de$vw$mib$widgets$ui$ChinaSpellerUI = ChinaSpeller.class$("de.vw.mib.widgets.ui.ChinaSpellerUI")) : class$de$vw$mib$widgets$ui$ChinaSpellerUI};
    }
