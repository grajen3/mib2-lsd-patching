...
final class ScreenArea$MoveInViewAnimation
extends AbstractWidget$WidgetInternalAnimation {
    private final ViewModel view;
    private final /* synthetic */ ScreenArea this$0;

    public ScreenArea$MoveInViewAnimation(ScreenArea screenArea, EasingParams easingParams, float f2, float f3, ViewModel viewModel) {
