...
final class LogClassifierNames {
    private final int[] classifierIds = new int[]{128, 1, 2, 3, 4, 5, 8, 16, 32, 64, 128, 256, 512, 1024, 1638, 2048, 4096, 8192, 16384, 0x800000, 256, 512, 1024, 2048, 4096, 8192, 16384, 0xA004000, 32768, 0x1008000, 335577088, 503349248, 0x28008000, 687898624, 704675840, 838893568, 1006665728, 1174437888, 0x50008000, 1509982208, 1, 2, 4, 8, 16, 32, 64};
    private String[] classifierNames;
    private IntObjectMap subClassifierNames;

    LogClassifierNames() {
    }

    private String[] createClassifierNames() {
        return new String[]{"APPS", "ASL", "BAP", "CIO", "CONFIGURATION", "ASI", "DATAPOOL", "DSI", "ERROR_HANDLER", "EVENTS", "GENERIC_EVENTS", "GRAPHICS", "LOGGING", "LSC", "RSI", "RESOURCES", "SPEECH", "SPI", "STARTUP", "STATEMACHINE", "THREADMANAGER", "TIMER", "VIEWS", "WIDGETS", "TOOLS", "ASLMOCKUPS", "COMMON", "CAR", "ASL2", "ASL_FRAMEWORK", "ASL_MEDIA", "NAV", "ASL_RADIO", "RADIO", "WEB_RADIO", "ASL_ONLINE", "ASL_PHONE", "ASL_SMARTPHONE", "ASL_SYSTEM", "ASL_WEBRADIO", "ANIMATION", "KOMBI_PICTURE_SERVER", "PERFORMANCE", "VE", "MOST_KOMBI", "SKIN", "DEBUG"};
    }
    ...
    private String[] createSubClassifierNames(int n) {
        ...
        switch (n) {
            case -2147483648: {
                stringArray = new String[]{"ASSEMBLY", "LIFECYCLE", "FACTORY", "MANAGER", "DESKTOP", "CONTENT", "UI", "ADAPTER", "INTENTS", "ADAPTER_PROXY", "ESAM", "ESAM_RULE_ENGINE"};
                break;
            }
            case 1: {
            ...
            case 4: {
                stringArray = new String[]{"STARTUP", "PROPERTIES", "AMBIENCELIGHT", "FEATUREFLAG"};
                break;
            }
            case 5: {
            ...
            case 64: {
                stringArray = new String[]{"DISPATCHER", "DISPATCHING_THREAD", "FACTORY", "STARTUP_DISPATCHING_THREAD", "DISPATCHER_MANAGER", "FRAMEWORK_DISPATCHER", "PROPERTY_UPDATE_DISPATCHER", "STARTUP_DISPATCHER", "STATEMACHINE_DISPATCHER", "SYSTEM_DISPATCHER", "VIEW_DISPATCHER", "DATAPOOL_DISPATCHER", "EVENT_QUEUE", "PERFORMANCE_TESTING", "GESTURE_DISPATCHER"};
                break;
            }
            case 128: {
                stringArray = new String[]{"GENERAL", "TIMER", "EVENTDISPATCHER", "SERVICEREGISTER", "TASK", "HSM", "POOL", "EVENT_QUEUE", "PERFORMANCE_TESTING", "PERFORMANCE_TESTING_THRESHOLD"};
                break;
            }
            case 256: {
                stringArray = new String[]{"DISPLAY_MANAGER", "FONT_MANAGER", "FONT_KERNEDRASTERFONT", "FONT_GLYPH_CACHE", "FONT_TEXTLAYOUT", "FONT_TEXTLAYOUT_CACHE", "GRAPHICS_MANAGER", "GRAPHICS_SURFACE", "GRAPHICS_CONTEXT", "GRAPHICS_FRAMEBUFFER", "GRAPHICS_GEOMETRYBUFFER", "GRAPHICS_MESH", "GRAPHICS_MESHHEAP", "GRAPHICS_TEXTURE", "GRAPHICS_TEXTUREATLAS", "GRAPHICS_SHADER", "GRAPHICS_EFFECT", "GRAPHICS_DRAWABLE", "GRAPHICS_SCENE", "GRAPHICS_SCENE_ANIMATION", "GRAPHICS_SCENE_RENDERER", "GRAPHICS_SCENE_LOADER", "IMAGE_MANAGER", "IMAGE_CACHE", "IMAGE_SKIN_LOADER", "IMAGE_SKIN_PRELOADER", "IMAGE_DYNAMIC_LOADER", null, null, null, "DEBUG", "PERFORMANCE"};
                break;
            }
            case 512: {
            ...
            case 1638: {
                stringArray = new String[]{"VIWI", "LOW_LEVEL", "HIGH_LEVEL", "GESTURES", "MAPRENDERER"};
                break;
            }
            case 2048: {
            ...
            case 262144: {
                stringArray = new String[]{"STARTUP", "VIEW", "POPUP", "VIEW2VIEW", "VIEWCOMPOSITOR", "LIST_ITEM_CONTROL", "SCRIPT", "SMARTVIEWHANDLER", "POPUPENTRY", "REPAINTMANAGER", "DESKTOP", "SCREENTREE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "DUMP", "PERFORMANCE"};
                break;
            }
            case 524288: {
            ...
            case 0x400000: {
                stringArray = new String[]{"SOUND", "ASIA_INPUT", "SPELLER_CONTROLLER", "INPUT_MANAGER", "DYNAMIC_RESOURCE_DATA"};
                break;
            }
            case 0x40000A: {
                stringArray = new String[]{"ASL_CAR", "ASL_CAR_BATTERY", "ASL_CAR_CLIMATE", "ASL_CAR_PARKING", "ASL_CAR_SERVICE", "ASL_CAR_VIEWOPTIONS", "CAR_APP_CLIMATE", "CAR_APP_CLIMATE_BAR", "CAR_APP_SEATMENU", "CAR_APP_CAR_BAR", "CAR_APP_CAR", "CAR_APP_PERSONALIZATION_SETUP_PAGE", "CAR_APP_CAR_AMBIENCELIGHT", "CAR_APP_FPK_SETUP"};
                break;
            }
            case 0x800000: {
            ...
            case 0x800001: {
                stringArray = new String[]{"CORE", "LIST", "HSM", "DSI_PROXY", "HAS", "CLIENT_API"};
                break;
            }
            case 8388628: {
            ...
            case 8388650: {
                stringArray = new String[]{"WEB_RADIO_MAIN", "WEB_RADIO_LIST", "WEB_RADIO_PRESETS", "WEB_RADIO_PERSISTENCE", "WEB_RADIO_SEARCH", "WEB_RADIO_SPELLER"};
                break;
            }
            case 8388658: {
            ...
            case 8388678: {
                stringArray = new String[]{"ANDROID_AUTO", "CAR_PLAY", "MIRRORLINK", "SMARTPHONE_INTEGRATION", "CAR_LIFE"};
                break;
            }
            case 0x800050: {
                stringArray = new String[]{"SYSTEM", "ASIA_INPUT", "DIAGNOSE", "DISPLAY", "EXBOXM", "FILEBROWSER", "KEYPANEL", "PERSISTENCE", "STARTUP", "SWDL", "TESTMODE", "GLOBALGOODBYE"};
                break;
            }
            case 8388698: {
            ...
            case 0x10000000: {
                stringArray = new String[]{"NAV_INFO", "NAV_VIEW", "STREAM_SINK", "LVDS", "HUD"};
                break;
            }
            case 0x20000000: {
    ...
    String[] getSubClassifierNames(int n) {
        ...
        if (this.subClassifierNames == null) {
            this.subClassifierNames = new IntObjectOptHashMap(41);
        }
        if ((stringArray = (String[])this.subClassifierNames.get(n)) == null) {
            stringArray = this.createSubClassifierNames(n);
            this.subClassifierNames.put(n, stringArray);
        }
        return stringArray;
    }
}
