...
public interface ASIHeadUnit$Consts {
    ...
    public static final int TEMPERATUREUNIT_CELSIUS;
    public static final int TEMPERATUREUNIT_FAHRENHEIT;
    ...
    public static final int REGION_EU;
    public static final int REGION_NAR;
    public static final int REGION_CN;
    public static final int REGION_JP;
    public static final int REGION_KR;
    public static final int REGION_TW;
    public static final int REGION_ROW;
    public static final int DRIVERSIDE_LEFT_HAND_DRIVE;
    public static final int DRIVERSIDE_RIGHT_HAND_DRIVE;
}
