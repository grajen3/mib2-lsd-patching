...
ASLAudioSDConstants {
    ...
    static /* synthetic */ Class class$de$vw$mib$bap$mqbpq$generated$audiosd$serializer$FSG_OperationState_Status;
    ...
    protected final FSG_OperationState_Status dequeueBAPEntity() {
        return (FSG_OperationState_Status)this.context.dequeueBAPEntity(this, class$de$vw$mib$bap$mqbpq$generated$audiosd$serializer$FSG_OperationState_Status == null ? (class$de$vw$mib$bap$mqbpq$generated$audiosd$serializer$FSG_OperationState_Status = FSGOperationStateStage.class$("de.vw.mib.bap.mqbpq.generated.audiosd.serializer.FSG_OperationState_Status")) : class$de$vw$mib$bap$mqbpq$generated$audiosd$serializer$FSG_OperationState_Status);
    }
    ...
    protected final int getCurrentAmplifierState() {
        return this.context.getInteger(1469, 0);
    }
