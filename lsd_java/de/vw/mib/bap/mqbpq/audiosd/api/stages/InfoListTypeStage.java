...
public abstract class InfoListTypeStage
implements Property,
BAPStage,
ASLAudioSDConstants {
    private BAPStageContext context;
    static /* synthetic */ Class class$de$vw$mib$bap$mqbpq$generated$audiosd$serializer$InfoListType_Status;

    protected void setBapInfoListType(Integer n) {
        int[] nArray = new int[]{23, 22};
        this.context.updateStages(this, nArray, n);
    }

    protected final InfoListType_Status dequeueBAPEntity() {
        return (InfoListType_Status)this.context.dequeueBAPEntity(this, class$de$vw$mib$bap$mqbpq$generated$audiosd$serializer$InfoListType_Status == null ? (class$de$vw$mib$bap$mqbpq$generated$audiosd$serializer$InfoListType_Status = InfoListTypeStage.class$("de.vw.mib.bap.mqbpq.generated.audiosd.serializer.InfoListType_Status")) : class$de$vw$mib$bap$mqbpq$generated$audiosd$serializer$InfoListType_Status);
    }
