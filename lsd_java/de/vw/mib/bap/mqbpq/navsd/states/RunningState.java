 ...
 */
package de.vw.mib.bap.mqbpq.navsd.states;
...
extends AbstractControlUnitState {
    static /* synthetic */ Class class$de$vw$mib$bap$mqbpq$navsd$states$RunningState;

    public RunningState(NavSdHsmContext navSdHsmContext, HsmState hsmState) {
        super(navSdHsmContext, (class$de$vw$mib$bap$mqbpq$navsd$states$RunningState == null ? (class$de$vw$mib$bap$mqbpq$navsd$states$RunningState = RunningState.class$("de.vw.mib.bap.mqbpq.navsd.states.RunningState")) : class$de$vw$mib$bap$mqbpq$navsd$states$RunningState).getName(), hsmState);
    }
