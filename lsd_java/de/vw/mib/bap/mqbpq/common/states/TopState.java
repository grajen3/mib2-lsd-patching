...
extends NotStartedFunctionControlUnitState {
    static /* synthetic */ Class class$de$vw$mib$bap$mqbpq$common$states$TopState;

    public TopState(FsgHsmContext fsgHsmContext, HsmState hsmState) {
        super(fsgHsmContext, (class$de$vw$mib$bap$mqbpq$common$states$TopState == null ? (class$de$vw$mib$bap$mqbpq$common$states$TopState = TopState.class$("de.vw.mib.bap.mqbpq.common.states.TopState")) : class$de$vw$mib$bap$mqbpq$common$states$TopState).getName(), hsmState);
    }
