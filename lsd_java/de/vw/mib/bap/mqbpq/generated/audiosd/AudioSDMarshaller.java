...
implements BAPIndicationMarshaller {
    ...
    public void resultEntity(int n, BAPEntity bAPEntity) {
        switch (n) {
            case 23: {
                this.getBapService().request(n, 0, 9, this.getBitSreamTransformer().toInteger(bAPEntity, AudioSDMarshaller.getBitstreamTransformerDatatype(0)));
                break;
            }
            case 27: {
                this.getBapService().request(n, 0, 9, this.getBitSreamTransformer().toInteger(bAPEntity, AudioSDMarshaller.getBitstreamTransformerDatatype(0)));
    ...
    public void statusEntity(int n, BAPEntity bAPEntity) {
        switch (n) {
            ...
            case 4: {
                this.getBapService().request(n, 0, 7, this.getBitSreamTransformer().toInteger(bAPEntity, AudioSDMarshaller.getBitstreamTransformerDatatype(0)));
                break;
            }
            case 14: {
                this.getBapService().request(n, 0, 7, this.getBitSreamTransformer().toInteger(bAPEntity, AudioSDMarshaller.getBitstreamTransformerDatatype(0)));
