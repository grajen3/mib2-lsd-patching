...
import de.vw.mib.bap.mqbpq.generated.navsd.serializer.Calibration_SetGet;
import de.vw.mib.bap.mqbpq.generated.navsd.serializer.LaneGuidance_GetArray;
...
implements BAPServiceListener {
    ...
    private BAPEntity createBAPEntityForSetGetIndication(int n, BitStream bitStream) {
        Calibration_SetGet calibration_SetGet;
        switch (n) {
            case 26: {
                calibration_SetGet = new Calibration_SetGet(bitStream);
                break;
            }
            default: {
                calibration_SetGet = null;
            }
        }
    ...
    private BAPEntity createBAPEntityForGetArrayIndication(int n, BitStream bitStream) {
        ...
        switch (n) {
            case 22: {
                bAPGetArray = new ManeuverDescriptor_GetArray(bitStream);
                break;
            }
            case 23: {
