...
extends AbstractControlUnitState {
    static /* synthetic */ Class class$de$vw$mib$bap$mqbab2$audiosd$states$RunningState;

    public RunningState(AudioSdHsmContext audioSdHsmContext, HsmState hsmState) {
        super(audioSdHsmContext, (class$de$vw$mib$bap$mqbab2$audiosd$states$RunningState == null ? (class$de$vw$mib$bap$mqbab2$audiosd$states$RunningState = RunningState.class$("de.vw.mib.bap.mqbab2.audiosd.states.RunningState")) : class$de$vw$mib$bap$mqbab2$audiosd$states$RunningState).getName(), hsmState);
    }
    ...
    public void stateStart() {
        this.getContextDelegate().getLogger().trace(this.getContextDelegate().getSubClassifier(), "AudioSDFunctionControlUnit successfully started");
    }
