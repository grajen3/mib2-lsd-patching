...
import de.vw.mib.bap.mqbab2.generated.audiosd.serializer.FSG_OperationState_Status;
...
ValetParkingServiceListener {
    ...
    protected static final int[] SOUND_LISTENER_IDS = new int[]{1469};
    ...
    static /* synthetic */ Class class$de$vw$mib$bap$mqbab2$generated$audiosd$serializer$FSG_OperationState_Status;
    ...
    protected FSG_OperationState_Status dequeueBAPEntity() {
        return (FSG_OperationState_Status)this.context.dequeueBAPEntity(this, class$de$vw$mib$bap$mqbab2$generated$audiosd$serializer$FSG_OperationState_Status == null ? (class$de$vw$mib$bap$mqbab2$generated$audiosd$serializer$FSG_OperationState_Status = FSGOperationStateHandling.class$("de.vw.mib.bap.mqbab2.generated.audiosd.serializer.FSG_OperationState_Status")) : class$de$vw$mib$bap$mqbab2$generated$audiosd$serializer$FSG_OperationState_Status);
    }
