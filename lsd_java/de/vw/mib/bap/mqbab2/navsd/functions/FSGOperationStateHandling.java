...
import de.vw.mib.bap.mqbab2.generated.navsd.serializer.FSG_OperationState_Status;
...
ValetParkingServiceListener {
    ...
    protected static final int[] SYSTEM_LISTENER_IDS = new int[]{1632, 1676};
    protected static final int[] NAVIGATION_LISTENER_IDS = new int[]{735, 733};
    protected static final int[] VALET_PARKING_LISTENER_IDS = new int[]{1};
    static /* synthetic */ Class class$de$vw$mib$bap$mqbab2$generated$navsd$serializer$FSG_OperationState_Status;
    ...
    protected FSG_OperationState_Status dequeueBAPEntity() {
        return (FSG_OperationState_Status)this.context.dequeueBAPEntity(this, class$de$vw$mib$bap$mqbab2$generated$navsd$serializer$FSG_OperationState_Status == null ? (class$de$vw$mib$bap$mqbab2$generated$navsd$serializer$FSG_OperationState_Status = FSGOperationStateHandling.class$("de.vw.mib.bap.mqbab2.generated.navsd.serializer.FSG_OperationState_Status")) : class$de$vw$mib$bap$mqbab2$generated$navsd$serializer$FSG_OperationState_Status);
    }
    ...
    private int getContextSpecificOperationState() {
        int n;
        block0 : switch (this.getSystemService().getNavigationDomainAvailable()) {
            case 1: {
                NavigationService navigationService = this.getNavigationService();
                if (navigationService.getNavigationOperationState() == 1) {
