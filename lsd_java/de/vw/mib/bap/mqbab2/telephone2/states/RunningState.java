...
extends AbstractControlUnitState {
    static /* synthetic */ Class class$de$vw$mib$bap$mqbab2$telephone2$states$RunningState;

    public RunningState(Telephone2HsmContext telephone2HsmContext, HsmState hsmState) {
        super(telephone2HsmContext, (class$de$vw$mib$bap$mqbab2$telephone2$states$RunningState == null ? (class$de$vw$mib$bap$mqbab2$telephone2$states$RunningState = RunningState.class$("de.vw.mib.bap.mqbab2.telephone2.states.RunningState")) : class$de$vw$mib$bap$mqbab2$telephone2$states$RunningState).getName(), hsmState);
    }
    ...
    public void stateStart() {
        this.getContextDelegate().getLogger().trace(this.getContextDelegate().getSubClassifier(), "Telephone2FunctionControlUnit successfully started");
    }
