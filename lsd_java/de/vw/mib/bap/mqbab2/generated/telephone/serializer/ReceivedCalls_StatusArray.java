...
public final class ReceivedCalls_StatusArray
implements BAPStatusArray {
    ...
    public ReceivedCalls_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public ReceivedCalls_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ReceivedCalls_StatusArray receivedCalls_StatusArray = (ReceivedCalls_StatusArray)bAPEntity;
        return this.asg_Id == receivedCalls_StatusArray.asg_Id && this.taid == receivedCalls_StatusArray.taid && this.totalNumListElements == receivedCalls_StatusArray.totalNumListElements && this.arrayHeader.equalTo(receivedCalls_StatusArray.arrayHeader) && this.data.equalTo(receivedCalls_StatusArray.data);
    }
    ...
    public String toString() {
        return "ReceivedCalls_StatusArray:";
    }
    ...
    public int getFunctionId() {
        return ReceivedCalls_StatusArray.functionId();
    }
}
