...
implements BAPSetGetArray {
    ...
    public ReceivedCalls_SetGetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public ReceivedCalls_SetGetArray(BitStream bitStream) {
        this();
    ...
    public String toString() {
        return "ReceivedCalls_SetGetArray:";
    }
    ...
    public void deserialize(BitStream bitStream) {
        ...
        if (!this.arrayHeader.isFullRangeUpdate()) {
            ...
            for (int i2 = 0; i2 < n; ++i2) {
                this.data.add(new ReceivedCalls_Data(bitStream, this.arrayHeader));
            }
        }
    }
