...
public final class FavoriteList_SetGetArray
implements BAPSetGetArray {
    ...
    public FavoriteList_SetGetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public FavoriteList_SetGetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        FavoriteList_SetGetArray favoriteList_SetGetArray = (FavoriteList_SetGetArray)bAPEntity;
        return this.asg_Id == favoriteList_SetGetArray.asg_Id && this.taid == favoriteList_SetGetArray.taid && this.arrayHeader.equalTo(favoriteList_SetGetArray.arrayHeader) && this.data.equalTo(favoriteList_SetGetArray.data);
    }
    ...
    public String toString() {
        return "FavoriteList_SetGetArray:";
    }
    ...
    public int getFunctionId() {
        return FavoriteList_SetGetArray.functionId();
    }
}
