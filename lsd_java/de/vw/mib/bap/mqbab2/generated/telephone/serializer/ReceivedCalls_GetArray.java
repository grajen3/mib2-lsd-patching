...
public final class ReceivedCalls_GetArray
implements BAPGetArray {
    ...
    public ReceivedCalls_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public ReceivedCalls_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ...
        return this.asg_Id == receivedCalls_GetArray.asg_Id && this.taid == receivedCalls_GetArray.taid && this.arrayHeader.equalTo(receivedCalls_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return ReceivedCalls_GetArray.functionId();
    }
}
