...
public final class DialedNumbers_GetArray
implements BAPGetArray {
    ...
    public DialedNumbers_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public DialedNumbers_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ...
        return this.asg_Id == dialedNumbers_GetArray.asg_Id && this.taid == dialedNumbers_GetArray.taid && this.arrayHeader.equalTo(dialedNumbers_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return DialedNumbers_GetArray.functionId();
    }
}
