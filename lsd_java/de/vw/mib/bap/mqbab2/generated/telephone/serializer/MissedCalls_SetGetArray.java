...
public final class MissedCalls_SetGetArray
implements BAPSetGetArray {
    ...
    public MissedCalls_SetGetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public MissedCalls_SetGetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        MissedCalls_SetGetArray missedCalls_SetGetArray = (MissedCalls_SetGetArray)bAPEntity;
        return this.asg_Id == missedCalls_SetGetArray.asg_Id && this.taid == missedCalls_SetGetArray.taid && this.arrayHeader.equalTo(missedCalls_SetGetArray.arrayHeader) && this.data.equalTo(missedCalls_SetGetArray.data);
    }
    ...
    public String toString() {
        return "MissedCalls_SetGetArray:";
    }
    ...
    public void deserialize(BitStream bitStream) {
        ...
        if (!this.arrayHeader.isFullRangeUpdate()) {
            ...
            for (int i2 = 0; i2 < n; ++i2) {
                this.data.add(new MissedCalls_Data(bitStream, this.arrayHeader));
            }
        }
    }
    ...
    public int getFunctionId() {
        return MissedCalls_SetGetArray.functionId();
    }
}
