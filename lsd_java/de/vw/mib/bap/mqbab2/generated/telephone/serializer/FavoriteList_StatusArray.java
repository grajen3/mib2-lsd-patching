...
public final class FavoriteList_StatusArray
implements BAPStatusArray {
    ...
    public FavoriteList_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public FavoriteList_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        FavoriteList_StatusArray favoriteList_StatusArray = (FavoriteList_StatusArray)bAPEntity;
        return this.asg_Id == favoriteList_StatusArray.asg_Id && this.taid == favoriteList_StatusArray.taid && this.totalNumListElements == favoriteList_StatusArray.totalNumListElements && this.arrayHeader.equalTo(favoriteList_StatusArray.arrayHeader) && this.data.equalTo(favoriteList_StatusArray.data);
    }
    ...
    public String toString() {
        return "FavoriteList_StatusArray:";
    }
    ...
    public int getFunctionId() {
        return FavoriteList_StatusArray.functionId();
    }
}
