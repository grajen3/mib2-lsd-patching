...
public class TelephoneMarshaller
implements BAPIndicationMarshaller {
    ...
    public TelephoneMarshaller(BAPService bAPService, BitStreamTransformer bitStreamTransformer) {
    ...
    public void resultEntity(int n, BAPEntity bAPEntity) {
        switch (n) {
            case 26: {
                this.getBapService().request(n, 0, 9, this.getBitSreamTransformer().toInteger(bAPEntity, TelephoneMarshaller.getBitstreamTransformerDatatype(0)));
                break;
            }
            case 27: {
                this.getBapService().request(n, 0, 9, this.getBitSreamTransformer().toInteger(bAPEntity, TelephoneMarshaller.getBitstreamTransformerDatatype(0)));
    ...
    public void statusEntity(int n, BAPEntity bAPEntity) {
        switch (n) {
            ...
            case 4: {
                this.getBapService().request(n, 0, 7, this.getBitSreamTransformer().toInteger(bAPEntity, TelephoneMarshaller.getBitstreamTransformerDatatype(0)));
                break;
            }
            case 14: {
                this.getBapService().requestByteSequence(n, 7, this.getBitSreamTransformer().toByteArray(bAPEntity));
