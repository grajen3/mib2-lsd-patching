...
public final class MissedCalls_GetArray
implements BAPGetArray {
    ...
    public MissedCalls_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public MissedCalls_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ...
        return this.asg_Id == missedCalls_GetArray.asg_Id && this.taid == missedCalls_GetArray.taid && this.arrayHeader.equalTo(missedCalls_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return MissedCalls_GetArray.functionId();
    }
}
