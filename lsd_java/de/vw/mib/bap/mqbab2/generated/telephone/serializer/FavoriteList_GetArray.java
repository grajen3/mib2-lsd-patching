...
public final class FavoriteList_GetArray
implements BAPGetArray {
    ...
    public FavoriteList_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public FavoriteList_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ...
        return this.asg_Id == favoriteList_GetArray.asg_Id && this.taid == favoriteList_GetArray.taid && this.arrayHeader.equalTo(favoriteList_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return FavoriteList_GetArray.functionId();
    }
}
