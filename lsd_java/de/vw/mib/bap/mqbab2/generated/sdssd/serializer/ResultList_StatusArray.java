...
public final class ResultList_StatusArray
implements BAPStatusArray {
    ...
    public ResultList_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public ResultList_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ResultList_StatusArray resultList_StatusArray = (ResultList_StatusArray)bAPEntity;
        return this.asg_Id == resultList_StatusArray.asg_Id && this.taid == resultList_StatusArray.taid && this.totalNumListElements == resultList_StatusArray.totalNumListElements && this.arrayHeader.equalTo(resultList_StatusArray.arrayHeader) && this.data.equalTo(resultList_StatusArray.data);
    }
    ...
    public int getFunctionId() {
        return ResultList_StatusArray.functionId();
    }
}
