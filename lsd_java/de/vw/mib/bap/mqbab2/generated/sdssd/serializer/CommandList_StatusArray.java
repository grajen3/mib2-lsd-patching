...
public final class CommandList_StatusArray
implements BAPStatusArray {
    ...
    public CommandList_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public CommandList_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        CommandList_StatusArray commandList_StatusArray = (CommandList_StatusArray)bAPEntity;
        return this.asg_Id == commandList_StatusArray.asg_Id && this.taid == commandList_StatusArray.taid && this.totalNumListElements == commandList_StatusArray.totalNumListElements && this.arrayHeader.equalTo(commandList_StatusArray.arrayHeader) && this.data.equalTo(commandList_StatusArray.data);
    }
    ...
    public int getFunctionId() {
        return CommandList_StatusArray.functionId();
    }
}
