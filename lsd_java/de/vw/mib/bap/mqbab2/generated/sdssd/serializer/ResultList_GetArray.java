...
public final class ResultList_GetArray
implements BAPGetArray {
    ...
    public ResultList_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public ResultList_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ...
        return this.asg_Id == resultList_GetArray.asg_Id && this.taid == resultList_GetArray.taid && this.arrayHeader.equalTo(resultList_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return ResultList_GetArray.functionId();
    }
}
