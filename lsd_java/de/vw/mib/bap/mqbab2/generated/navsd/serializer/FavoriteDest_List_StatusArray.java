...
public final class FavoriteDest_List_StatusArray
implements BAPStatusArray {
    ...
    public FavoriteDest_List_StatusArray() {
        this.internalReset();
        this.customInitialization();
    }

    public FavoriteDest_List_StatusArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        FavoriteDest_List_StatusArray favoriteDest_List_StatusArray = (FavoriteDest_List_StatusArray)bAPEntity;
        return this.asg_Id == favoriteDest_List_StatusArray.asg_Id && this.taid == favoriteDest_List_StatusArray.taid && this.totalNumListElements == favoriteDest_List_StatusArray.totalNumListElements && this.arrayHeader.equalTo(favoriteDest_List_StatusArray.arrayHeader) && this.data.equalTo(favoriteDest_List_StatusArray.data);
    }
    ...
    public int getFunctionId() {
        return FavoriteDest_List_StatusArray.functionId();
    }
}
