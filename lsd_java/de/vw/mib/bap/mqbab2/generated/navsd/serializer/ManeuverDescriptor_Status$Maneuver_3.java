...
public final class ManeuverDescriptor_Status$Maneuver_3
implements BAPEntity {
    ...
    public ManeuverDescriptor_Status$Maneuver_3() {
        this.internalReset();
        this.customInitialization();
    }

    public ManeuverDescriptor_Status$Maneuver_3(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ManeuverDescriptor_Status$Maneuver_3 maneuverDescriptor_Status$Maneuver_3 = (ManeuverDescriptor_Status$Maneuver_3)bAPEntity;
        return this.mainElement == maneuverDescriptor_Status$Maneuver_3.mainElement && this.direction == maneuverDescriptor_Status$Maneuver_3.direction && this.zLevelGuidance == maneuverDescriptor_Status$Maneuver_3.zLevelGuidance && this.sidestreets.equalTo(maneuverDescriptor_Status$Maneuver_3.sidestreets);
    }
