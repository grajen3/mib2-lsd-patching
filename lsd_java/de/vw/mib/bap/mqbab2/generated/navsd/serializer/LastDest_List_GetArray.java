...
public final class LastDest_List_GetArray
implements BAPGetArray {
    ...
    public LastDest_List_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public LastDest_List_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ...
        return this.asg_Id == lastDest_List_GetArray.asg_Id && this.taid == lastDest_List_GetArray.taid && this.arrayHeader.equalTo(lastDest_List_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return LastDest_List_GetArray.functionId();
    }
}
