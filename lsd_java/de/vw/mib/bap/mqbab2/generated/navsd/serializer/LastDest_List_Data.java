...
public final class LastDest_List_Data
implements BAPArrayElement {
    ...
    public LastDest_List_Data(ArrayHeader arrayHeader) {
        this.arrayHeader = arrayHeader;
    ...
    public LastDest_List_Data(BitStream bitStream, ArrayHeader arrayHeader) {
        this(arrayHeader);
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        LastDest_List_Data lastDest_List_Data = (LastDest_List_Data)bAPEntity;
        return this.arrayHeader.equalTo(lastDest_List_Data.arrayHeader) && this.pos == lastDest_List_Data.pos && this.poi_Type == lastDest_List_Data.poi_Type && this.description.equalTo(lastDest_List_Data.description);
    }
