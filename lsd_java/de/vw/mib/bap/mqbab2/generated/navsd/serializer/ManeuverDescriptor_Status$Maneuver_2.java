...
public final class ManeuverDescriptor_Status$Maneuver_2
implements BAPEntity {
    ...
    public ManeuverDescriptor_Status$Maneuver_2() {
        this.internalReset();
        this.customInitialization();
    }

    public ManeuverDescriptor_Status$Maneuver_2(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ManeuverDescriptor_Status$Maneuver_2 maneuverDescriptor_Status$Maneuver_2 = (ManeuverDescriptor_Status$Maneuver_2)bAPEntity;
        return this.mainElement == maneuverDescriptor_Status$Maneuver_2.mainElement && this.direction == maneuverDescriptor_Status$Maneuver_2.direction && this.zLevelGuidance == maneuverDescriptor_Status$Maneuver_2.zLevelGuidance && this.sidestreets.equalTo(maneuverDescriptor_Status$Maneuver_2.sidestreets);
    }
