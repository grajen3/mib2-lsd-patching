...
public final class FavoriteDest_List_GetArray
implements BAPGetArray {
    ...
    public FavoriteDest_List_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public FavoriteDest_List_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        ...
        return this.asg_Id == favoriteDest_List_GetArray.asg_Id && this.taid == favoriteDest_List_GetArray.taid && this.arrayHeader.equalTo(favoriteDest_List_GetArray.arrayHeader);
    }
    ...
    public String toString() {
        return "FavoriteDest_List_GetArray:";
    }
    ...
    public int getFunctionId() {
        return FavoriteDest_List_GetArray.functionId();
    }
}
