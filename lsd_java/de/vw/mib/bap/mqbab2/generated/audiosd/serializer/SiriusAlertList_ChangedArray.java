...
public final class SiriusAlertList_ChangedArray
implements BAPChangedArray {
    ...
    public SiriusAlertList_ChangedArray() {
        this.internalReset();
        this.customInitialization();
    }

    public SiriusAlertList_ChangedArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        SiriusAlertList_ChangedArray siriusAlertList_ChangedArray = (SiriusAlertList_ChangedArray)bAPEntity;
        return this.arrayHeader.equalTo(siriusAlertList_ChangedArray.arrayHeader) && this.data.equalTo(siriusAlertList_ChangedArray.data);
    }
    ...
    public String toString() {
        return "SiriusAlertList_ChangedArray:";
    }
    ...
    public int getFunctionId() {
        return SiriusAlertList_ChangedArray.functionId();
    }
