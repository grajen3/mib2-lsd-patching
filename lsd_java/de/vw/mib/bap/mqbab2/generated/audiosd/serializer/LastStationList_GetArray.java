...
public final class LastStationList_GetArray
implements BAPGetArray {
    ...
    public LastStationList_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public LastStationList_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        LastStationList_GetArray lastStationList_GetArray = (LastStationList_GetArray)bAPEntity;
        return this.asg_Id == lastStationList_GetArray.asg_Id && this.taid == lastStationList_GetArray.taid && this.arrayHeader.equalTo(lastStationList_GetArray.arrayHeader);
    }
    ...
    public String toString() {
        return "LastStationList_GetArray:";
    }
    ...
    public int getFunctionId() {
        return LastStationList_GetArray.functionId();
    }
