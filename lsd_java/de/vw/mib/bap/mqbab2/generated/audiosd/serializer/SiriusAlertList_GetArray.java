...
public final class SiriusAlertList_GetArray
implements BAPGetArray {
    ...
    public SiriusAlertList_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public SiriusAlertList_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        SiriusAlertList_GetArray siriusAlertList_GetArray = (SiriusAlertList_GetArray)bAPEntity;
        return this.asg_Id == siriusAlertList_GetArray.asg_Id && this.taid == siriusAlertList_GetArray.taid && this.arrayHeader.equalTo(siriusAlertList_GetArray.arrayHeader);
    }
    ...
    public String toString() {
        return "SiriusAlertList_GetArray:";
    }
    ...
    public int getFunctionId() {
        return SiriusAlertList_GetArray.functionId();
    }
