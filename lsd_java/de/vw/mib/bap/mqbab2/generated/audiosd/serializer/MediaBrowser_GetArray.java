...
public final class MediaBrowser_GetArray
implements BAPGetArray {
    ...
    public MediaBrowser_GetArray() {
        this.internalReset();
        this.customInitialization();
    }

    public MediaBrowser_GetArray(BitStream bitStream) {
        this();
    ...
    public boolean equalTo(BAPEntity bAPEntity) {
        MediaBrowser_GetArray mediaBrowser_GetArray = (MediaBrowser_GetArray)bAPEntity;
        return this.asg_Id == mediaBrowser_GetArray.asg_Id && this.taid == mediaBrowser_GetArray.taid && this.arrayHeader.equalTo(mediaBrowser_GetArray.arrayHeader);
    }
    ...
    public int getFunctionId() {
        return MediaBrowser_GetArray.functionId();
    }
