...
extends NotStartedFunctionControlUnitState {
    ...
    static /* synthetic */ Class class$de$vw$mib$bap$mqbab2$common$states$InitializingState;

    public InitializingState(FsgHsmContext fsgHsmContext, HsmState hsmState) {
        super(fsgHsmContext, (class$de$vw$mib$bap$mqbab2$common$states$InitializingState == null ? (class$de$vw$mib$bap$mqbab2$common$states$InitializingState = InitializingState.class$("de.vw.mib.bap.mqbab2.common.states.InitializingState")) : class$de$vw$mib$bap$mqbab2$common$states$InitializingState).getName(), hsmState);
    }
