...
extends NotStartedFunctionControlUnitState {
    static /* synthetic */ Class class$de$vw$mib$bap$mqbab2$common$states$NotInitializedState;

    public NotInitializedState(FsgHsmContext fsgHsmContext, HsmState hsmState) {
        super(fsgHsmContext, (class$de$vw$mib$bap$mqbab2$common$states$NotInitializedState == null ? (class$de$vw$mib$bap$mqbab2$common$states$NotInitializedState = NotInitializedState.class$("de.vw.mib.bap.mqbab2.common.states.NotInitializedState")) : class$de$vw$mib$bap$mqbab2$common$states$NotInitializedState).getName(), hsmState);
    }
