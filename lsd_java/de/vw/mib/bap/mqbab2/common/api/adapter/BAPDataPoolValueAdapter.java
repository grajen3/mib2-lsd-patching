...
public final class BAPDataPoolValueAdapter {
    ...
    public Object nativeDataValue(BAPEntity bAPEntity) {
        Object object;
        BitStreamTransformer bitStreamTransformer = APIFactory.getAPIFactory().getBitStreamTransformer();
        switch (this.getDataType()) {
            case 3: {
                object = bitStreamTransformer.toByteArray(bAPEntity);
                break;
            }
            case 2: {
                object = new Integer(bitStreamTransformer.toInteger(bAPEntity, 32));
                break;
            }
            case 1: {
                object = new Integer(bitStreamTransformer.toInteger(bAPEntity, 16));
                break;
            }
            case 0: {
                object = new Integer(bitStreamTransformer.toInteger(bAPEntity, 8));
                break;
            }
            default: {
                object = null;
