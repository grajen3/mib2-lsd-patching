 ...
 */
package de.vw.mib.bap.mqbab2.common.api.adapter;
...
import de.vw.mib.bap.mqbab2.common.api.adapter.AbstractBAPDataPool$AllFunctions;
import de.vw.mib.bap.mqbab2.common.api.adapter.AbstractBAPDataPool$SendbufferFunctionRegistryListenerAdapter;
import de.vw.mib.bap.mqbab2.common.api.adapter.BAPDataPoolValueAdapter;
import de.vw.mib.bap.mqbab2.common.api.adapter.BAPValueObserverableAdapter;
import de.vw.mib.bap.mqbab2.common.api.stages.BAPStage;
import de.vw.mib.bap.mqbab2.common.api.stages.BAPStageContext;
import de.vw.mib.bap.mqbab2.common.api.stages.BAPStageInitializer;
import de.vw.mib.bap.mqbab2.common.marshalling.FunctionRegistryListenerAdapter;
...
BAPFunctionListenerRegistry {
    ...
    public final void requestValidValues() {
        APIFactory.getAPIFactory().getBapDispatcher().informThatAllBapDatapoolValuesAreValid(this.getLogicalControlUnitID());
    }
    ...
    protected final void logError(String string) {
        APIFactory.getAPIFactory().getLogger().error(4, string);
    }

    protected final void logError(Throwable throwable, String string) {
        APIFactory.getAPIFactory().getLogger().error(4).append(string).attachThrowable(throwable).log();
    }
    ...
    public void uninitialize() {
        ...
        while (iterator.hasNext()) {
            BAPStage bAPStage = (BAPStage)iterator.next();
            bAPStage.uninitialize();
        }
        this.bapStages.clear();
        this.dataPool.clear();
        APIFactory.getAPIFactory().getBapDispatcher().uninitialize(this.getLogicalControlUnitID());
    }
    ...
    private FunctionRegistryListenerAdapter getCachedTransmissionRegistryListenerAdapter() {
        this._cachedTransmissionfunctionRegistryListenerAdapter = new AbstractBAPDataPool$SendbufferFunctionRegistryListenerAdapter(this, this.getLogicalControlUnitID(), APIFactory.getAPIFactory().getBapDispatcher(), true);
    ...
    private FunctionRegistryListenerAdapter getFunctionRegistryListenerAdapter() {
        if (this._functionRegistryListenerAdapter == null) {
            this._functionRegistryListenerAdapter = new AbstractBAPDataPool$SendbufferFunctionRegistryListenerAdapter(this, this.getLogicalControlUnitID(), APIFactory.getAPIFactory().getBapDispatcher(), false);
        }
