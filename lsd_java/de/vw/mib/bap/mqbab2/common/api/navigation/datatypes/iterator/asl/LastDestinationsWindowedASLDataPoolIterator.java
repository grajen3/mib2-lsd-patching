...
public class LastDestinationsWindowedASLDataPoolIterator
extends LastDestinationsASLDataPoolIterator {
    protected int[] rowIndices;

    public LastDestinationsWindowedASLDataPoolIterator(int[] nArray) {
