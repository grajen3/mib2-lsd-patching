...
public class CallInformationsASLDataPoolIterator
extends AbstractASLDataPoolIterator
implements PhoneCallInformationElement {
    public CallInformationsASLDataPoolIterator() {
        super(1158);
    }
    ...
    public int getCallType() {
        Object object = this.aslList.getRowItem(this.currentIndex);
        return this.aslList.getListTransformer().getInt(23, object);
    }

    @Override
    public int getCallDisconnectionReason() {
        Object object = this.aslList.getRowItem(this.currentIndex);
