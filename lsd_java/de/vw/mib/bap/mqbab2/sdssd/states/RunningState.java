...
extends AbstractControlUnitState {
    static /* synthetic */ Class class$de$vw$mib$bap$mqbab2$sdssd$states$RunningState;

    public RunningState(SDSSDHsmContext sDSSDHsmContext, HsmState hsmState) {
        super(sDSSDHsmContext, (class$de$vw$mib$bap$mqbab2$sdssd$states$RunningState == null ? (class$de$vw$mib$bap$mqbab2$sdssd$states$RunningState = RunningState.class$("de.vw.mib.bap.mqbab2.sdssd.states.RunningState")) : class$de$vw$mib$bap$mqbab2$sdssd$states$RunningState).getName(), hsmState);
    }
    ...
    public void stateStart() {
        this.getContextDelegate().getLogger().trace(this.getContextDelegate().getSubClassifier(), "SDSSDFunctionControlUnit successfully started");
    }
