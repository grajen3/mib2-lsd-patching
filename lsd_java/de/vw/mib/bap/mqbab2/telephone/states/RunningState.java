...
extends AbstractControlUnitState {
    static /* synthetic */ Class class$de$vw$mib$bap$mqbab2$telephone$states$RunningState;

    public RunningState(TelephoneHsmContext telephoneHsmContext, HsmState hsmState) {
        super(telephoneHsmContext, (class$de$vw$mib$bap$mqbab2$telephone$states$RunningState == null ? (class$de$vw$mib$bap$mqbab2$telephone$states$RunningState = RunningState.class$("de.vw.mib.bap.mqbab2.telephone.states.RunningState")) : class$de$vw$mib$bap$mqbab2$telephone$states$RunningState).getName(), hsmState);
    }
    ...
    public void stateStart() {
        this.getContextDelegate().getLogger().trace(this.getContextDelegate().getSubClassifier(), "TelephoneFunctionControlUnit successfully started");
    }
