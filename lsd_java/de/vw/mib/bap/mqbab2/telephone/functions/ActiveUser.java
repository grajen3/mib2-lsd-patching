...
PhoneServiceListener {
    protected static final int[] PHONE_LISTENER_IDS = new int[]{3606, 1120, 3930};
    ...
    private String getBapActiveUserName() {
        ...
        String string = phoneService.isBluetoothConnectedUserPopUpVisible() ? phoneService.getBluetoothExternalDeviceName() : phoneService.getBluetoothDeviceName();
        return string;
    }
