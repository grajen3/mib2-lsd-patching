...
public final class FsgArrayRequestData {
    ...
    public void setStatusArrayHeaderDataAndFillRequestData(BAPStatusArray bAPStatusArray, BAPGetArray bAPGetArray, FsgArrayList fsgArrayList) {
        this.setStatusArrayHeaderData(bAPStatusArray, bAPGetArray, fsgArrayList);
        this.fillRequestData(bAPStatusArray, fsgArrayList);
    }
    ...
    public void fillRequestData(BAPStatusArray bAPStatusArray, FsgArrayList fsgArrayList) {
        FsgArrayListIterator fsgArrayListIterator = this.direction == 1 ? fsgArrayList.getForwardIteratorStartingAt(this.start) : fsgArrayList.getBackwardIteratorStartingAt(this.start);
        BAPArrayData bAPArrayData = bAPStatusArray.getArrayData();
        ArrayHeader arrayHeader = bAPStatusArray.getArrayHeader();
        for (int i2 = 0; fsgArrayListIterator.hasNext() && i2 < this.elements; ++i2) {
            BAPArrayElement bAPArrayElement = fsgArrayListIterator.next();
