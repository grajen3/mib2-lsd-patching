...
import de.vw.mib.bap.array.fsg.FsgArrayMessageBlockingTracker;
...
class FsgArrayMessageBlockingRequestTracker
...
FsgArrayMessageBlockingTracker {
    ...
    FsgArrayMessageBlockingRequestTracker(Array array, ArrayListener arrayListener, TimerFactory timerFactory) {
        this._array = array;
    ...
    private Timer getTimer() {
        if (this._timer == null) {
            this._timer = this._timerFactory.createTimer(this, 0);
