...
implements FsgArrayList {
    ...
    public int nextBapPosID(int n, int n2) {
        int n3;
        FsgArrayListIterator fsgArrayListIterator = n2 >= 0 ? this.getForwardIteratorStartingAt(n) : this.getBackwardIteratorStartingAt(n);
        BAPArrayElement bAPArrayElement = null;
        for (n3 = Math.abs(n2); n3 >= 0 && fsgArrayListIterator.hasNext(); --n3) {
            bAPArrayElement = fsgArrayListIterator.next();
        }
