...
import de.vw.mib.bap.array.fsg.FsgArrayListWindowed$WindowedAbsPosArrayListIterator;
import de.vw.mib.bap.array.fsg.FsgArrayListWindowed$WindowedArbitraryArrayListIterator;
...
class FsgArrayListWindowed
implements DynamicListDataListener,
FsgArrayList {
    private final ASLList _aslList;
    private final FSGArrayListDelegate _delegate;
    ...
    FsgArrayListWindowed(int n, FSGArrayListDelegate fSGArrayListDelegate) {
        this._aslList = ListManager.getASLList(n);
        this._delegate = fSGArrayListDelegate;
    }
    ...
    private FSGArrayListDelegate getDelegate() {
    ...
    public int putElement(long l, BAPArrayElement bAPArrayElement, long l2) {
        throw new UnsupportedOperationException("putElement is only supported in non-windowed lists");
    }
    ...
    @Override
    public FsgArrayListIterator getForwardIteratorStartingAt(int n) {
        throw new UnsupportedOperationException("iterators are only supported in non-windowed lists");
    }

    @Override
    public FsgArrayListIterator getBackwardIteratorStartingAt(int n) {
        throw new UnsupportedOperationException("iterators are only supported in non-windowed lists");
    }

    @Override
    public FsgArrayDeltaContext createNewDeltaContext(FsgArrayListElementComparator fsgArrayListElementComparator) {
        throw new UnsupportedOperationException("DeltaContext is only supported in non-windowed lists");
    }
}
