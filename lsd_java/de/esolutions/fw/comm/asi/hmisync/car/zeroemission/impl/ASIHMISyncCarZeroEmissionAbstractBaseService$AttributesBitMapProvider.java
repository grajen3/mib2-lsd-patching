...
class ASIHMISyncCarZeroEmissionAbstractBaseService$AttributesBitMapProvider
implements IAttributeBitMapProvider {
    private final HashMap map = new HashMap();

    public ASIHMISyncCarZeroEmissionAbstractBaseService$AttributesBitMapProvider() {
