...
public class SIAOilInspection {
    ...
    public String toString() {
        return new StringBuffer("SIAOilInspection{").append("distanceStatus=").append(this.distanceStatus).append(", distance=").append(this.distance).append(", distanceUnit=").append(this.distanceUnit).append(", timeStatus=").append(this.timeStatus).append(", time=").append(this.time).append("}").toString();
    }
}
