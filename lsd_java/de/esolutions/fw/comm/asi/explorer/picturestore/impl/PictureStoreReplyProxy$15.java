...
class PictureStoreReplyProxy$15
implements ISerializable {
    ...
    PictureStoreReplyProxy$15(PictureStoreReplyProxy pictureStoreReplyProxy, int n, ResourceLocator[] resourceLocatorArray, int n2) {
