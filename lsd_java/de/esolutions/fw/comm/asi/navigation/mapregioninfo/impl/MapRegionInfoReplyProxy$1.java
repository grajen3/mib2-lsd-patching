...
class MapRegionInfoReplyProxy$1
implements ISerializable {
    ...
    MapRegionInfoReplyProxy$1(MapRegionInfoReplyProxy mapRegionInfoReplyProxy, int n, ComponentInfo componentInfo, int n2) {
        this.this$0 = mapRegionInfoReplyProxy;
        this.val$requestID = n;
        this.val$componentInfo = componentInfo;
    ...
    public void serialize(ISerializer iSerializer) {
        ...
        ComponentInfoSerializer.putOptionalComponentInfo(iSerializer, this.val$componentInfo);
