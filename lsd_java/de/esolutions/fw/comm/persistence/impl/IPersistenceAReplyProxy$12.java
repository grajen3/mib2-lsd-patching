...
class IPersistenceAReplyProxy$12
implements ISerializable {
    ...
    IPersistenceAReplyProxy$12(IPersistenceAReplyProxy iPersistenceAReplyProxy, PartitionHandle partitionHandle, long l, int n) {
