...
class IPersistenceAReplyProxy$19
implements ISerializable {
    ...
    IPersistenceAReplyProxy$19(IPersistenceAReplyProxy iPersistenceAReplyProxy, PartitionHandle partitionHandle, long l, int n) {
