...
public class HighlightSerializer {
    public static void putOptionalHighlight(ISerializer iSerializer, Highlight highlight) {
        ...
        if (!bl) {
            int n = highlight.getGendescription();
            iSerializer.putInt32(n);
            int n2 = highlight.getHighlightStart();
            iSerializer.putInt32(n2);
            int n3 = highlight.getHighlightEnd();
    ...
    public static Highlight getOptionalHighlight(IDeserializer iDeserializer) {
        ...
        if (!bl) {
            ...
            highlight.gendescription = n3 = iDeserializer.getInt32();
            highlight.highlightStart = n2 = iDeserializer.getInt32();
            highlight.highlightEnd = n = iDeserializer.getInt32();
        }
        return highlight;
    }
