...
import de.esolutions.fw.comm.dsi.organizer.DSIAdbSetup;
import de.esolutions.fw.comm.dsi.organizer.DSIAdbSetupC;
...
public class DSIAdbSetupProxy
implements DSIAdbSetup,
DSIAdbSetupC {
    private static final CallContext context = CallContext.getContext("PROXY.dsi.organizer.DSIAdbSetup");
    private Proxy proxy;

    public DSIAdbSetupProxy(int n, DSIAdbSetupReply dSIAdbSetupReply) {
        ServiceInstanceID serviceInstanceID = new ServiceInstanceID("834784f2-4ed4-5f09-8afd-8530801f1b9a", n, "e124bef2-9cba-5028-b58b-0a5fb0469882", "dsi.organizer.DSIAdbSetup");
        DSIAdbSetupReplyService dSIAdbSetupReplyService = new DSIAdbSetupReplyService(dSIAdbSetupReply);
        this.proxy = new Proxy(serviceInstanceID, dSIAdbSetupReplyService, context);
    }
