...
public class DSIDDP20Proxy
implements DSIDDP20,
DSIDDP20C {
    private static final CallContext context = CallContext.getContext("PROXY.dsi.ddp20.DSIDDP20");
    private Proxy proxy;

    public DSIDDP20Proxy(int n, DSIDDP20Reply dSIDDP20Reply) {
        ServiceInstanceID serviceInstanceID = new ServiceInstanceID("07ed1e50-8c4c-52dc-b51a-61428c4f83bc", n, "f6ea08bb-34ae-54e5-8390-f65b1fe5723d", "dsi.ddp20.DSIDDP20");
        DSIDDP20ReplyService dSIDDP20ReplyService = new DSIDDP20ReplyService(dSIDDP20Reply);
        this.proxy = new Proxy(serviceInstanceID, dSIDDP20ReplyService, context);
    }
