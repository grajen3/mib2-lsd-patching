...
implements ISerializable {
    ...
    DSINavigationProxy$32(DSINavigationProxy dSINavigationProxy, NavLocation navLocation, int n) {
    ...
    public void serialize(ISerializer iSerializer) {
        ...
        iSerializer.putInt32(this.val$selectionCriterion);
    }
}
