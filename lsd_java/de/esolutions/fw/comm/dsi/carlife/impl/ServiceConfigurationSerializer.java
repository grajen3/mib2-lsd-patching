...
public class ServiceConfigurationSerializer {
    public static void putOptionalServiceConfiguration(ISerializer iSerializer, ServiceConfiguration serviceConfiguration) {
        ...
        if (!bl) {
            ...
            int n5 = serviceConfiguration.getTouchscreenResolutionX();
            iSerializer.putInt32(n5);
            int n6 = serviceConfiguration.getTouchscreenResolutionY();
            iSerializer.putInt32(n6);
            boolean bl4 = serviceConfiguration.isTouchpadAvailable();
            iSerializer.putBool(bl4);
            int n7 = serviceConfiguration.getTouchpadResolutionX();
            iSerializer.putInt32(n7);
            int n8 = serviceConfiguration.getTouchpadResolutionY();
    ...
    public static ServiceConfiguration getOptionalServiceConfiguration(IDeserializer iDeserializer) {
        ...
        if (!bl) {
            ...
            serviceConfiguration.touchscreenResolutionX = n6 = iDeserializer.getInt32();
            serviceConfiguration.touchscreenResolutionY = n5 = iDeserializer.getInt32();
            serviceConfiguration.touchpadAvailable = bl3 = iDeserializer.getBool();
            serviceConfiguration.touchpadResolutionX = n4 = iDeserializer.getInt32();
            serviceConfiguration.touchpadResolutionY = n3 = iDeserializer.getInt32();
