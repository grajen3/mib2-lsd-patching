...
public class DSIDisplayManagementProxy
implements DSIDisplayManagement,
DSIDisplayManagementC {
    private static final CallContext context = CallContext.getContext("PROXY.dsi.displaymanagement.DSIDisplayManagement");
    private Proxy proxy;

    public DSIDisplayManagementProxy(int n, DSIDisplayManagementReply dSIDisplayManagementReply) {
        ServiceInstanceID serviceInstanceID = new ServiceInstanceID("0d85c3ca-aa14-5938-88df-8dcafa49fe81", n, "55e41181-5ef7-582a-8e17-c4c93d42c01e", "dsi.displaymanagement.DSIDisplayManagement");
        DSIDisplayManagementReplyService dSIDisplayManagementReplyService = new DSIDisplayManagementReplyService(dSIDisplayManagementReply);
        this.proxy = new Proxy(serviceInstanceID, dSIDisplayManagementReplyService, context);
    }
