...
implements ISerializable {
    ...
    DSIRadioDataProxy$4(DSIRadioDataProxy dSIRadioDataProxy, RadioStationData[] radioStationDataArray, ResourceLocator[] resourceLocatorArray, int n, int n2) {
        this.this$0 = dSIRadioDataProxy;
        this.val$radioStationData = radioStationDataArray;
        this.val$resourceLocator = resourceLocatorArray;
        this.val$requestType = n;
        this.val$sessionId = n2;
    }

    @Override
    public void serialize(ISerializer iSerializer) {
        RadioStationDataSerializer.putOptionalRadioStationDataVarArray(iSerializer, this.val$radioStationData);
        ResourceLocatorSerializer.putOptionalResourceLocatorVarArray(iSerializer, this.val$resourceLocator);
        iSerializer.putInt32(this.val$requestType);
