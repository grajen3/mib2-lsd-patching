...
public class CallStateSerializer {
    public static void putOptionalCallState(ISerializer iSerializer, CallState callState) {
        ...
        if (!bl) {
            ...
            ResourceLocator resourceLocator = callState.getCallerThumbnail();
    ...
    public static CallState getOptionalCallState(IDeserializer iDeserializer) {
        ...
        if (!bl) {
            ...
            callState.callerThumbnail = resourceLocator = ResourceLocatorSerializer.getOptionalResourceLocator(iDeserializer);
        }
        return callState;
    }
