...
public class AppStateSerializer {
    ...
    public static AppState getOptionalAppState(IDeserializer iDeserializer) {
        ...
        if (!bl) {
            ...
            appState.appStateID = n3 = iDeserializer.getInt32();
            appState.owner = n2 = iDeserializer.getInt32();
            appState.speechMode = n = iDeserializer.getInt32();
        }
        return appState;
    }
